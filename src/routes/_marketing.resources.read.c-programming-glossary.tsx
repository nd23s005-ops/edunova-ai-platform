...
const RESOURCE: ReaderResource = {
  id: "c-programming-glossary",
  title: "C Programming — Glossary",
  ...
  heroSubtitle: "A-to-Z glossary of C and systems-programming terminology used across this library.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-glossary" }],
  }),
  component: Page,
});
