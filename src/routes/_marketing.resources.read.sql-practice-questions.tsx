...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Hands-on SQL practice questions covering queries, joins, aggregation, and CTEs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Practice Questions</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Practice Questions</b> — is designed to be self-contained: Hands-on SQL practice questions covering queries, joins, aggregation, and CTEs.</p>
