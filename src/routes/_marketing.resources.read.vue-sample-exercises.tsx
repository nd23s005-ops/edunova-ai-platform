...
const RESOURCE: ReaderResource = {
  id: "vue-sample-exercises",
  title: "Vue.js — Sample Exercises",
  ...
  heroSubtitle: 'Short, focused Vue.js exercises for SFCs, Composition API, Pinia stores, and Vue Router.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready Vue.js.</li>
