...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Ship a production-grade MERN app — folder structure, REST APIs, React frontend, auth, tests, and deployment.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — practical, production-ready MERN full-stack development.</li>
