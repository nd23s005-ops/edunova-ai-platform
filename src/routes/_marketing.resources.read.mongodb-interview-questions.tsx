...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Curated MongoDB interview questions covering CRUD, aggregation, indexing, sharding, and system design.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — practical, production-ready MongoDB.</li>
