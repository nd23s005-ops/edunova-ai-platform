...
const RESOURCE: ReaderResource = {
  id: "network-security-practice-questions",
  title: "Network Security — Practice Questions",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "24 min",
  pages: 30,
  ...
  heroSubtitle: "A structured educational workbook of 350+ theory questions, MCQs, scenario-based questions, topology analysis, protocol identification, security architecture exercises, and defensive case studies.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured educational workbook of 350+ theory questions, MCQs, scenario-based questions, topology analysis, protocol identification, security architecture exercises, and defensive case studies. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
