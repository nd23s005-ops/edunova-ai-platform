...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "One-page C++ cheat sheet — syntax, STL containers, smart pointers, and one-liners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Cheat Sheet</b> — practical, modern-C++ coverage.</li>
