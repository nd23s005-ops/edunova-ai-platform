...
const RESOURCE: ReaderResource = {
  id: "cyber-security-interview-questions",
  ...
  heroSubtitle: "350+ interview questions covering fundamentals, IAM, network, cloud, IR, SIEM, governance, and behavioral topics.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>350+ interview questions covering fundamentals, IAM, network, cloud, IR, SIEM, governance, and behavioral topics. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
