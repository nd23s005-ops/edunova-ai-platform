...
const RESOURCE: ReaderResource = {
  id: "typescript-complete-tutorial",
  title: "TypeScript — Complete Tutorial",
  ...
  heroSubtitle: 'End-to-end TypeScript tutorial from primitives to generics, modules, and framework integration.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Complete Tutorial</b> — is self-contained: End-to-end TypeScript tutorial from primitives to generics, modules, and framework integration.</p>
