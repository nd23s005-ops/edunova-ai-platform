...
const RESOURCE: ReaderResource = {
  id: "devops-tips-tricks",
  title: "DevOps — Tips & Tricks",
  ...
  heroSubtitle: "High-leverage DevOps tips for pipelines, containers, Kubernetes, IaC, and on-call life.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>High-leverage DevOps tips for pipelines, containers, Kubernetes, IaC, and on-call life. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
