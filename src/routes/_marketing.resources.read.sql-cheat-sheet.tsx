...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "One-page SQL cheat sheet — clauses, joins, aggregates, and one-liners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Cheat Sheet</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Cheat Sheet</b> — is designed to be self-contained: One-page SQL cheat sheet — clauses, joins, aggregates, and one-liners.</p>
