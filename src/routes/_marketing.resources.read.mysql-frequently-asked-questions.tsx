...
const RESOURCE: ReaderResource = {
  id: "mysql-frequently-asked-questions",
  title: "MySQL — Frequently Asked Questions",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 14,
  ...
  heroSubtitle: "Answers to the most common MySQL questions from beginners and working developers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Frequently Asked Questions</b> — is designed to be self-contained: Answers to the most common MySQL questions from beginners and working developers.</p>
