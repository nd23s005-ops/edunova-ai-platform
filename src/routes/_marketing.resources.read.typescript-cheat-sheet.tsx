...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page TypeScript cheat sheet — syntax, utility types, and generics at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Cheat Sheet</b> — is self-contained: One-page TypeScript cheat sheet — syntax, utility types, and generics at a glance.</p>
