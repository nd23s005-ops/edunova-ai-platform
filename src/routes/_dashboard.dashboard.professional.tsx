...
import { Briefcase, BookOpen, TrendingUp, Target } from "lucide-react";
  ...
  return (
    <RoleGate allow={["professional"]}>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard label="Courses completed" value="8" hint="This year" icon={<BookOpen className="h-4 w-4" />} />
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        ...
        <PlaceholderPanel title="Recommended courses" />
      </div>
    </RoleGate>
  );
}
