...
const RESOURCE: ReaderResource = {
  id: "numpy-frequently-asked-questions",
  title: "NumPy — Frequently Asked Questions",
  ...
  heroSubtitle: "The most-asked questions about NumPy, answered clearly with examples.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Frequently Asked Questions</b> — is self-contained: The most-asked questions about NumPy, answered clearly with examples.</p>
