...
const RESOURCE: ReaderResource = {
  id: "operating-systems-sample-exercises",
  title: "Operating Systems — Sample Exercises",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "17 min",
  pages: 29,
  ...
  heroSubtitle: "Practical OS workbook with 300+ exercises: processes, threads, scheduling, synchronization, deadlocks, memory management, paging, virtual memory, Linux commands, filesystems, and shell scripting basics.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Sample Exercises.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Practical OS workbook with 300+ exercises: processes, threads, scheduling, synchronization, deadlocks, memory management, paging, virtual memory, Linux commands, filesystems, and shell scripting basics.</p>
