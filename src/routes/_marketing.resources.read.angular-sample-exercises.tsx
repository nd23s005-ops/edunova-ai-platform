...
const RESOURCE: ReaderResource = {
  id: "angular-sample-exercises",
  title: "Angular — Sample Exercises",
  ...
  heroSubtitle: 'Short, focused Angular exercises for standalone components, DI, RxJS, and reactive forms.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Sample Exercises</b> — is self-contained: Short, focused Angular exercises for standalone components, DI, RxJS, and reactive forms.</p>
