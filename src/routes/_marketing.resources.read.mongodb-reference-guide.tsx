...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'The exhaustive MongoDB reference — shell, operators, aggregation stages, and driver recipes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Reference Guide</b> — practical, production-ready MongoDB.</li>
