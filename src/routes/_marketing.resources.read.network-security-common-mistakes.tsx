...
const RESOURCE: ReaderResource = {
  id: "network-security-common-mistakes",
  title: "Network Security — Common Mistakes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "15 min",
  pages: 15,
  ...
  heroSubtitle: "A troubleshooting guide covering common Network Security mistakes: poor segmentation, weak firewall rules, insecure wireless, insufficient monitoring, improper authentication, outdated protocols, weak encryption, and poor documentation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A troubleshooting guide covering common Network Security mistakes: poor segmentation, weak firewall rules, insecure wireless, insufficient monitoring, improper authentication, outdated protocols, weak encryption, and poor documentation. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
