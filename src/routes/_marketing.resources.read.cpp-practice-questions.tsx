...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Hands-on C++ practice questions covering syntax, classes, STL, and small programs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Practice Questions</b> — practical, modern-C++ coverage.</li>
