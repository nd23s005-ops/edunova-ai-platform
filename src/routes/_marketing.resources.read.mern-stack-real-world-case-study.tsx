...
const RESOURCE: ReaderResource = {
  id: "mern-stack-real-world-case-study",
  title: "MERN Stack — Real-world Case Study",
  ...
  heroSubtitle: 'How teams run MERN in production — scaling patterns, observability, and postmortems.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready MERN full-stack development.</li>
