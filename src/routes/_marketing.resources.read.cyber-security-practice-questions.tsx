...
const RESOURCE: ReaderResource = {
  id: "cyber-security-practice-questions",
  title: "Cyber Security — Practice Questions",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "28 min",
  pages: 36,
  ...
  heroSubtitle: "A workbook of theory, MCQ, and scenario practice questions across cybersecurity domains.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A workbook of theory, MCQ, and scenario practice questions across cybersecurity domains. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
