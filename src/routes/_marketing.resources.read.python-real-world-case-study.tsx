...
const RESOURCE: ReaderResource = {
  id: "python-real-world-case-study",
  title: "Python — Real-world Case Study",
  ...
  heroSubtitle: "Real production Python systems — architecture, trade-offs, and lessons learned.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Real-world Case Study</b> — is designed to be self-contained: Real production Python systems — architecture, trade-offs, and lessons learned.</p>
