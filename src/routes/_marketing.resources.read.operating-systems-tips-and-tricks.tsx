...
const RESOURCE: ReaderResource = {
  id: "operating-systems-tips-and-tricks",
  title: "Operating Systems — Tips & Tricks",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 10,
  ...
  heroSubtitle: "Practical OS tips and tricks: Linux command shortcuts, debugging workflows, scheduling tricks, memory optimization tips, shell productivity, monitoring utilities, and troubleshooting techniques.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-tips-and-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-tips-and-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Tips & Tricks.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Practical OS tips and tricks: Linux command shortcuts, debugging workflows, scheduling tricks, memory optimization tips, shell productivity, monitoring utilities, and troubleshooting techniques.</p>
