...
const RESOURCE: ReaderResource = {
  id: "vue-reference-guide",
  title: "Vue.js — Reference Guide",
  ...
  heroSubtitle: 'A complete reference for Vue.js — Composition API, directives, Vue Router, Pinia, and config.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Reference Guide</b> — practical, production-ready Vue.js.</li>
