...
const RESOURCE: ReaderResource = {
  id: "gcp-pdf-notes",
  title: "Google Cloud Platform — PDF Notes",
  ...
  heroSubtitle: "Comprehensive PDF-style notes on Google Cloud services, architecture, and operations.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-pdf-notes" }],
  }),
  component: Page,
});
