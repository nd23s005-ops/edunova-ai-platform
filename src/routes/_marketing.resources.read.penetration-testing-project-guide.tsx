...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-project-guide",
  title: "Penetration Testing — Project Guide",
  category: "Security",
  ...
  heroSubtitle: "A complete project guide for planning and documenting an authorized pentest engagement: scope, rules of engagement, stakeholder communication, assessment planning, evidence collection, reporting structure, remediation tracking, and project review.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete project guide for planning and documenting an authorized pentest engagement: scope, rules of engagement, stakeholder communication, assessment planning, evidence collection, reporting structure, remediation tracking, and project review. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
