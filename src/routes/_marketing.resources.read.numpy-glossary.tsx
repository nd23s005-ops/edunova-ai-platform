...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A concise glossary of NumPy terms \u2014 ndarray, dtype, axis, broadcasting, ufunc, and more.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Glossary</b> — is self-contained: A concise glossary of NumPy terms — ndarray, dtype, axis, broadcasting, ufunc, and more.</p>
