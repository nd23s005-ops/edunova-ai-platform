...
const RESOURCE: ReaderResource = {
  id: "pandas-sample-exercises",
  title: "Pandas — Sample Exercises",
  ...
  heroSubtitle: 'Short, focused Pandas exercises for I/O, cleaning, groupby, joins, and time series.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready Pandas.</li>
