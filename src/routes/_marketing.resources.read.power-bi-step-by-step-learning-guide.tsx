...
const RESOURCE: ReaderResource = {
  id: "power-bi-step-by-step-learning-guide",
  title: "Power BI — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "This step-by-step learning guide sequences your Power BI journey — one skill per lesson — so you build real reports while learning the underlying concepts.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>This step-by-step learning guide sequences your Power BI journey — one skill per lesson — so you build real reports while learning the underlying concepts.</p>
