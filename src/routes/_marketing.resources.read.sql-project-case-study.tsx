...
const RESOURCE: ReaderResource = {
  id: "sql-project-case-study",
  title: "SQL — Project Case Study",
  category: "Databases",
  ...
  heroSubtitle: "Full case study of a SQL project — schema, indexes, queries, and delivery.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Project Case Study</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Project Case Study</b> — is designed to be self-contained: Full case study of a SQL project — schema, indexes, queries, and delivery.</p>
