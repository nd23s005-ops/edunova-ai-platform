...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Complete worked solutions and explanations for the Vue.js practice question set.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready Vue.js.</li>
