...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Comprehensive PDF-style Docker notes covering the entire container lifecycle — images, networking, storage, security, Compose, Swarm, and CI/CD.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive PDF-style Docker notes covering the entire container lifecycle — images, networking, storage, security, Compose, Swarm, and CI/CD.</p>
