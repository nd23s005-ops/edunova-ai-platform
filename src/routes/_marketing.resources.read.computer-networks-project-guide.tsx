...
const RESOURCE: ReaderResource = {
  id: "computer-networks-project-guide",
  title: "Computer Networks — Project Guide",
  category: "CS Core",
  ...
  heroSubtitle: "How to design, implement, secure, test, monitor, document, and maintain enterprise networks using modern technologies and best practices.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "req", label: "Requirements Gathering" },
  { id: "design", label: "Design" },
  { id: "ip", label: "IP Planning" },
  { id: "route", label: "Routing Strategy" },
  ...
  { id: "check", label: "Project Checklist" },
...
export const Route = createFileRoute("/_marketing/resources/read/computer-networks-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/computer-networks-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>How to design, implement, secure, test, monitor, document, and maintain enterprise networks using modern technologies and best practices.</p>
        <Figure src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=1400&q=80" caption="Figure 1 — Overview illustration for Computer Networks — Project Guide." />
      </Section>

      <Section id="req" title="Requirements Gathering">
        <p>User count, applications, throughput, growth, compliance.</p>
      </Section>

      <Section id="design" title="Design">
        <p>Hierarchical model — access, distribution, core. Redundancy at every layer.</p>
        <Figure src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=1400&q=80" caption="Figure 1 — Reference diagram for design." />
      </Section>

      <Section id="ip" title="IP Planning">
        <p>Contiguous supernets. Room for growth. Documented in IPAM.</p>
      </Section>

      <Section id="route" title="Routing Strategy">
        <p>OSPF areas for internal. BGP for external. Route summarization.</p>
      </Section>

      <Section id="switch" title="Switching & VLANs">
        <p>VLAN per function. Trunk uplinks. STP tuning.</p>
      </Section>

      <Section id="sec" title="Security">
        <p>Segmentation, ACLs, NGFW, IDS/IPS, Zero Trust ambitions.</p>
      </Section>

      <Section id="mon" title="Monitoring">
        <p>SNMP, NetFlow, syslog, RUM. Dashboards for MTTR.</p>
      </Section>

      <Section id="test" title="Testing">
        <p>Failover drills, chaos scenarios, capacity tests.</p>
      </Section>

      <Section id="docs" title="Documentation">
        <p>Runbooks, topology maps, change logs, IPAM.</p>
      </Section>

      <Section id="maint" title="Maintenance">
        <p>Patch cadence, EOL tracking, config backups.</p>
      </Section>

      <Section id="check" title="Project Checklist">
        <p>Design signed off. IPs assigned. Monitoring live. Docs current.</p>
      </Section>
