...
const RESOURCE: ReaderResource = {
  id: "expressjs-advanced-concepts",
  ...
  heroSubtitle: 'Advanced Express.js — clustering, streaming, microservices, message queues, and clean architecture.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Advanced Concepts</b> — is self-contained: Advanced Express.js — clustering, streaming, microservices, message queues, and clean architecture.</p>
