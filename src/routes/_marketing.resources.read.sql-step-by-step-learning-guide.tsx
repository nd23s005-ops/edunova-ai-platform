...
const RESOURCE: ReaderResource = {
  id: "sql-step-by-step-learning-guide",
  title: "SQL — Step-by-Step Learning Guide",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "28 min",
  pages: 29,
  ...
  heroSubtitle: "A structured, incremental path from zero to confident SQL developer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Step-by-Step Learning Guide</b> — is designed to be self-contained: A structured, incremental path from zero to confident SQL developer.</p>
