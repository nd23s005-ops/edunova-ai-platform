...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-project-guide",
  title: "Tailwind CSS — Project Guide",
  ...
  heroSubtitle: 'Build a responsive, production-ready Tailwind CSS project with a design-token-driven UI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — practical, production-ready Tailwind CSS.</li>
