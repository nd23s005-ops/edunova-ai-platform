...
const RESOURCE: ReaderResource = {
  id: "mysql-advanced-concepts",
  title: "MySQL — Advanced Concepts",
  category: "Databases",
  difficulty: "Advanced",
  readingTime: "32 min",
  pages: 58,
  ...
  heroSubtitle: "Deep MyMySQL — InnoDB internals, indexing, isolation levels, replication, and tuning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Advanced Concepts</b> — is designed to be self-contained: Deep MyMySQL — InnoDB internals, indexing, isolation levels, replication, and tuning.</p>
