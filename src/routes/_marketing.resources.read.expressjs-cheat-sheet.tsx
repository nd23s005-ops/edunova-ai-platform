...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page Express.js reference — HTTP verbs, router API, common middleware, and status codes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Cheat Sheet</b> — is self-contained: One-page Express.js reference — HTTP verbs, router API, common middleware, and status codes.</p>
