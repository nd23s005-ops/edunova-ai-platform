...
const RESOURCE: ReaderResource = {
  id: "swift-ios-project-case-study",
  title: "Swift (iOS) — Project Case Study",
  category: "Mobile",
  ...
  heroSubtitle: "Full case study of a SwiftUI project — architecture, state, networking, and delivery.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Project Case Study</b> — is designed to be self-contained: Full case study of a SwiftUI project — architecture, state, networking, and delivery.</p>
