...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "This complete tutorial walks you end-to-end through Tableau — from connecting data sources to publishing governed, enterprise-grade dashboards on Tableau Cloud and Server.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>This complete tutorial walks you end-to-end through Tableau — from connecting data sources to publishing governed, enterprise-grade dashboards on Tableau Cloud and Server.</p>
