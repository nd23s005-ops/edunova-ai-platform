...
const RESOURCE: ReaderResource = {
  id: "network-security-frequently-asked-questions",
  title: "Network Security — Frequently Asked Questions",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "13 min",
  pages: 15,
  ...
  heroSubtitle: "A comprehensive FAQ covering Network Security protocols, firewalls, VPNs, IDS/IPS, Zero Trust, PKI, TLS, wireless security, cloud networking, certifications, interviews, and enterprise infrastructure protection.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive FAQ covering Network Security protocols, firewalls, VPNs, IDS/IPS, Zero Trust, PKI, TLS, wireless security, cloud networking, certifications, interviews, and enterprise infrastructure protection. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
