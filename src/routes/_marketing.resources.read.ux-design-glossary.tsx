...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Complete alphabetical glossary covering UX Design terminology, research concepts, usability, accessibility standards, information architecture, interaction design, and design thinking terms with examples.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Glossary.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete alphabetical glossary covering UX Design terminology, research concepts, usability, accessibility standards, information architecture, interaction design, and design thinking terms with examples.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Glossary</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
