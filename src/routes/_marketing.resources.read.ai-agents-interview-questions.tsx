...
const RESOURCE: ReaderResource = {
  id: "ai-agents-interview-questions",
  ...
  heroSubtitle: "AI agent interview questions across LLMs, RAG, tool use, memory, planning, and multi-agent design.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This interview questions focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
