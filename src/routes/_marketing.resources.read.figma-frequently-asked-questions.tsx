...
const RESOURCE: ReaderResource = {
  id: "figma-frequently-asked-questions",
  title: "Figma — Frequently Asked Questions",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 10,
  ...
  heroSubtitle: "Comprehensive Figma FAQ from beginner to advanced \u2014 Auto Layout, components, variants, design systems, variables, responsive design, prototyping, Dev Mode, plugins, accessibility, collaboration, portfolios, and careers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Frequently Asked Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive Figma FAQ from beginner to advanced — Auto Layout, components, variants, design systems, variables, responsive design, prototyping, Dev Mode, plugins, accessibility, collaboration, portfolios, and careers.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Frequently Asked Questions</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
