...
const RESOURCE: ReaderResource = {
  id: "kubernetes-beginner-guide",
  title: "Kubernetes — Beginner Guide",
  ...
  heroSubtitle: "Beginner-friendly introduction to Kubernetes — container orchestration, cluster architecture, and core objects.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-beginner-guide" }],
  }),
  component: Page,
});
