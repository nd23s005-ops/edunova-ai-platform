...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-reference-guide",
  title: "Penetration Testing — Reference Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "52 min",
  pages: 74,
  ...
  heroSubtitle: "A comprehensive reference handbook covering PTES phases, OWASP references, NIST guidance, vulnerability management lifecycle, reporting templates, risk assessment frameworks, compliance standards, security documentation, and defensive security reference tables.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive reference handbook covering PTES phases, OWASP references, NIST guidance, vulnerability management lifecycle, reporting templates, risk assessment frameworks, compliance standards, security documentation, and defensive security reference tables. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
