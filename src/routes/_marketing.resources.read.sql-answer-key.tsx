...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Fully explained answers to the SQL practice set with step-by-step reasoning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Answer Key</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Answer Key</b> — is designed to be self-contained: Fully explained answers to the SQL practice set with step-by-step reasoning.</p>
