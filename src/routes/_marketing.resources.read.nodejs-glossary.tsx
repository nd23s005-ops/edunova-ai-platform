...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Every Node.js term you'll meet — event loop, stream, buffer, REPL, cluster, worker, and more.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, production-ready Node.js.</li>
