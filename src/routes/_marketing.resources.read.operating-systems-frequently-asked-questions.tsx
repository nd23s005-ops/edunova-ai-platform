...
const RESOURCE: ReaderResource = {
  id: "operating-systems-frequently-asked-questions",
  title: "Operating Systems — Frequently Asked Questions",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "13 min",
  pages: 15,
  ...
  heroSubtitle: "Comprehensive Operating Systems FAQ: processes, threads, scheduling, synchronization, deadlocks, memory management, virtual memory, Linux, filesystems, virtualization, containers, security, certifications, and careers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Frequently Asked Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive Operating Systems FAQ: processes, threads, scheduling, synchronization, deadlocks, memory management, virtual memory, Linux, filesystems, virtualization, containers, security, certifications, and careers.</p>
