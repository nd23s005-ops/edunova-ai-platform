...
const RESOURCE: ReaderResource = {
  id: "ai-agents-tips-tricks",
  title: "AI Agents — Tips & Tricks",
  category: "AI & Data",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 8,
  ...
  heroSubtitle: "Productivity tips and tricks for prompting, tool design, tracing, and evaluation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This tips & tricks focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
