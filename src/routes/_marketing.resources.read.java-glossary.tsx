...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A-to-Z glossary of Java and JVM terminology used across the docs and this library.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Glossary</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Glossary</b> — is designed to be self-contained: A-to-Z glossary of Java and JVM terminology used across the docs and this library.</p>
