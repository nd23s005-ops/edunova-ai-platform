...
const RESOURCE: ReaderResource = {
  id: "data-analytics-common-mistakes",
  title: "Data Analytics — Common Mistakes",
  ...
  heroSubtitle: 'The Data Analytics pitfalls that mislead decisions — dirty data, wrong KPIs, and bad charts.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, business-ready Data Analytics.</li>
