...
const RESOURCE: ReaderResource = {
  id: "javascript-real-world-case-study",
  title: "JavaScript — Real-world Case Study",
  ...
  heroSubtitle: "How modern JavaScript solved a complex business problem \u2014 architecture, integration, async processing, scaling.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Problem Statement" },
  { id: "s2", label: "2. Solution Architecture" },
  { id: "s3", label: "3. Async Processing" },
  { id: "s4", label: "4. Optimization" },
  { id: "s5", label: "5. Deployment" },
  { id: "s6", label: "6. Monitoring" },
  { id: "s7", label: "7. Scalability" },
  { id: "s8", label: "8. Engineering Decisions" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Real-world Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>An enterprise-grade case study demonstrating how JavaScript delivers business value at scale.</p>
      ...
      <Section id="s1" title="1. Problem Statement">
        <p>Legacy PHP monolith, poor UX, high churn.</p>
        <Code lang="js">{`// Problem Statement — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from problem statement";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Solution Architecture">
        <p>Node.js microservices + React SPA.</p>
        <Code lang="js">{`// Solution Architecture — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from solution architecture";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Async Processing">
        <p>Queue-based job workers with BullMQ.</p>
        <Code lang="js">{`// Async Processing — illustrative snippet
const example = () => {
  // apply concepts covered above
...
const example = () => {
  // apply concepts covered above
  return "hello from optimization";
};`}</Code>
      </Section>

      <Section id="s5" title="5. Deployment">
        <p>Kubernetes, canary releases.</p>
...
const example = () => {
  ...
  return "hello from deployment";
      ...
      <Section id="s6" title="6. Monitoring">
        <p>OpenTelemetry, Sentry, Datadog.</p>
        <Code lang="js">{`// Monitoring — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from monitoring";
};`}</Code>
      </Section>

      <Section id="s7" title="7. Scalability">
        <p>Handling 10x traffic on Black Friday.</p>
        <Code lang="js">{`// Scalability — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from scalability";
};`}</Code>
      </Section>

      <Section id="s8" title="8. Engineering Decisions">
        <p>Trade-offs and why.</p>
        <Code lang="js">{`// Engineering Decisions — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from engineering decisions";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Real-world Case Study equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
