...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "One-page Java cheat sheet — syntax, collections, streams, and standard-library one-liners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Cheat Sheet</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Cheat Sheet</b> — is designed to be self-contained: One-page Java cheat sheet — syntax, collections, streams, and standard-library one-liners.</p>
