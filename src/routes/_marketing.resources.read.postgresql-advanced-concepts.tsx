...
const RESOURCE: ReaderResource = {
  id: "postgresql-advanced-concepts",
  ...
  heroSubtitle: "Deep PostgreSQL — MVCC, planner, indexing internals, isolation levels, and replication.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Advanced Concepts</b> — is designed to be self-contained: Deep PostgreSQL — MVCC, planner, indexing internals, isolation levels, and replication.</p>
