...
const RESOURCE: ReaderResource = {
  id: "power-bi-project-case-study",
  title: "Power BI — Project Case Study",
  ...
  heroSubtitle: "A detailed Power BI project case study — modeling, DAX, and dashboard design decisions for a real business use case.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A detailed Power BI project case study — modeling, DAX, and dashboard design decisions for a real business use case.</p>
