...
const RESOURCE: ReaderResource = {
  id: "aws-project-guide",
  title: "AWS — Project Guide",
  ...
  heroSubtitle: "Guided project blueprint for building and deploying a production workload on AWS.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This project guide focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
