...
const RESOURCE: ReaderResource = {
  id: "azure-project-guide",
  title: "Microsoft Azure — Project Guide",
  ...
  heroSubtitle: "Ship a production-style Azure project — App Service + SQL + Front Door + monitoring.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Ship a production-style Azure project — App Service + SQL + Front Door + monitoring. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
