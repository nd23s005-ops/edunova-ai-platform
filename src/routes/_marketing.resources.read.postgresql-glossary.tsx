...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A-to-Z glossary of PostgreSQL and relational-database terminology used across this library.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Glossary</b> — is designed to be self-contained: A-to-Z glossary of PostgreSQL and relational-database terminology used across this library.</p>
