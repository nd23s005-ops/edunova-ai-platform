...
const RESOURCE: ReaderResource = {
  id: "javascript-frequently-asked-questions",
  ...
  heroSubtitle: "Comprehensive FAQ from beginner to advanced \u2014 variables, closures, prototypes, modules, async, ES2020+, debugging, careers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Frequently Asked Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>The questions we hear most often, answered directly.</p>
      ...
      <Section id="s1" title="1. Getting Started">
        <p>Do I need a framework? Which editor?</p>
        <Code lang="js">{`// Getting Started — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from getting started";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Language">
        <p>What is hoisting? Why let over var?</p>
        <Code lang="js">{`// Language — illustrative snippet
const example = () => {
  // apply concepts covered above
...
const example = () => {
  ...
  return "hello from async";
      ...
      <Section id="s4" title="4. Prototypes">
        <p>Class or prototypal inheritance?</p>
...
const example = () => {
  ...
  return "hello from modules";
      ...
      <Section id="s6" title="6. Careers">
        <p>How much JS is enough for a job?</p>
        <Code lang="js">{`// Careers — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from careers";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Frequently Asked Questions equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
