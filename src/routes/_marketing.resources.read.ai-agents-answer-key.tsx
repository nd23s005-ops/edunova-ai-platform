...
const RESOURCE: ReaderResource = {
  id: "ai-agents-answer-key",
  title: "AI Agents — Answer Key",
  category: "AI & Data",
  difficulty: "Beginner",
  readingTime: "27 min",
  pages: 38,
  ...
  heroSubtitle: "Detailed answer key with explanations for AI agent practice questions.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This answer key focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
