...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Advanced Flutter — multi-package Clean Architecture, custom render objects, isolates, and on-device AI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — modern, production-ready Flutter development.</li>
