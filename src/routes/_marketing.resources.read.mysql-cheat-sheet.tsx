...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "One-page MySQL cheat sheet — clauses, joins, admin, and one-liners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Cheat Sheet</b> — is designed to be self-contained: One-page MySQL cheat sheet — clauses, joins, admin, and one-liners.</p>
