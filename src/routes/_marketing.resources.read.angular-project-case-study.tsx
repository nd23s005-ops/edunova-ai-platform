...
const RESOURCE: ReaderResource = {
  id: "angular-project-case-study",
  title: "Angular — Project Case Study",
  ...
  heroSubtitle: 'Deep-dive case study of a production Angular project — architecture, state, and trade-offs.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Project Case Study</b> — is self-contained: Deep-dive case study of a production Angular project — architecture, state, and trade-offs.</p>
