...
const RESOURCE: ReaderResource = {
  id: "android-reference-guide",
  title: "Android Development — Reference Guide",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "31 min",
  pages: 69,
  ...
  heroSubtitle: 'The exhaustive Android reference — Kotlin, Compose, Jetpack, Retrofit, Room, and Play Console.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Reference Guide</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Reference Guide</b> — is self-contained: The exhaustive Android reference — Kotlin, Compose, Jetpack, Retrofit, Room, and Play Console.</p>
