...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page Flutter reference — Dart syntax, widgets, Riverpod, Bloc, and Firebase snippets.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — modern, production-ready Flutter development.</li>
