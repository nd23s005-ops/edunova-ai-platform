...
const RESOURCE: ReaderResource = {
  id: "postgresql-frequently-asked-questions",
  title: "PostgreSQL — Frequently Asked Questions",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "14 min",
  pages: 16,
  ...
  heroSubtitle: "Answers to the most common PostgreSQL questions from beginners and working developers.",
};
...
const RELATED = [
  { title: "PostgreSQL — Beginner Guide", tag: "SQL", time: "11 min" },
  { title: "PostgreSQL — Cheat Sheet", tag: "SQL", time: "6 min" },
  { title: "PostgreSQL — Interview Questions", tag: "SQL", time: "33 min" },
];

export const Route = createFileRoute("/_marketing/resources/read/postgresql-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Frequently Asked Questions</b> — is designed to be self-contained: Answers to the most common PostgreSQL questions from beginners and working developers.</p>
...
ORDER  BY 1;`}</Code>
      ...
      <Section id="references" title="Further Reading & Official References">
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li><a className="text-primary hover:underline" href="https://dev.mysql.com/doc/workbench/en/" target="_blank" rel="noreferrer">MySQL Workbench</a> · <a className="text-primary hover:underline" href="https://dev.mysql.com/doc/postgresql-shell/8.0/en/" target="_blank" rel="noreferrer">MySQL Shell</a></li>
