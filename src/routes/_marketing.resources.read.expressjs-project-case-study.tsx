...
const RESOURCE: ReaderResource = {
  id: "expressjs-project-case-study",
  title: "Express.js — Project Case Study",
  ...
  heroSubtitle: 'Anatomy of a real Express.js project — decisions, trade-offs, folder structure, and lessons learned.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Project Case Study</b> — is self-contained: Anatomy of a real Express.js project — decisions, trade-offs, folder structure, and lessons learned.</p>
