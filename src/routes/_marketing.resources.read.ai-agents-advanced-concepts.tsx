...
const RESOURCE: ReaderResource = {
  id: "ai-agents-advanced-concepts",
  title: "AI Agents — Advanced Concepts",
  category: "AI & Data",
  difficulty: "Advanced",
  readingTime: "40 min",
  pages: 40,
  ...
  heroSubtitle: "Advanced concepts — planning, reflection, multi-agent orchestration, MCP, and agent evaluation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This advanced concepts focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
