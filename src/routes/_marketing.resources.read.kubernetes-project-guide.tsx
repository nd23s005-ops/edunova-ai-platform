...
const RESOURCE: ReaderResource = {
  id: "kubernetes-project-guide",
  title: "Kubernetes — Project Guide",
  ...
  heroSubtitle: "Ship a production-grade Kubernetes project — Helm, GitOps, observability, and secure deployments.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-project-guide" }],
  }),
  component: Page,
});
