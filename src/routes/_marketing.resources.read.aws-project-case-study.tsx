...
const RESOURCE: ReaderResource = {
  id: "aws-project-case-study",
  title: "AWS — Project Case Study",
  ...
  heroSubtitle: "A worked AWS project case study — architecture, trade-offs, and lessons learned.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This project case study focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
