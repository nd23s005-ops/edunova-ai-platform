...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Deep, printable C++ notes covering the language, STL, templates, and production workflows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>PDF Notes</b> — practical, modern-C++ coverage.</li>
