...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-practice-questions",
  title: "Ethical Hacking — Practice Questions",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "32 min",
  pages: 26,
  ...
  heroSubtitle: "A workbook of theory, MCQ, and scenario-based practice questions across authorized testing, OWASP, MITRE, IR, cloud, and governance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A workbook of theory, MCQ, and scenario-based practice questions across authorized testing, OWASP, MITRE, IR, cloud, and governance. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
