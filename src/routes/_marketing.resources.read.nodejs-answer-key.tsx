...
const RESOURCE: ReaderResource = {
  id: "nodejs-answer-key",
  title: "Node.js — Answer Key",
  ...
  heroSubtitle: 'Worked answers and explanations for the Node.js practice set — code, reasoning, and edge cases.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready Node.js.</li>
