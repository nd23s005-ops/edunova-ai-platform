...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Modern DevOps best practices — trunk-based development, IaC, observability, DevSecOps, and SRE.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Modern DevOps best practices — trunk-based development, IaC, observability, DevSecOps, and SRE. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
