...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A concise glossary of AI agent, LLM, and RAG terminology.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This glossary focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
