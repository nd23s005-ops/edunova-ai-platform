...
const RESOURCE: ReaderResource = {
  id: "mysql-sample-exercises",
  title: "MySQL — Sample Exercises",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "16 min",
  pages: 32,
  ...
  heroSubtitle: "Bite-size MySQL exercises with sample schemas, expected outputs, and hints.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Sample Exercises</b> — is designed to be self-contained: Bite-size MySQL exercises with sample schemas, expected outputs, and hints.</p>
