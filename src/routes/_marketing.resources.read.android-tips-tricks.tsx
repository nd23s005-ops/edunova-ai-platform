...
const RESOURCE: ReaderResource = {
  id: "android-tips-tricks",
  title: "Android Development — Tips & Tricks",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "12 min",
  pages: 8,
  ...
  heroSubtitle: 'Practical Android tips that speed up Compose, debugging, and Play Store releases.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Tips & Tricks</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Tips & Tricks</b> — is self-contained: Practical Android tips that speed up Compose, debugging, and Play Store releases.</p>
