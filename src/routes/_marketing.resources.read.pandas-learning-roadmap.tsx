...
const RESOURCE: ReaderResource = {
  id: "pandas-learning-roadmap",
  title: "Pandas — Learning Roadmap",
  ...
  heroSubtitle: 'A staged roadmap for learning Pandas — from Series basics to enterprise data pipelines.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready Pandas.</li>
