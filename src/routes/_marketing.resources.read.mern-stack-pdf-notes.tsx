...
const RESOURCE: ReaderResource = {
  id: "mern-stack-pdf-notes",
  title: "MERN Stack — PDF Notes",
  ...
  heroSubtitle: 'Deep printable MERN notes — architecture, request lifecycle, MongoDB modeling, Express APIs, React patterns, and DevOps.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready MERN full-stack development.</li>
