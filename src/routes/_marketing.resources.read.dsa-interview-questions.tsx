...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "DSA interview handbook with 400+ questions: coding challenges, arrays, strings, linked lists, trees, graphs, DP, greedy, backtracking, bit manipulation, systematic patterns, HR questions, and mock interviews.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Interview Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>DSA interview handbook with 400+ questions: coding challenges, arrays, strings, linked lists, trees, graphs, DP, greedy, backtracking, bit manipulation, systematic patterns, HR questions, and mock interviews.</p>
