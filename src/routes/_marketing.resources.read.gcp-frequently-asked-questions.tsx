...
const RESOURCE: ReaderResource = {
  id: "gcp-frequently-asked-questions",
  title: "Google Cloud Platform — Frequently Asked Questions",
  ...
  heroSubtitle: "The most frequent questions about Google Cloud, answered clearly.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-frequently-asked-questions" }],
  }),
  component: Page,
});
