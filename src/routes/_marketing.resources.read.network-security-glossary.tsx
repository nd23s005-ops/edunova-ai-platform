...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A comprehensive alphabetical glossary of Network Security terminology — protocols, authentication, encryption, firewalls, IDS/IPS, VPNs, PKI, SIEM, Zero Trust, cloud networking, and compliance vocabulary with clear examples.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive alphabetical glossary of Network Security terminology — protocols, authentication, encryption, firewalls, IDS/IPS, VPNs, PKI, SIEM, Zero Trust, cloud networking, and compliance vocabulary with clear examples. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
