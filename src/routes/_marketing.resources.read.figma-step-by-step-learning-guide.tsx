...
const RESOURCE: ReaderResource = {
  id: "figma-step-by-step-learning-guide",
  title: "Figma — Step-by-Step Learning Guide",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "28 min",
  pages: 40,
  ...
  heroSubtitle: "A week-by-week Figma learning roadmap covering basics, interface mastery, Auto Layout, responsive design, design systems, prototyping, collaborative workflows, UI projects, portfolio building, and interview prep.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Step-by-Step Learning Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>A week-by-week Figma learning roadmap covering basics, interface mastery, Auto Layout, responsive design, design systems, prototyping, collaborative workflows, UI projects, portfolio building, and interview prep.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Step-by-Step Learning Guide</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
