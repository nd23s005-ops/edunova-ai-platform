...
const RESOURCE: ReaderResource = {
  id: "network-security-reference-guide",
  title: "Network Security — Reference Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "42 min",
  pages: 53,
  ...
  heroSubtitle: "A comprehensive reference handbook covering OSI/TCP-IP models, protocol tables, common ports, firewalls, VPNs, IDS/IPS, authentication, encryption, TLS/SSL, PKI, wireless, Zero Trust, compliance, and hardening checklists.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive reference handbook covering OSI/TCP-IP models, protocol tables, common ports, firewalls, VPNs, IDS/IPS, authentication, encryption, TLS/SSL, PKI, wireless, Zero Trust, compliance, and hardening checklists. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
