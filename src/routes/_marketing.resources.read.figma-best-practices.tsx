...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Figma best practices: file organization, naming conventions, Auto Layout, reusable components, variants, variables, accessibility, responsive design, Dev Mode, collaboration, and scalable design systems.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Best Practices.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Figma best practices: file organization, naming conventions, Auto Layout, reusable components, variants, variables, accessibility, responsive design, Dev Mode, collaboration, and scalable design systems.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Best Practices</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
