...
const RESOURCE: ReaderResource = {
  id: "javascript-learning-roadmap",
  ...
  heroSubtitle: "Structured roadmap \u2014 weekly plans, projects, milestones, portfolio, certifications, and career paths.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Phase 1 — Foundations (Weeks 1-4)" },
  { id: "s2", label: "2. Phase 2 — Intermediate (Weeks 5-8)" },
  { id: "s3", label: "3. Phase 3 — Framework (Weeks 9-12)" },
  { id: "s4", label: "4. Phase 4 — Backend (Weeks 13-16)" },
  { id: "s5", label: "5. Phase 5 — Portfolio & Job Search" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Learning Roadmap.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>A visual, milestone-driven roadmap to becoming a professional JavaScript developer.</p>
      ...
      <Section id="s1" title="1. Phase 1 — Foundations (Weeks 1-4)">
        <p>Syntax, DOM, small projects.</p>
        <Code lang="js">{`// Phase 1 — Foundations (Weeks 1-4) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from phase 1 — foundations (weeks 1-4)";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Phase 2 — Intermediate (Weeks 5-8)">
        <p>Async, modules, testing.</p>
        <Code lang="js">{`// Phase 2 — Intermediate (Weeks 5-8) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from phase 2 — intermediate (weeks 5-8)";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Phase 3 — Framework (Weeks 9-12)">
        <p>React or Vue + routing + state.</p>
        <Code lang="js">{`// Phase 3 — Framework (Weeks 9-12) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from phase 3 — framework (weeks 9-12)";
};`}</Code>
      </Section>

      <Section id="s4" title="4. Phase 4 — Backend (Weeks 13-16)">
        <p>Node.js, Express, databases.</p>
        <Code lang="js">{`// Phase 4 — Backend (Weeks 13-16) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from phase 4 — backend (weeks 13-16)";
};`}</Code>
      </Section>

      <Section id="s5" title="5. Phase 5 — Portfolio & Job Search">
        <p>3 flagship projects, interviews.</p>
        <Code lang="js">{`// Phase 5 — Portfolio & Job Search — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from phase 5 — portfolio & job search";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Learning Roadmap equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
