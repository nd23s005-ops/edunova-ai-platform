...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-sample-exercises",
  title: "Penetration Testing — Sample Exercises",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "23 min",
  pages: 23,
  ...
  heroSubtitle: "A workbook of 300+ educational exercises on threat modeling, vulnerability identification, risk assessment, OWASP recognition, security reporting, compliance mapping, defensive analysis, documentation, and remediation planning. Safe, simulated scenarios only.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A workbook of 300+ educational exercises on threat modeling, vulnerability identification, risk assessment, OWASP recognition, security reporting, compliance mapping, defensive analysis, documentation, and remediation planning. Safe, simulated scenarios only. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
