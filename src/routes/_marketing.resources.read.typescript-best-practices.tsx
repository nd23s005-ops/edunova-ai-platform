...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'TypeScript best practices — strict mode, narrowing, generics, and API design.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Best Practices</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Best Practices</b> — is self-contained: TypeScript best practices — strict mode, narrowing, generics, and API design.</p>
