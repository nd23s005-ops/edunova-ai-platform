...
const RESOURCE: ReaderResource = {
  id: "mern-stack-project-case-study",
  title: "MERN Stack — Project Case Study",
  ...
  heroSubtitle: 'Anatomy of a real MERN project — decisions, trade-offs, folder structure, and lessons learned.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready MERN full-stack development.</li>
