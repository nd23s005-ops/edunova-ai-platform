...
const RESOURCE: ReaderResource = {
  id: "nodejs-project-guide",
  title: "Node.js — Project Guide",
  ...
  heroSubtitle: 'Ship a production-grade Node.js backend — layout, REST APIs, DB, auth, tests, and deployment.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — practical, production-ready Node.js.</li>
