...
const RESOURCE: ReaderResource = {
  id: "nodejs-real-world-case-study",
  title: "Node.js — Real-world Case Study",
  ...
  heroSubtitle: 'How teams run Node.js in production — scaling, clustering, observability, and postmortems.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready Node.js.</li>
