...
const RESOURCE: ReaderResource = {
  id: "android-quick-revision-notes",
  title: "Android Development — Quick Revision Notes",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 5,
  ...
  heroSubtitle: 'Rapid Android revision — lifecycles, Jetpack, Compose, MVVM, and coroutines at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Quick Revision Notes</b> — is self-contained: Rapid Android revision — lifecycles, Jetpack, Compose, MVVM, and coroutines at a glance.</p>
