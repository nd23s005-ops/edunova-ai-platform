...
const RESOURCE: ReaderResource = {
  id: "kubernetes-complete-tutorial",
  ...
  heroSubtitle: "End-to-end Kubernetes tutorial — pods, deployments, services, networking, storage, and shipping to production.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-complete-tutorial" }],
  }),
  component: Page,
});
