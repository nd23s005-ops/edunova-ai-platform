...
const RESOURCE: ReaderResource = {
  id: "figma-advanced-concepts",
  title: "Figma — Advanced Concepts",
  category: "Design",
  difficulty: "Advanced",
  readingTime: "36 min",
  pages: 42,
  ...
  heroSubtitle: "Advanced Figma handbook: enterprise design systems, variables, design tokens, advanced Auto Layout, responsive patterns, interactive components, prototyping, Dev Mode workflows, accessibility, plugin development, version control, and multi-team collaboration.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Advanced Concepts.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced Figma handbook: enterprise design systems, variables, design tokens, advanced Auto Layout, responsive patterns, interactive components, prototyping, Dev Mode workflows, accessibility, plugin development, version control, and multi-team collaboration.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Advanced Concepts</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
