...
const RESOURCE: ReaderResource = {
  id: "computer-networks-glossary",
  title: "Computer Networks — Glossary",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "15 min",
  pages: 15,
  ...
  heroSubtitle: "Alphabetical networking glossary: TCP/IP, routing, switching, wireless, security, cloud, protocols, acronyms, and definitions with examples.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/computer-networks-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/computer-networks-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Alphabetical networking glossary: TCP/IP, routing, switching, wireless, security, cloud, protocols, acronyms, and definitions with examples.</p>
        <Figure src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=1400&q=80" caption="Figure 1 — Overview illustration for Computer Networks — Glossary." />
      </Section>

      <Section id="a" title="A — C">
        <p>ACL, ARP, BGP, Broadcast, CIDR, Collision Domain, CSMA/CD.</p>
      </Section>

      <Section id="d" title="D — G">
        <p>DHCP, DNS, EIGRP, Ethernet, Frame, Gateway.</p>
        <Figure src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=1400&q=80" caption="Figure 1 — Reference diagram for d — g." />
      </Section>

      <Section id="h" title="H — L">
        <p>HSRP, HTTP, ICMP, IPsec, LACP, LAN.</p>
      </Section>

      <Section id="m" title="M — R">
        <p>MAC, MPLS, NAT, OSPF, PAT, Ping, Routing.</p>
      </Section>

      <Section id="s" title="S — Z">
        <p>STP, Subnet, Switch, TCP, UDP, VLAN, VPN, VXLAN, WAN.</p>
      </Section>

      <Section id="acr" title="Common Acronyms">
        <p>AS, CIDR, GRE, MTU, MSS, RTT, SLA, SD-WAN, SLAAC.</p>
      </Section>
