...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Battle-tested Flutter practices — modularization, Clean Architecture, and testing.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Best Practices</b> — modern, production-ready Flutter development.</li>
