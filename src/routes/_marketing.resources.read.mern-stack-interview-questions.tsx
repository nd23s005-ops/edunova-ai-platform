...
const RESOURCE: ReaderResource = {
  id: "mern-stack-interview-questions",
  ...
  heroSubtitle: 'Curated MERN interview questions covering MongoDB, Express, React, Node, auth, system design, and architecture.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — practical, production-ready MERN full-stack development.</li>
