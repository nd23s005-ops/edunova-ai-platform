...
const RESOURCE: ReaderResource = {
  id: "ai-agents-reference-guide",
  title: "AI Agents — Reference Guide",
  category: "AI & Data",
  difficulty: "Beginner",
  readingTime: "30 min",
  pages: 73,
  ...
  heroSubtitle: "Reference guide for AI agents — frameworks, patterns, tool schemas, MCP, and evaluation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This reference guide focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
