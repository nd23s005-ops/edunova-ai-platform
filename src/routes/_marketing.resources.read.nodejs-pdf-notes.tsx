...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Deep printable Node.js notes — runtime, event loop, streams, networking, security, and performance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready Node.js.</li>
