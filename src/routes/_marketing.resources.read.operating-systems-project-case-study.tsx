...
const RESOURCE: ReaderResource = {
  id: "operating-systems-project-case-study",
  title: "Operating Systems — Project Case Study",
  category: "CS Core",
  ...
  heroSubtitle: "Production-level OS project case study: architecture, implementation, scheduling strategies, memory optimization, synchronization, testing, debugging, performance tuning, deployment, maintenance, and lessons learned.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Project Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Production-level OS project case study: architecture, implementation, scheduling strategies, memory optimization, synchronization, testing, debugging, performance tuning, deployment, maintenance, and lessons learned.</p>
