...
const RESOURCE: ReaderResource = {
  id: "c-programming-quick-revision-notes",
  title: "C Programming — Quick Revision Notes",
  ...
  heroSubtitle: "Fast recap of C syntax, pointers, and memory for exam or interview day.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-quick-revision-notes" }],
  }),
  component: Page,
});
