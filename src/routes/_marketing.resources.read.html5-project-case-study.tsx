...
const RESOURCE: ReaderResource = {
  id: "html5-project-case-study",
  title: "HTML5 — Project Case Study",
  ...
  heroSubtitle: "Production HTML5 case study \u2014 requirements, semantic structure, accessibility, SEO, deployment, testing, optimization.",
};
...
const TOC: TocItem[] = [
  ...
  { id: "s3", label: "3. Accessibility" },
  { id: "s4", label: "4. SEO Strategy" },
  { id: "s5", label: "5. Deployment" },
  { id: "s6", label: "6. Testing" },
  { id: "s7", label: "7. Optimization" },
  { id: "s8", label: "8. Outcomes" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Project Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Full journey of a real HTML5 project from brief to launch.</p>
      ...
      <Section id="s1" title="1. Context">
        <p>Business goals & user personas.</p>
        <Code lang="html">{`<!-- Context — illustrative snippet -->
<section aria-label="context">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s2" title="2. Architecture">
        <p>Component & page hierarchy.</p>
        <Code lang="html">{`<!-- Architecture — illustrative snippet -->
<section aria-label="architecture">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s3" title="3. Accessibility">
        <p>WCAG AA compliance journey.</p>
...
<section aria-label="accessibility">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s4" title="4. SEO Strategy">
        <p>OG, JSON-LD, sitemap.</p>
        <Code lang="html">{`<!-- SEO Strategy — illustrative snippet -->
<section aria-label="seo strategy">
  <h2>SEO Strategy</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>
...
<section aria-label="testing">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s7" title="7. Optimization">
        <p>LCP, CLS improvements.</p>
        <Code lang="html">{`<!-- Optimization — illustrative snippet -->
<section aria-label="optimization">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s8" title="8. Outcomes">
        <p>Traffic +3x, conversion +40%.</p>
        <Code lang="html">{`<!-- Outcomes — illustrative snippet -->
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Project Case Study equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
