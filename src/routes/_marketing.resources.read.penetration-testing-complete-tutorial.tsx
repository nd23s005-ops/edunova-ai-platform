...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-complete-tutorial",
  title: "Penetration Testing — Complete Tutorial",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "50 min",
  pages: 120,
  ...
  heroSubtitle: "A complete educational tutorial covering pentest methodologies, OSINT, vulnerability assessment, web/API/cloud security assessment concepts, reporting, remediation, compliance, and responsible disclosure. Ethical and defensive throughout.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete educational tutorial covering pentest methodologies, OSINT, vulnerability assessment, web/API/cloud security assessment concepts, reporting, remediation, compliance, and responsible disclosure. Ethical and defensive throughout. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
