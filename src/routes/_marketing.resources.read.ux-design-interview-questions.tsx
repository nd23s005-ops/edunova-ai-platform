...
const RESOURCE: ReaderResource = {
  id: "ux-design-interview-questions",
  ...
  heroSubtitle: "350+ UX Design interview questions \u2014 research, interviews, personas, journey mapping, information architecture, wireframing, prototyping, usability testing, accessibility, portfolio review, HR, and mock rounds.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Interview Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>350+ UX Design interview questions — research, interviews, personas, journey mapping, information architecture, wireframing, prototyping, usability testing, accessibility, portfolio review, HR, and mock rounds.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Interview Questions</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
