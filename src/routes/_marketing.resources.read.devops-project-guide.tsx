...
const RESOURCE: ReaderResource = {
  id: "devops-project-guide",
  title: "DevOps — Project Guide",
  ...
  heroSubtitle: "Ship a production-style DevOps project — GitOps pipeline, IaC, Kubernetes deployment, and observability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Ship a production-style DevOps project — GitOps pipeline, IaC, Kubernetes deployment, and observability. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
