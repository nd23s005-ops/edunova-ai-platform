...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "One-page kubectl and YAML cheat sheet — the commands and manifests you use every day.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-cheat-sheet" }],
  }),
  component: Page,
});
