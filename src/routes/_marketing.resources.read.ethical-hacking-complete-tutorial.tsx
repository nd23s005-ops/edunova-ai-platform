...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-complete-tutorial",
  title: "Ethical Hacking — Complete Tutorial",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "60 min",
  pages: 110,
  ...
  heroSubtitle: "A complete authorized-testing tutorial covering PTES, OWASP Top 10, MITRE ATT&CK, threat modeling, vulnerability management, cloud/container security, and reporting.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete authorized-testing tutorial covering PTES, OWASP Top 10, MITRE ATT&CK, threat modeling, vulnerability management, cloud/container security, and reporting. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
