...
const RESOURCE: ReaderResource = {
  id: "dsa-learning-roadmap",
  title: "Data Structures & Algorithms — Learning Roadmap",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "8 min",
  pages: 12,
  ...
  heroSubtitle: "DSA learning roadmap: fundamentals, coding practice schedules, problem-solving patterns, LeetCode progression, competitive programming, interview prep, and SWE career growth.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Learning Roadmap.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>DSA learning roadmap: fundamentals, coding practice schedules, problem-solving patterns, LeetCode progression, competitive programming, interview prep, and SWE career growth.</p>
