...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A single-page Docker cheat sheet — CLI commands, Dockerfile directives, Compose keys, and networking flags at your fingertips.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A single-page Docker cheat sheet — CLI commands, Dockerfile directives, Compose keys, and networking flags at your fingertips.</p>
