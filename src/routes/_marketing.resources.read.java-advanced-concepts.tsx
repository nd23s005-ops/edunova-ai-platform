...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Deep Java — JVM internals, GC tuning, virtual threads, modules, and pattern matching.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Advanced Concepts</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Advanced Concepts</b> — is designed to be self-contained: Deep Java — JVM internals, GC tuning, virtual threads, modules, and pattern matching.</p>
