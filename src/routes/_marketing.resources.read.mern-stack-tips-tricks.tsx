...
const RESOURCE: ReaderResource = {
  id: "mern-stack-tips-tricks",
  title: "MERN Stack — Tips & Tricks",
  ...
  heroSubtitle: 'Practical MERN tips that speed up development, debugging, and refactors.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Tips & Tricks</b> — practical, production-ready MERN full-stack development.</li>
