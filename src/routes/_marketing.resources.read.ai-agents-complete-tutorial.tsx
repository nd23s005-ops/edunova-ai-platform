...
const RESOURCE: ReaderResource = {
  id: "ai-agents-complete-tutorial",
  title: "AI Agents — Complete Tutorial",
  category: "AI & Data",
  difficulty: "Beginner",
  readingTime: "65 min",
  pages: 80,
  ...
  heroSubtitle: "End-to-end tutorial on building AI agents — LLMs, tool calling, RAG, memory, and multi-agent orchestration.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This complete tutorial focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
