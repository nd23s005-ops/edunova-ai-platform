...
const RESOURCE: ReaderResource = {
  id: "nextjs-common-mistakes",
  title: "Next.js — Common Mistakes",
  ...
  heroSubtitle: 'The most common Next.js mistakes and how to fix them — client boundaries, caching, and env.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Common Mistakes</b> — is self-contained: The most common Next.js mistakes and how to fix them — client boundaries, caching, and env.</p>
