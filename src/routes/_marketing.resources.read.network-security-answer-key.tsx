...
const RESOURCE: ReaderResource = {
  id: "network-security-answer-key",
  title: "Network Security — Answer Key",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "23 min",
  pages: 38,
  ...
  heroSubtitle: "A complete answer key with detailed explanations, architecture analysis, protocol discussions, defensive recommendations, best practices, evaluation rubrics, and learning references for the Practice Questions.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete answer key with detailed explanations, architecture analysis, protocol discussions, defensive recommendations, best practices, evaluation rubrics, and learning references for the Practice Questions. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
