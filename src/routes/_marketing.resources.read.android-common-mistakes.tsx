...
const RESOURCE: ReaderResource = {
  id: "android-common-mistakes",
  title: "Android Development — Common Mistakes",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "15 min",
  pages: 14,
  ...
  heroSubtitle: 'The Android pitfalls that ship bugs — memory leaks, ANRs, lifecycle, and security misses.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Common Mistakes</b> — is self-contained: The Android pitfalls that ship bugs — memory leaks, ANRs, lifecycle, and security misses.</p>
