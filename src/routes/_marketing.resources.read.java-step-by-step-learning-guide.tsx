...
const RESOURCE: ReaderResource = {
  id: "java-step-by-step-learning-guide",
  title: "Java — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A structured, incremental path from zero to confident Java developer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Step-by-Step Learning Guide</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Step-by-Step Learning Guide</b> — is designed to be self-contained: A structured, incremental path from zero to confident Java developer.</p>
