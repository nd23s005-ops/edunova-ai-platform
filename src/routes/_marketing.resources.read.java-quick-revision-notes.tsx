...
const RESOURCE: ReaderResource = {
  id: "java-quick-revision-notes",
  title: "Java — Quick Revision Notes",
  ...
  heroSubtitle: "Fast recap of Java syntax, OOP, and collections for exam or interview day.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Quick Revision Notes</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Quick Revision Notes</b> — is designed to be self-contained: Fast recap of Java syntax, OOP, and collections for exam or interview day.</p>
