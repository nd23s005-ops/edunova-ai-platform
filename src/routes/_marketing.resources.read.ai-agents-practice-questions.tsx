...
const RESOURCE: ReaderResource = {
  id: "ai-agents-practice-questions",
  ...
  heroSubtitle: "Practice questions covering agent fundamentals, RAG, tool use, and frameworks.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This practice questions focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
