...
const RESOURCE: ReaderResource = {
  id: "sql-frequently-asked-questions",
  title: "SQL — Frequently Asked Questions",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "14 min",
  pages: 11,
  ...
  heroSubtitle: "Answers to the most common SQL questions from beginners and working developers.",
};
...
const RELATED = [
  { title: "SQL — Beginner Guide", tag: "SQL", time: "11 min" },
  { title: "SQL — Cheat Sheet", tag: "SQL", time: "6 min" },
  { title: "SQL — Interview Questions", tag: "SQL", time: "33 min" },
];

export const Route = createFileRoute("/_marketing/resources/read/sql-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Frequently Asked Questions</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Frequently Asked Questions</b> — is designed to be self-contained: Answers to the most common SQL questions from beginners and working developers.</p>
...
ORDER  BY 1;`}</Code>
      ...
      <Section id="references" title="Further Reading & Official References">
        <ul className="list-disc space-y-1 pl-5">
          <li><a className="text-primary hover:underline" href="https://www.iso.org/standard/76583.html" target="_blank" rel="noreferrer">ISO SQL Standard</a> · <a className="text-primary hover:underline" href="https://www.postgresql.org/docs/" target="_blank" rel="noreferrer">PostgreSQL Docs</a></li>
          <li><a className="text-primary hover:underline" href="https://dev.mysql.com/doc/" target="_blank" rel="noreferrer">MySQL Docs</a> · <a className="text-primary hover:underline" href="https://mariadb.com/kb/en/documentation/" target="_blank" rel="noreferrer">MariaDB Docs</a> · <a className="text-primary hover:underline" href="https://www.sqlite.org/docs.html" target="_blank" rel="noreferrer">SQLite Docs</a></li>
          <li><a className="text-primary hover:underline" href="https://learn.microsoft.com/en-us/sql/t-sql/language-reference" target="_blank" rel="noreferrer">SQL Server T-SQL</a> · <a className="text-primary hover:underline" href="https://docs.oracle.com/en/database/" target="_blank" rel="noreferrer">Oracle Database</a></li>
