...
const RESOURCE: ReaderResource = {
  id: "data-analytics-complete-tutorial",
  title: "Data Analytics — Complete Tutorial",
  ...
  heroSubtitle: 'An end-to-end Data Analytics walkthrough — Excel, SQL, Python, statistics, BI, and dashboards.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, business-ready Data Analytics.</li>
