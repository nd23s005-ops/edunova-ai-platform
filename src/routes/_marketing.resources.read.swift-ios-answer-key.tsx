...
const RESOURCE: ReaderResource = {
  id: "swift-ios-answer-key",
  title: "Swift (iOS) — Answer Key",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "26 min",
  pages: 45,
  ...
  heroSubtitle: "Fully explained answers to the Swift/iOS practice set with step-by-step reasoning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Answer Key</b> — is designed to be self-contained: Fully explained answers to the Swift/iOS practice set with step-by-step reasoning.</p>
