...
const RESOURCE: ReaderResource = {
  id: "tableau-quick-revision-notes",
  title: "Tableau — Quick Revision Notes",
  ...
  heroSubtitle: "Quick revision notes to refresh Tableau essentials before an exam, certification, or interview — every core concept in a single scannable pass.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Quick revision notes to refresh Tableau essentials before an exam, certification, or interview — every core concept in a single scannable pass.</p>
