...
const RESOURCE: ReaderResource = {
  id: "numpy-learning-roadmap",
  title: "NumPy — Learning Roadmap",
  ...
  heroSubtitle: "A visual roadmap for NumPy \u2014 what to learn, in what order, and how to know you're ready.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Learning Roadmap</b> — is self-contained: A visual roadmap for NumPy — what to learn, in what order, and how to know you're ready.</p>
