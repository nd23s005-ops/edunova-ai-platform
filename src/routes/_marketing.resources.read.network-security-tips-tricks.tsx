...
const RESOURCE: ReaderResource = {
  id: "network-security-tips-tricks",
  title: "Network Security — Tips & Tricks",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "8 min",
  pages: 10,
  ...
  heroSubtitle: "A productivity guide covering troubleshooting, documentation, monitoring strategies, firewall management, VPN administration, logging, configuration management, automation, and workflow optimization.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A productivity guide covering troubleshooting, documentation, monitoring strategies, firewall management, VPN administration, logging, configuration management, automation, and workflow optimization. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
