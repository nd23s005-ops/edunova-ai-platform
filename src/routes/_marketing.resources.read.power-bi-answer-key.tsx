...
const RESOURCE: ReaderResource = {
  id: "power-bi-answer-key",
  title: "Power BI — Answer Key",
  ...
  heroSubtitle: "Detailed answer key explaining the reasoning, DAX formulas, and modeling decisions behind every Power BI practice question.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Detailed answer key explaining the reasoning, DAX formulas, and modeling decisions behind every Power BI practice question.</p>
