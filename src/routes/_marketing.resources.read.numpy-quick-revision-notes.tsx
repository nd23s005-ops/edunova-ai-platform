...
const RESOURCE: ReaderResource = {
  id: "numpy-quick-revision-notes",
  title: "NumPy — Quick Revision Notes",
  ...
  heroSubtitle: "Condensed one-pager revision notes for NumPy \u2014 perfect for exam eve or interview prep.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Quick Revision Notes</b> — is self-contained: Condensed one-pager revision notes for NumPy — perfect for exam eve or interview prep.</p>
