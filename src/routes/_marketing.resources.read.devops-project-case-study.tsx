...
const RESOURCE: ReaderResource = {
  id: "devops-project-case-study",
  title: "DevOps — Project Case Study",
  ...
  heroSubtitle: "Case study of a fintech DevOps transformation — pipelines, IaC, Kubernetes, and SRE outcomes.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Case study of a fintech DevOps transformation — pipelines, IaC, Kubernetes, and SRE outcomes. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
