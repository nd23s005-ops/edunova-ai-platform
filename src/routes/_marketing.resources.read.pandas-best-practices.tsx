...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Pandas best practices — vectorization, dtypes, memory, chained assignment, and reproducibility.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Best Practices</b> — practical, production-ready Pandas.</li>
