...
const RESOURCE: ReaderResource = {
  id: "vue-practice-questions",
  title: "Vue.js — Practice Questions",
  ...
  heroSubtitle: 'Hands-on Vue.js practice questions covering components, directives, routing, and state.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready Vue.js.</li>
