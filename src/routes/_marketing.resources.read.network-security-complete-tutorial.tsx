...
const RESOURCE: ReaderResource = {
  id: "network-security-complete-tutorial",
  title: "Network Security — Complete Tutorial",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "60 min",
  pages: 82,
  ...
  heroSubtitle: "A complete tutorial covering Network Security principles, secure architecture, firewalls, VLANs, VPNs, IDS/IPS, WAF, NAC, SIEM, DNS security, TLS/SSL, PKI, Zero Trust, cloud network security, monitoring, incident response, and compliance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete tutorial covering Network Security principles, secure architecture, firewalls, VLANs, VPNs, IDS/IPS, WAF, NAC, SIEM, DNS security, TLS/SSL, PKI, Zero Trust, cloud network security, monitoring, incident response, and compliance. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
