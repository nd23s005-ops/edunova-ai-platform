...
const RESOURCE: ReaderResource = {
  id: "javascript-step-by-step-learning-guide",
  title: "JavaScript — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A structured week-by-week JavaScript roadmap \u2014 daily plans, milestones, exercises, projects, and interview prep.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Week 1 — Syntax & Variables" },
  { id: "s2", label: "2. Week 2 — Functions & Scope" },
  { id: "s3", label: "3. Week 3 — Arrays & Objects" },
  { id: "s4", label: "4. Week 4 — DOM & Events" },
  { id: "s5", label: "5. Week 5 — Async & Fetch" },
  { id: "s6", label: "6. Week 6 — Modules & Tooling" },
  { id: "s7", label: "7. Week 7 — Classes & OOP" },
  { id: "s8", label: "8. Week 8 — Testing" },
  { id: "s9", label: "9. Week 9-10 — Capstone Project" },
  { id: "s10", label: "10. Week 11 — Interview Prep" },
  { id: "s11", label: "11. Week 12 — Portfolio & Deployment" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Step-by-Step Learning Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>This guide walks you through a 12-week disciplined path from beginner to job-ready JavaScript developer.</p>
      ...
      <Section id="s1" title="1. Week 1 — Syntax & Variables">
        <p>Types, operators, control flow.</p>
        <Code lang="js">{`// Week 1 — Syntax & Variables — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 1 — syntax & variables";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Week 2 — Functions & Scope">
        <p>Closures, arrow, higher-order functions.</p>
        <Code lang="js">{`// Week 2 — Functions & Scope — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 2 — functions & scope";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Week 3 — Arrays & Objects">
        <p>Destructuring, spread, methods.</p>
        <Code lang="js">{`// Week 3 — Arrays & Objects — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 3 — arrays & objects";
};`}</Code>
      </Section>

      <Section id="s4" title="4. Week 4 — DOM & Events">
        <p>Interactive to-do app.</p>
        <Code lang="js">{`// Week 4 — DOM & Events — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 4 — dom & events";
};`}</Code>
      </Section>

      <Section id="s5" title="5. Week 5 — Async & Fetch">
        <p>Promises, async/await, real APIs.</p>
        <Code lang="js">{`// Week 5 — Async & Fetch — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 5 — async & fetch";
};`}</Code>
      </Section>

      <Section id="s6" title="6. Week 6 — Modules & Tooling">
        <p>Vite, ESLint, Prettier.</p>
        <Code lang="js">{`// Week 6 — Modules & Tooling — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 6 — modules & tooling";
};`}</Code>
      </Section>

      <Section id="s7" title="7. Week 7 — Classes & OOP">
        <p>Inheritance, encapsulation.</p>
        <Code lang="js">{`// Week 7 — Classes & OOP — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 7 — classes & oop";
};`}</Code>
      </Section>

      <Section id="s8" title="8. Week 8 — Testing">
        <p>Vitest fundamentals.</p>
        <Code lang="js">{`// Week 8 — Testing — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 8 — testing";
};`}</Code>
      </Section>

      <Section id="s9" title="9. Week 9-10 — Capstone Project">
        <p>Full-stack task manager.</p>
        <Code lang="js">{`// Week 9-10 — Capstone Project — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 9-10 — capstone project";
};`}</Code>
      </Section>

      <Section id="s10" title="10. Week 11 — Interview Prep">
        <p>Coding drills, system design.</p>
        <Code lang="js">{`// Week 11 — Interview Prep — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 11 — interview prep";
};`}</Code>
      </Section>

      <Section id="s11" title="11. Week 12 — Portfolio & Deployment">
        <p>Netlify/Vercel, README polish.</p>
        <Code lang="js">{`// Week 12 — Portfolio & Deployment — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from week 12 — portfolio & deployment";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Step-by-Step Learning Guide equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
