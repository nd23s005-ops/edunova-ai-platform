...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Comprehensive C++ reference — syntax, STL, templates, memory model, and tooling.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Reference Guide</b> — practical, modern-C++ coverage.</li>
