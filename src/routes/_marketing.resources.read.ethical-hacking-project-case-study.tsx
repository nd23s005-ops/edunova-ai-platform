...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-project-case-study",
  title: "Ethical Hacking — Project Case Study",
  category: "Security",
  ...
  heroSubtitle: "A detailed authorized project case study — scoping, threat modeling, findings prioritization, executive reporting, and remediation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A detailed authorized project case study — scoping, threat modeling, findings prioritization, executive reporting, and remediation. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
