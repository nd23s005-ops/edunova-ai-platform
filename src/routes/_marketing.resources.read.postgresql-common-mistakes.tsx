...
const RESOURCE: ReaderResource = {
  id: "postgresql-common-mistakes",
  title: "PostgreSQL — Common Mistakes",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 17,
  ...
  heroSubtitle: "N+1 queries, missing indexes, cartesian joins, and other classic PostgreSQL pitfalls.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Common Mistakes</b> — is designed to be self-contained: N+1 queries, missing indexes, cartesian joins, and other classic PostgreSQL pitfalls.</p>
