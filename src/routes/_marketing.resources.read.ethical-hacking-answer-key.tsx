...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-answer-key",
  title: "Ethical Hacking — Answer Key",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "33 min",
  pages: 24,
  ...
  heroSubtitle: "Detailed answer key with explanations, defensive recommendations, evaluation rubrics, and references matching the Practice Questions.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Detailed answer key with explanations, defensive recommendations, evaluation rubrics, and references matching the Practice Questions. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
