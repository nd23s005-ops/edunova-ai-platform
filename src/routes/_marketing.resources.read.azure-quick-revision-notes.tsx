...
const RESOURCE: ReaderResource = {
  id: "azure-quick-revision-notes",
  title: "Microsoft Azure — Quick Revision Notes",
  ...
  heroSubtitle: "Fast-recall Azure notes for interviews and AZ-900/AZ-104 revision.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Fast-recall Azure notes for interviews and AZ-900/AZ-104 revision. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
