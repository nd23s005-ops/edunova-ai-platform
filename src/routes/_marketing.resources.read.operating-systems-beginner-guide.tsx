...
const RESOURCE: ReaderResource = {
  id: "operating-systems-beginner-guide",
  title: "Operating Systems — Beginner Guide",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "15 min",
  pages: 20,
  ...
  heroSubtitle: "Beginner-friendly Operating Systems guide: fundamentals, kernel, user mode, processes, threads, scheduling, memory management, filesystems, device management, system calls, virtualization, Linux basics, and real-world examples.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Beginner Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Beginner-friendly Operating Systems guide: fundamentals, kernel, user mode, processes, threads, scheduling, memory management, filesystems, device management, system calls, virtualization, Linux basics, and real-world examples.</p>
