...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A friendly first tour of MongoDB — documents, collections, BSON, and running your first queries.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready MongoDB.</li>
