...
const RESOURCE: ReaderResource = {
  id: "azure-learning-roadmap",
  title: "Microsoft Azure — Learning Roadmap",
  ...
  heroSubtitle: "Roadmap to become a job-ready Azure engineer — AZ-900, AZ-104, AZ-204, AZ-305, and AI-900.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Roadmap to become a job-ready Azure engineer — AZ-900, AZ-104, AZ-204, AZ-305, and AI-900. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
...
az monitor app-insights component create -g rg-app -a ai-my-web --location eastus`}</Code>
      ...
      <Section id="roadmap" title="Azure Certification Roadmap">
        <ol className="list-decimal space-y-1 pl-5">
          <li><b>AZ-900</b> — Azure Fundamentals: cloud concepts, core services, pricing.</li>
          <li><b>AI-900</b> — AI Fundamentals on Azure.</li>
          <li><b>AZ-104</b> — Azure Administrator: identity, storage, compute, networking.</li>
          <li><b>AZ-204</b> — Azure Developer: App Service, Functions, storage SDKs, Cosmos DB.</li>
          <li><b>AZ-305</b> — Azure Solutions Architect Expert: designing enterprise workloads.</li>
          <li>Optional specialties — Security (AZ-500), Data (DP-203), DevOps (AZ-400).</li>
        </ol>
      </Section>
