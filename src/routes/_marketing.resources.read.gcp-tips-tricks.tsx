...
const RESOURCE: ReaderResource = {
  id: "gcp-tips-tricks",
  title: "Google Cloud Platform — Tips & Tricks",
  ...
  heroSubtitle: "Practical tips and tricks to work faster and safer on Google Cloud.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-tips-tricks" }],
  }),
  component: Page,
});
