...
const RESOURCE: ReaderResource = {
  id: "cyber-security-common-mistakes",
  title: "Cyber Security — Common Mistakes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "16 min",
  pages: 17,
  ...
  heroSubtitle: "Common mistakes in cybersecurity programs — weak IAM, flat networks, poor monitoring, unpatched systems, missing IR playbooks.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Common mistakes in cybersecurity programs — weak IAM, flat networks, poor monitoring, unpatched systems, missing IR playbooks. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
