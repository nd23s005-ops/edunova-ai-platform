...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Idiomatic PostgreSQL — clean queries, safe transactions, indexing, and maintainability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Best Practices</b> — is designed to be self-contained: Idiomatic PostgreSQL — clean queries, safe transactions, indexing, and maintainability.</p>
