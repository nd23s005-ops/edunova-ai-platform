...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Advanced AWS concepts — multi-account landing zones, hybrid networking, service meshes, and platform engineering.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This advanced concepts focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
