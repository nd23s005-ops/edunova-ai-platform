...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Change detection internals, zoneless Angular, deferrable views, micro frontends, and advanced patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Advanced Concepts</b> — is self-contained: Change detection internals, zoneless Angular, deferrable views, micro frontends, and advanced patterns.</p>
