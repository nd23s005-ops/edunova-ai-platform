...
const RESOURCE: ReaderResource = {
  id: "numpy-step-by-step-learning-guide",
  title: "NumPy — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A structured, week-by-week study plan for NumPy with milestones, exercises, and self-checks.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Step-by-Step Learning Guide</b> — is self-contained: A structured, week-by-week study plan for NumPy with milestones, exercises, and self-checks.</p>
