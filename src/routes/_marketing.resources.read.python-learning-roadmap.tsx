...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A month-by-month Python roadmap from beginner to production-ready engineer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Learning Roadmap</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Learning Roadmap</b> — is designed to be self-contained: A month-by-month Python roadmap from beginner to production-ready engineer.</p>
