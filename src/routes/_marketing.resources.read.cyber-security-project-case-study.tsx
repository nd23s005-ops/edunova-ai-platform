...
const RESOURCE: ReaderResource = {
  id: "cyber-security-project-case-study",
  title: "Cyber Security — Project Case Study",
  category: "Security",
  ...
  heroSubtitle: "A detailed defensive project case study — scoping, threat modeling, control design, and operational reporting.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A detailed defensive project case study — scoping, threat modeling, control design, and operational reporting. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
