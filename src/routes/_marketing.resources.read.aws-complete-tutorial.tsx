...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "End-to-end AWS tutorial covering compute, storage, networking, security, and DevOps on Amazon Web Services.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This complete tutorial focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
