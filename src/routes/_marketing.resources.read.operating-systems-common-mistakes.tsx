...
const RESOURCE: ReaderResource = {
  id: "operating-systems-common-mistakes",
  title: "Operating Systems — Common Mistakes",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "13 min",
  pages: 17,
  ...
  heroSubtitle: "OS troubleshooting handbook: scheduling mistakes, synchronization bugs, deadlocks, race conditions, paging errors, segmentation faults, virtual memory issues, Linux permissions, and filesystem errors.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Common Mistakes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>OS troubleshooting handbook: scheduling mistakes, synchronization bugs, deadlocks, race conditions, paging errors, segmentation faults, virtual memory issues, Linux permissions, and filesystem errors.</p>
