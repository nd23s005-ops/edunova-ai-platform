...
const RESOURCE: ReaderResource = {
  id: "docker-quick-revision-notes",
  title: "Docker — Quick Revision Notes",
  ...
  heroSubtitle: "Quick revision notes to refresh Docker essentials before an interview or certification — every core concept in a single scannable pass.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Quick revision notes to refresh Docker essentials before an interview or certification — every core concept in a single scannable pass.</p>
