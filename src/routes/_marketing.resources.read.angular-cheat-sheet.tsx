...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page Angular cheat sheet — CLI, bindings, directives, pipes, RxJS, and signals at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Cheat Sheet</b> — is self-contained: One-page Angular cheat sheet — CLI, bindings, directives, pipes, RxJS, and signals at a glance.</p>
