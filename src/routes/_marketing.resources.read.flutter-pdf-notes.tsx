...
const RESOURCE: ReaderResource = {
  id: "flutter-pdf-notes",
  title: "Flutter — PDF Notes",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "79 min",
  pages: 130,
  ...
  heroSubtitle: 'Deep printable Flutter notes — Dart, widgets, state, Firebase, testing, performance, and multi-platform delivery.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — modern, production-ready Flutter development.</li>
