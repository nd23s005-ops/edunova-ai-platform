...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-beginner-guide",
  title: "Ethical Hacking — Beginner Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 26,
  ...
  heroSubtitle: "A beginner-friendly, ethics-first introduction to authorized security testing — hacker categories, legal responsibilities, PTES, OWASP, NIST, and defensive fundamentals.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A beginner-friendly, ethics-first introduction to authorized security testing — hacker categories, legal responsibilities, PTES, OWASP, NIST, and defensive fundamentals. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
