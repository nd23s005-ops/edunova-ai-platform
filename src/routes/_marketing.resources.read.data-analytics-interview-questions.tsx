...
const RESOURCE: ReaderResource = {
  id: "data-analytics-interview-questions",
  ...
  heroSubtitle: 'Curated Data Analytics interview questions across Excel, SQL, Python, statistics, and case studies.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — practical, business-ready Data Analytics.</li>
