...
const RESOURCE: ReaderResource = {
  id: "postgresql-project-case-study",
  title: "PostgreSQL — Project Case Study",
  category: "Databases",
  ...
  heroSubtitle: "Full case study of a PostgreSQL project — schema, indexes, JSONB, and delivery.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Project Case Study</b> — is designed to be self-contained: Full case study of a PostgreSQL project — schema, indexes, JSONB, and delivery.</p>
