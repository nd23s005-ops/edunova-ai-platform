...
const RESOURCE: ReaderResource = {
  id: "expressjs-quick-revision-notes",
  title: "Express.js — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid Express.js revision — routes, middleware, request/response, and REST essentials at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Quick Revision Notes</b> — is self-contained: Rapid Express.js revision — routes, middleware, request/response, and REST essentials at a glance.</p>
