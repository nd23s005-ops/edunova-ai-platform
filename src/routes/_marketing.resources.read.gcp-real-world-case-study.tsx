...
const RESOURCE: ReaderResource = {
  id: "gcp-real-world-case-study",
  title: "Google Cloud Platform — Real-world Case Study",
  ...
  heroSubtitle: "Real-world GCP case study covering scale, reliability, security, and cost.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-real-world-case-study" }],
  }),
  component: Page,
});
