...
const RESOURCE: ReaderResource = {
  id: "azure-advanced-concepts",
  title: "Microsoft Azure — Advanced Concepts",
  ...
  heroSubtitle: "Advanced Azure — landing zones, hub-spoke networking, private endpoints, AKS, and enterprise-scale patterns.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced Azure — landing zones, hub-spoke networking, private endpoints, AKS, and enterprise-scale patterns. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
