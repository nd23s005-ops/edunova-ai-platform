...
const RESOURCE: ReaderResource = {
  id: "javascript-beginner-guide",
  title: "JavaScript — Beginner Guide",
  ...
  heroSubtitle: "A friendly first walk through JavaScript \u2014 variables, data types, functions, arrays, objects, DOM, events, and ES6+ with real-world analogies.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Variables & Types" },
  { id: "s2", label: "2. Operators & Control Flow" },
  { id: "s3", label: "3. Functions" },
  { id: "s4", label: "4. Arrays & Objects" },
  { id: "s5", label: "5. DOM Manipulation" },
  { id: "s6", label: "6. Events" },
  { id: "s7", label: "7. ES6+ Essentials" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Beginner Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>JavaScript is the language of the web — the only language browsers natively speak. It powers dynamic UIs, backends via Node.js, mobile apps, and even embedded devices.</p>
      ...
      <Section id="s1" title="1. Variables & Types">
        <p>let/const/var, primitives (string, number, boolean, null, undefined, symbol, bigint), and objects.</p>
        <Code lang="js">{`// Variables & Types — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from variables & types";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Operators & Control Flow">
        <p>Arithmetic, comparison, logical, ternary, if/else, switch, loops (for, while, for-of, for-in).</p>
        <Code lang="js">{`// Operators & Control Flow — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from operators & control flow";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Functions">
        <p>Declarations, expressions, arrow functions, default & rest params, closures.</p>
        <Code lang="js">{`// Functions — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from functions";
      ...
      <Section id="s4" title="4. Arrays & Objects">
        <p>Literal syntax, destructuring, spread/rest, common array methods.</p>
        <Code lang="js">{`// Arrays & Objects — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from arrays & objects";
};`}</Code>
      </Section>

      <Section id="s5" title="5. DOM Manipulation">
        <p>querySelector, textContent, classList, createElement, appendChild.</p>
        <Code lang="js">{`// DOM Manipulation — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from dom manipulation";
};`}</Code>
      </Section>

      <Section id="s6" title="6. Events">
        <p>addEventListener, event object, delegation, preventDefault.</p>
        <Code lang="js">{`// Events — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from events";
      ...
      <Section id="s7" title="7. ES6+ Essentials">
        <p>let/const, template literals, arrow fns, destructuring, modules.</p>
        <Code lang="js">{`// ES6+ Essentials — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from es6+ essentials";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Beginner Guide equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
