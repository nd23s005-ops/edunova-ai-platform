...
const RESOURCE: ReaderResource = {
  id: "ux-design-quick-revision-notes",
  title: "UX Design — Quick Revision Notes",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "6 min",
  pages: 4,
  ...
  heroSubtitle: "Concise UX Design revision notes optimized for interviews and rapid revision \u2014 UX lifecycle summaries, research methods, usability heuristics, accessibility reminders, and UX workflow references.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Quick Revision Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Concise UX Design revision notes optimized for interviews and rapid revision — UX lifecycle summaries, research methods, usability heuristics, accessibility reminders, and UX workflow references.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Quick Revision Notes</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
