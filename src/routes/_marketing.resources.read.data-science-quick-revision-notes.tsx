...
const RESOURCE: ReaderResource = {
  id: "data-science-quick-revision-notes",
  title: "Data Science — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid Data Science revision — statistics, Pandas, ML algorithms, and metrics at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-science-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-science-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready Data Science.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Data Science combines <b>statistics</b>, <b>programming</b>, and <b>domain knowledge</b> to turn raw data into decisions and products. From dashboards and forecasts to recommender systems and LLM agents, it's the discipline behind most modern data-driven features. This resource — <b>Data Science — Quick Revision Notes</b> — is self-contained: Rapid Data Science revision — statistics, Pandas, ML algorithms, and metrics at a glance.</p>
