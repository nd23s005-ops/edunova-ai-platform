...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Curated Docker interview questions — conceptual, hands-on, and scenario-based — covering images, layers, networking, volumes, and security.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Curated Docker interview questions — conceptual, hands-on, and scenario-based — covering images, layers, networking, volumes, and security.</p>
