...
const RESOURCE: ReaderResource = {
  id: "mysql-beginner-guide",
  title: "MySQL — Beginner Guide",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 21,
  ...
  heroSubtitle: "A friendly first tour of MyMySQL — install, connect, tables, and your first real queries.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Beginner Guide</b> — is designed to be self-contained: A friendly first tour of MyMySQL — install, connect, tables, and your first real queries.</p>
