...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-beginner-guide",
  title: "Tailwind CSS — Beginner Guide",
  ...
  heroSubtitle: 'A friendly first tour of Tailwind CSS — utility-first classes, responsive design, and shipping your first UI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready Tailwind CSS.</li>
