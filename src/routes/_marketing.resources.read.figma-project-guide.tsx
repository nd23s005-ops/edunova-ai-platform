...
const RESOURCE: ReaderResource = {
  id: "figma-project-guide",
  title: "Figma — Project Guide",
  category: "Design",
  ...
  heroSubtitle: "Complete Figma project guide: UI/UX planning, wireframing, low- and high-fidelity design, Auto Layout, responsive interfaces, reusable components, design systems, prototyping, developer handoff, usability testing, and evaluation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Project Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete Figma project guide: UI/UX planning, wireframing, low- and high-fidelity design, Auto Layout, responsive interfaces, reusable components, design systems, prototyping, developer handoff, usability testing, and evaluation.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Project Guide</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
