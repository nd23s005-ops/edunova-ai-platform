...
const RESOURCE: ReaderResource = {
  id: "ai-agents-common-mistakes",
  title: "AI Agents — Common Mistakes",
  category: "AI & Data",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 11,
  ...
  heroSubtitle: "Common mistakes when building AI agents and how to avoid them.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This common mistakes focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
