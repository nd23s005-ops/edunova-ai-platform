...
const RESOURCE: ReaderResource = {
  id: "gcp-complete-tutorial",
  title: "Google Cloud Platform — Complete Tutorial",
  ...
  heroSubtitle: "End-to-end tutorial covering compute, storage, networking, databases, GKE, and CI/CD on Google Cloud.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-complete-tutorial" }],
  }),
  component: Page,
});
