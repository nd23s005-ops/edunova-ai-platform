...
const RESOURCE: ReaderResource = {
  id: "aws-sample-exercises",
  title: "AWS — Sample Exercises",
  ...
  heroSubtitle: "Hands-on AWS exercises — launching EC2, configuring VPC, S3, IAM, and Lambda.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This sample exercises focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
