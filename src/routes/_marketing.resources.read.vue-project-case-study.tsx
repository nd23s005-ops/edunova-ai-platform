...
const RESOURCE: ReaderResource = {
  id: "vue-project-case-study",
  title: "Vue.js — Project Case Study",
  ...
  heroSubtitle: 'Deep-dive case study of a production Vue.js project — architecture, state, and trade-offs.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready Vue.js.</li>
