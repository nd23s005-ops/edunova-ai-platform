...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A complete reference for CSS3 syntax, selectors, properties, and modern functions.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Reference Guide</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Reference Guide</b> — is self-contained: A complete reference for CSS3 syntax, selectors, properties, and modern functions.</p>
