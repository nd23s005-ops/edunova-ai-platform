...
const RESOURCE: ReaderResource = {
  id: "tableau-advanced-concepts",
  title: "Tableau — Advanced Concepts",
  ...
  heroSubtitle: "Advanced Tableau concepts — nested LOD, table calc addressing, Tableau APIs, embedding, extensions, and enterprise-scale performance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced Tableau concepts — nested LOD, table calc addressing, Tableau APIs, embedding, extensions, and enterprise-scale performance.</p>
