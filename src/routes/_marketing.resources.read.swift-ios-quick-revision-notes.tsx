...
const RESOURCE: ReaderResource = {
  id: "swift-ios-quick-revision-notes",
  title: "Swift (iOS) — Quick Revision Notes",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 6,
  ...
  heroSubtitle: "Fast recap of Swift syntax, SwiftUI, and iOS APIs for interview day.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Quick Revision Notes</b> — is designed to be self-contained: Fast recap of Swift syntax, SwiftUI, and iOS APIs for interview day.</p>
