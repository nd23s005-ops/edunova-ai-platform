...
const RESOURCE: ReaderResource = {
  id: "tableau-beginner-guide",
  title: "Tableau — Beginner Guide",
  ...
  heroSubtitle: "This beginner guide introduces Tableau — the industry-leading visual analytics platform for turning data into interactive dashboards, stories, and business insights.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>This beginner guide introduces Tableau — the industry-leading visual analytics platform for turning data into interactive dashboards, stories, and business insights.</p>
