...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-interview-questions",
  ...
  heroSubtitle: 'Curated Tailwind CSS interview questions on utility-first design, theming, and performance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — practical, production-ready Tailwind CSS.</li>
