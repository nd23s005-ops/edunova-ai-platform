...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-sample-exercises",
  title: "Tailwind CSS — Sample Exercises",
  ...
  heroSubtitle: 'Short, focused Tailwind CSS exercises for utilities, Flex, Grid, dark mode, and responsive design.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready Tailwind CSS.</li>
