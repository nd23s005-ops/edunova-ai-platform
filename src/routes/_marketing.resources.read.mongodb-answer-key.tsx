...
const RESOURCE: ReaderResource = {
  id: "mongodb-answer-key",
  title: "MongoDB — Answer Key",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "32 min",
  pages: 43,
  ...
  heroSubtitle: 'Worked answers and explanations for the MongoDB practice set — queries, pipelines, and edge cases.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready MongoDB.</li>
