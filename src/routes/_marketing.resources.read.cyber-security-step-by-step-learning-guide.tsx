...
const RESOURCE: ReaderResource = {
  id: "cyber-security-step-by-step-learning-guide",
  title: "Cyber Security — Step-by-Step Learning Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "27 min",
  pages: 37,
  ...
  heroSubtitle: "A structured, week-by-week cyber security learning path from fundamentals to SOC-ready defensive skills and certifications.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured, week-by-week cyber security learning path from fundamentals to SOC-ready defensive skills and certifications. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
