...
const RESOURCE: ReaderResource = {
  id: "data-science-project-case-study",
  title: "Data Science — Project Case Study",
  ...
  heroSubtitle: 'Anatomy of a real Data Science project — decisions, trade-offs, and lessons learned.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-science-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-science-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready Data Science.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Data Science combines <b>statistics</b>, <b>programming</b>, and <b>domain knowledge</b> to turn raw data into decisions and products. From dashboards and forecasts to recommender systems and LLM agents, it's the discipline behind most modern data-driven features. This resource — <b>Data Science — Project Case Study</b> — is self-contained: Anatomy of a real Data Science project — decisions, trade-offs, and lessons learned.</p>
