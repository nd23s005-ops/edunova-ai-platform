...
const RESOURCE: ReaderResource = {
  id: "nodejs-step-by-step-learning-guide",
  title: "Node.js — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive Node.js path — install, REPL, modules, async, HTTP servers, databases, and production.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready Node.js.</li>
