...
const RESOURCE: ReaderResource = {
  id: "network-security-interview-questions",
  ...
  heroSubtitle: "A comprehensive Network Security interview handbook covering 350+ questions across TCP/IP, OSI, firewalls, IDS/IPS, VPNs, Zero Trust, SIEM, incident response, DNS, wireless, and compliance for Network/SOC/Cloud/Infrastructure Security roles.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive Network Security interview handbook covering 350+ questions across TCP/IP, OSI, firewalls, IDS/IPS, VPNs, Zero Trust, SIEM, incident response, DNS, wireless, and compliance for Network/SOC/Cloud/Infrastructure Security roles. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
