...
const RESOURCE: ReaderResource = {
  id: "mysql-tips-tricks",
  title: "MySQL — Tips & Tricks",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 10,
  ...
  heroSubtitle: "Practical MySQL tips — CTEs, window functions, and shortcuts that save time.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Tips & Tricks</b> — is designed to be self-contained: Practical MySQL tips — CTEs, window functions, and shortcuts that save time.</p>
