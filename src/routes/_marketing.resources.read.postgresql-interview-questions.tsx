...
const RESOURCE: ReaderResource = {
  id: "postgresql-interview-questions",
  ...
  heroSubtitle: "Curated PostgreSQL interview questions — joins, JSONB, indexes, MVCC, and tuning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Interview Questions</b> — is designed to be self-contained: Curated PostgreSQL interview questions — joins, JSONB, indexes, MVCC, and tuning.</p>
