...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page Node.js reference — CLI, fs, http, stream, buffer, and common npm scripts.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready Node.js.</li>
