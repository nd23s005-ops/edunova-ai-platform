...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A comprehensive NumPy reference \u2014 creation, indexing, math, linear algebra, random, and I/O.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Reference Guide</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Reference Guide</b> — is self-contained: A comprehensive NumPy reference — creation, indexing, math, linear algebra, random, and I/O.</p>
