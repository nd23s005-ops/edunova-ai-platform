...
const RESOURCE: ReaderResource = {
  id: "dsa-quick-revision-notes",
  title: "Data Structures & Algorithms — Quick Revision Notes",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 4,
  ...
  heroSubtitle: "Concise DSA revision notes for exams and coding interviews: complexity charts, algorithm summaries, common formulas, problem-solving patterns, and quick lookup tables.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Quick Revision Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Concise DSA revision notes for exams and coding interviews: complexity charts, algorithm summaries, common formulas, problem-solving patterns, and quick lookup tables.</p>
