...
const RESOURCE: ReaderResource = {
  id: "docker-sample-exercises",
  title: "Docker — Sample Exercises",
  ...
  heroSubtitle: "Hands-on Docker exercises — build multi-stage images, wire up Compose stacks, mount volumes, and secure containers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Hands-on Docker exercises — build multi-stage images, wire up Compose stacks, mount volumes, and secure containers.</p>
