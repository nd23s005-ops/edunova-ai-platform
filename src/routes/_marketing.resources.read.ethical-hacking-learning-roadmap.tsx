...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-learning-roadmap",
  title: "Ethical Hacking — Learning Roadmap",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "7 min",
  pages: 12,
  ...
  heroSubtitle: "A structured ethical hacking learning roadmap — networking, Linux, OWASP, cloud, certifications, portfolio, interviews, and career progression.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured ethical hacking learning roadmap — networking, Linux, OWASP, cloud, certifications, portfolio, interviews, and career progression. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
