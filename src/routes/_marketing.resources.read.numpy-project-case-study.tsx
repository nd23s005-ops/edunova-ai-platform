...
const RESOURCE: ReaderResource = {
  id: "numpy-project-case-study",
  title: "NumPy — Project Case Study",
  ...
  heroSubtitle: "A production project built with NumPy \u2014 background, architecture, decisions, and outcomes.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Project Case Study</b> — is self-contained: A production project built with NumPy — background, architecture, decisions, and outcomes.</p>
