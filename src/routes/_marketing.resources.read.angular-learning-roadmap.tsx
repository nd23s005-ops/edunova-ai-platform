...
const RESOURCE: ReaderResource = {
  id: "angular-learning-roadmap",
  title: "Angular — Learning Roadmap",
  ...
  heroSubtitle: 'A staged roadmap for learning Angular — from CLI basics to enterprise-scale SPAs.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Learning Roadmap</b> — is self-contained: A staged roadmap for learning Angular — from CLI basics to enterprise-scale SPAs.</p>
