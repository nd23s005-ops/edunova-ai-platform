...
const RESOURCE: ReaderResource = {
  id: "gcp-answer-key",
  title: "Google Cloud Platform — Answer Key",
  ...
  heroSubtitle: "Detailed answers and explanations for the GCP practice questions.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-answer-key" }],
  }),
  component: Page,
});
