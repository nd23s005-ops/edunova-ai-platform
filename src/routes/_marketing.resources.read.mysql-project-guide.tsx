...
const RESOURCE: ReaderResource = {
  id: "mysql-project-guide",
  title: "MySQL — Project Guide",
  category: "Databases",
  ...
  heroSubtitle: "Build real MySQL projects — analytics dashboards, reporting layers, and OLTP schemas.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Project Guide</b> — is designed to be self-contained: Build real MySQL projects — analytics dashboards, reporting layers, and OLTP schemas.</p>
