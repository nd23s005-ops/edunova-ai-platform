...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-real-world-case-study",
  title: "Ethical Hacking — Real-world Case Study",
  category: "Security",
  ...
  heroSubtitle: "A real-world enterprise defensive case study — how coordinated security testing reduced risk, improved compliance, and hardened operations.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A real-world enterprise defensive case study — how coordinated security testing reduced risk, improved compliance, and hardened operations. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
