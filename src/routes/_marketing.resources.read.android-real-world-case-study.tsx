...
const RESOURCE: ReaderResource = {
  id: "android-real-world-case-study",
  title: "Android Development — Real-world Case Study",
  category: "Mobile",
  ...
  heroSubtitle: 'How teams run Android in production — architecture, telemetry, crash reporting, and A/B testing.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Real-world Case Study</b> — is self-contained: How teams run Android in production — architecture, telemetry, crash reporting, and A/B testing.</p>
