...
const RESOURCE: ReaderResource = {
  id: "ux-design-answer-key",
  title: "UX Design — Answer Key",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "27 min",
  pages: 38,
  ...
  heroSubtitle: "Complete Answer Key for UX Design practice questions with detailed explanations, recommended workflows, research analysis, usability improvements, accessibility recommendations, and evaluation rubrics.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Answer Key.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete Answer Key for UX Design practice questions with detailed explanations, recommended workflows, research analysis, usability improvements, accessibility recommendations, and evaluation rubrics.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Answer Key</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
