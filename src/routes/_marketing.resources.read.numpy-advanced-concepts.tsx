...
const RESOURCE: ReaderResource = {
  id: "numpy-advanced-concepts",
  title: "NumPy — Advanced Concepts",
  ...
  heroSubtitle: "Advanced NumPy \u2014 strides, memory layout, ufuncs, vectorization, and performance engineering.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Advanced Concepts</b> — is self-contained: Advanced NumPy — strides, memory layout, ufuncs, vectorization, and performance engineering.</p>
