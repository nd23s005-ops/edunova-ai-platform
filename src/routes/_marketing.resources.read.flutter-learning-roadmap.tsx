...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A month-by-month Flutter roadmap from Dart basics to senior mobile engineer.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — modern, production-ready Flutter development.</li>
