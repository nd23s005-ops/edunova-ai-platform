...
const RESOURCE: ReaderResource = {
  id: "azure-frequently-asked-questions",
  title: "Microsoft Azure — Frequently Asked Questions",
  ...
  heroSubtitle: "Frequently asked questions about Microsoft Azure services, certifications, and careers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Frequently asked questions about Microsoft Azure services, certifications, and careers. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
