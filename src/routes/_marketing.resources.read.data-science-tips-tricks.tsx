...
const RESOURCE: ReaderResource = {
  id: "data-science-tips-tricks",
  title: "Data Science — Tips & Tricks",
  ...
  heroSubtitle: 'Practical Data Science tips that speed up EDA, modeling, and iteration.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-science-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-science-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Tips & Tricks</b> — practical, production-ready Data Science.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Data Science combines <b>statistics</b>, <b>programming</b>, and <b>domain knowledge</b> to turn raw data into decisions and products. From dashboards and forecasts to recommender systems and LLM agents, it's the discipline behind most modern data-driven features. This resource — <b>Data Science — Tips & Tricks</b> — is self-contained: Practical Data Science tips that speed up EDA, modeling, and iteration.</p>
