...
const RESOURCE: ReaderResource = {
  id: "postgresql-quick-revision-notes",
  title: "PostgreSQL — Quick Revision Notes",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 7,
  ...
  heroSubtitle: "Fast recap of PostgreSQL syntax, joins, JSONB, and tuning for interview day.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Quick Revision Notes</b> — is designed to be self-contained: Fast recap of PostgreSQL syntax, joins, JSONB, and tuning for interview day.</p>
