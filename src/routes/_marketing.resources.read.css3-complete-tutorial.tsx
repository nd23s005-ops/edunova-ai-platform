...
const RESOURCE: ReaderResource = {
  id: "css3-complete-tutorial",
  title: "CSS3 — Complete Tutorial",
  ...
  heroSubtitle: 'End-to-end CSS3 tutorial from selectors and layout to Flexbox, Grid, animations, and production styling.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Complete Tutorial</b> — is self-contained: End-to-end CSS3 tutorial from selectors and layout to Flexbox, Grid, animations, and production styling.</p>
