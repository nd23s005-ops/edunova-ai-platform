...
const RESOURCE: ReaderResource = {
  id: "cyber-security-answer-key",
  title: "Cyber Security — Answer Key",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "27 min",
  pages: 41,
  ...
  heroSubtitle: "Detailed answer key with explanations, defensive rationale, evaluation rubrics, and references.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Detailed answer key with explanations, defensive rationale, evaluation rubrics, and references. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
