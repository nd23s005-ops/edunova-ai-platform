...
const RESOURCE: ReaderResource = {
  id: "figma-interview-questions",
  title: "Figma — Interview Questions",
  category: "Design",
  ...
  heroSubtitle: "350+ Figma interview questions across beginner, intermediate, and advanced levels \u2014 Auto Layout, components, variants, design systems, responsive design, prototyping, Dev Mode, accessibility, case studies, portfolios, HR, and mock rounds.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Interview Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>350+ Figma interview questions across beginner, intermediate, and advanced levels — Auto Layout, components, variants, design systems, responsive design, prototyping, Dev Mode, accessibility, case studies, portfolios, HR, and mock rounds.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Interview Questions</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
