...
const RESOURCE: ReaderResource = {
  id: "nextjs-real-world-case-study",
  title: "Next.js — Real-world Case Study",
  ...
  heroSubtitle: 'How real teams adopt Next.js at scale — App Router migration, caching, and performance wins.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Real-world Case Study</b> — is self-contained: How real teams adopt Next.js at scale — App Router migration, caching, and performance wins.</p>
