...
const RESOURCE: ReaderResource = {
  id: "css3-practice-questions",
  title: "CSS3 — Practice Questions",
  ...
  heroSubtitle: 'Hands-on CSS3 practice questions covering selectors, Flexbox, Grid, and real UI scenarios.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Practice Questions</b> — is self-contained: Hands-on CSS3 practice questions covering selectors, Flexbox, Grid, and real UI scenarios.</p>
