...
const RESOURCE: ReaderResource = {
  id: "tableau-reference-guide",
  title: "Tableau — Reference Guide",
  ...
  heroSubtitle: "A complete Tableau reference guide — every function, chart type, action, and platform feature documented for day-to-day use.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete Tableau reference guide — every function, chart type, action, and platform feature documented for day-to-day use.</p>
