...
const RESOURCE: ReaderResource = {
  id: "python-common-mistakes",
  title: "Python — Common Mistakes",
  ...
  heroSubtitle: "Mutable defaults, late binding, GIL myths, and other classic Python pitfalls — with fixes.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Common Mistakes</b> — is designed to be self-contained: Mutable defaults, late binding, GIL myths, and other classic Python pitfalls — with fixes.</p>
