...
const RESOURCE: ReaderResource = {
  id: "ai-agents-real-world-case-study",
  title: "AI Agents — Real-world Case Study",
  category: "AI & Data",
  ...
  heroSubtitle: "Real-world enterprise agentic architecture — evaluation, safety, and cost.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This real-world case study focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
