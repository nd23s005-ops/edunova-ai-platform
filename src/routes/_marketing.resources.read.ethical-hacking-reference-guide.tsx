...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-reference-guide",
  title: "Ethical Hacking — Reference Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "32 min",
  pages: 45,
  ...
  heroSubtitle: "A reference handbook: PTES, OWASP Top 10 / ASVS / WSTG, MITRE ATT&CK, CVSS, CIS Controls, and NIST framework mappings.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A reference handbook: PTES, OWASP Top 10 / ASVS / WSTG, MITRE ATT&CK, CVSS, CIS Controls, and NIST framework mappings. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
