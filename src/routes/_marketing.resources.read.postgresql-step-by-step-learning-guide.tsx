...
const RESOURCE: ReaderResource = {
  id: "postgresql-step-by-step-learning-guide",
  title: "PostgreSQL — Step-by-Step Learning Guide",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "27 min",
  pages: 27,
  ...
  heroSubtitle: "A structured, incremental path from zero to confident PostgreSQL developer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Step-by-Step Learning Guide</b> — is designed to be self-contained: A structured, incremental path from zero to confident PostgreSQL developer.</p>
