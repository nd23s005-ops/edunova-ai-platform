...
const RESOURCE: ReaderResource = {
  id: "cyber-security-quick-revision-notes",
  title: "Cyber Security — Quick Revision Notes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "6 min",
  pages: 6,
  ...
  heroSubtitle: "Concise revision notes summarizing cybersecurity concepts, frameworks, controls, and defensive workflows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Concise revision notes summarizing cybersecurity concepts, frameworks, controls, and defensive workflows. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
