...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Practical Kubernetes tips and tricks — kubectl shortcuts, debugging, and productivity wins.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-tips-tricks" }],
  }),
  component: Page,
});
