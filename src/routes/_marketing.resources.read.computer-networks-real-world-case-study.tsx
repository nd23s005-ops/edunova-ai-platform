...
const RESOURCE: ReaderResource = {
  id: "computer-networks-real-world-case-study",
  title: "Computer Networks — Real-world Case Study",
  category: "CS Core",
  ...
  heroSubtitle: "Real-world enterprise networking case study: business requirements, architecture, routing, switching, redundancy, VLANs, VPNs, firewalls, monitoring, troubleshooting, outcomes.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "bg", label: "Business Context" },
  { id: "req", label: "Requirements" },
  { id: "arch", label: "Network Architecture" },
  { id: "route", label: "Routing" },
  { id: "switch", label: "Switching" },
  { id: "redundancy", label: "Redundancy" },
  { id: "vpn", label: "VPNs & Remote Access" },
  { id: "fw", label: "Firewalls" },
  { id: "mon", label: "Monitoring" },
  { id: "trouble", label: "Troubleshooting Playbook" },
...
export const Route = createFileRoute("/_marketing/resources/read/computer-networks-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/computer-networks-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Real-world enterprise networking case study: business requirements, architecture, routing, switching, redundancy, VLANs, VPNs, firewalls, monitoring, troubleshooting, outcomes.</p>
        <Figure src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=1400&q=80" caption="Figure 1 — Overview illustration for Computer Networks — Real-world Case Study." />
      </Section>

      <Section id="bg" title="Business Context">
        <p>Global retailer, 400 stores, 15 DCs, 30K endpoints.</p>
      </Section>

      <Section id="req" title="Requirements">
        <p>Sub-100ms POS transactions. 99.95% store connectivity.</p>
      ...
      <Section id="arch" title="Network Architecture">
        <p>SD-WAN edge. Regional hubs. Core MPLS backbone.</p>
      </Section>

      <Section id="route" title="Routing">
        <p>OSPF regional. BGP inter-region. Path preference by cost.</p>
      </Section>

      <Section id="switch" title="Switching">
        <p>Store L2 with L3 uplinks. VLANs by function (POS, CCTV, guest).</p>
      </Section>

      <Section id="redundancy" title="Redundancy">
        <p>Dual uplinks, dual power, HSRP for gateways.</p>
      </Section>

      <Section id="vpn" title="VPNs & Remote Access">
        <p>Site-to-site IPsec + SSL VPN for staff.</p>
      </Section>

      <Section id="fw" title="Firewalls">
        <p>Zone-based NGFW at edges. Micro-segmentation in DCs.</p>
      </Section>

      <Section id="mon" title="Monitoring">
        <p>ThousandEyes for user experience. Splunk for logs.</p>
      </Section>

      <Section id="trouble" title="Troubleshooting Playbook">
        <p>Standardized runbooks reduced MTTR by 62%.</p>
      </Section>

      <Section id="outcomes" title="Outcomes">
        <p>Store uptime 99.97%. Transaction latency −38%. WAN cost −22%.</p>
      </Section>
