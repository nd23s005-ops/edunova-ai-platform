...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Curated Vue.js interview questions on reactivity, Composition API, Pinia, SSR, and performance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — practical, production-ready Vue.js.</li>
