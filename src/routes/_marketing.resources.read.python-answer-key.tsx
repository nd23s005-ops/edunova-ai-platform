...
const RESOURCE: ReaderResource = {
  id: "python-answer-key",
  title: "Python — Answer Key",
  ...
  heroSubtitle: "Fully explained answers to the Python practice set with step-by-step reasoning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Answer Key</b> — is designed to be self-contained: Fully explained answers to the Python practice set with step-by-step reasoning.</p>
