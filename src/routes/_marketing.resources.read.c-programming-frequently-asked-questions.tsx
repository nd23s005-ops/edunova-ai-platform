...
const RESOURCE: ReaderResource = {
  id: "c-programming-frequently-asked-questions",
  title: "C Programming — Frequently Asked Questions",
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-frequently-asked-questions" }],
  }),
  component: Page,
});
