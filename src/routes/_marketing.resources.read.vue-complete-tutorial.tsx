...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'End-to-end Vue.js tutorial — components, reactivity, routing, Pinia, HTTP, testing, and deployment.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, production-ready Vue.js.</li>
