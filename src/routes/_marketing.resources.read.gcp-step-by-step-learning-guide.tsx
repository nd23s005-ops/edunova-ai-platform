...
const RESOURCE: ReaderResource = {
  id: "gcp-step-by-step-learning-guide",
  title: "Google Cloud Platform — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A structured, step-by-step path to become productive with Google Cloud Platform.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-step-by-step-learning-guide" }],
  }),
  component: Page,
});
