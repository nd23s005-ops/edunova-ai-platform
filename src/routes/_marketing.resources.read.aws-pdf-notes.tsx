...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Comprehensive AWS study notes spanning IAM, EC2, VPC, S3, RDS, Lambda, EKS, observability, and the Well-Architected Framework.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This pdf notes focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
