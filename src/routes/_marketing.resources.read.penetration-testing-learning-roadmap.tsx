...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-learning-roadmap",
  title: "Penetration Testing — Learning Roadmap",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 6,
  ...
  heroSubtitle: "A structured learning roadmap covering networking, Linux, cybersecurity fundamentals, web/cloud security, pentest methodology, OWASP, reporting, certifications, portfolio projects, interview preparation, and career progression.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured learning roadmap covering networking, Linux, cybersecurity fundamentals, web/cloud security, pentest methodology, OWASP, reporting, certifications, portfolio projects, interview preparation, and career progression. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
