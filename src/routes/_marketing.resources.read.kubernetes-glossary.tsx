...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Every Kubernetes term you'll meet — from Pod to CRD, explained in plain language.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-glossary" }],
  }),
  component: Page,
});
