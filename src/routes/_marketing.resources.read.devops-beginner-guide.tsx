...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Gentle, defense-first introduction to DevOps — culture, CI/CD, IaC, containers, and observability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Gentle, defense-first introduction to DevOps — culture, CI/CD, IaC, containers, and observability. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
