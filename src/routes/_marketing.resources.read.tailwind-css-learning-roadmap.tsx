...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-learning-roadmap",
  title: "Tailwind CSS — Learning Roadmap",
  ...
  heroSubtitle: 'A staged roadmap for learning Tailwind CSS — from utilities to enterprise-grade design systems.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready Tailwind CSS.</li>
