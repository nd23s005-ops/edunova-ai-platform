...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "AWS interview questions across IAM, VPC, EC2, S3, RDS, Lambda, EKS, and Well-Architected design.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This interview questions focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
