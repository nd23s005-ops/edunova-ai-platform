...
const RESOURCE: ReaderResource = {
  id: "power-bi-glossary",
  title: "Power BI — Glossary",
  ...
  heroSubtitle: "A comprehensive Power BI glossary — every term, feature, and concept explained in plain English with examples.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive Power BI glossary — every term, feature, and concept explained in plain English with examples.</p>
