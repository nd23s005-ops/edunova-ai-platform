...
const RESOURCE: ReaderResource = {
  id: "typescript-learning-roadmap",
  ...
  heroSubtitle: 'A staged roadmap for learning TypeScript — from basics to enterprise-grade patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Learning Roadmap</b> — is self-contained: A staged roadmap for learning TypeScript — from basics to enterprise-grade patterns.</p>
