...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-advanced-concepts",
  title: "Ethical Hacking — Advanced Concepts",
  category: "Security",
  difficulty: "Advanced",
  readingTime: "33 min",
  pages: 49,
  ...
  heroSubtitle: "Advanced authorized-testing concepts — purple teaming, adversary emulation, cloud/K8s security assessment, DevSecOps, and AI in security.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced authorized-testing concepts — purple teaming, adversary emulation, cloud/K8s security assessment, DevSecOps, and AI in security. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
