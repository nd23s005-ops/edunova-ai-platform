...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-step-by-step-learning-guide",
  title: "Ethical Hacking — Step-by-Step Learning Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "26 min",
  pages: 25,
  ...
  heroSubtitle: "A structured, week-by-week ethical hacking learning path — networking, Linux, OWASP, defensive labs, certifications, and portfolio development.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured, week-by-week ethical hacking learning path — networking, Linux, OWASP, defensive labs, certifications, and portfolio development. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
