...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Productivity tips \u2014 debugging workflows, VS Code shortcuts, ES2020+, async patterns, performance wins.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. VS Code" },
  { id: "s2", label: "2. Debugging" },
  { id: "s3", label: "3. Modern Syntax" },
  { id: "s4", label: "4. Async" },
  { id: "s5", label: "5. Performance" },
  { id: "s6", label: "6. Career" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-tips-and-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-tips-and-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Tips & Tricks.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Small habits that compound into massive productivity gains.</p>
      ...
      <Section id="s1" title="1. VS Code">
        <p>Multi-cursor, snippets, breakpoints.</p>
        <Code lang="js">{`// VS Code — illustrative snippet
const example = () => {
  ...
  return "hello from vs code";
      ...
      <Section id="s2" title="2. Debugging">
        <p>console.table, .trace, conditional breakpoints.</p>
...
const example = () => {
  ...
  return "hello from debugging";
      ...
      <Section id="s3" title="3. Modern Syntax">
        <p>Optional chaining, nullish coalescing.</p>
        <Code lang="js">{`// Modern Syntax — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from modern syntax";
};`}</Code>
      </Section>

      <Section id="s4" title="4. Async">
        <p>Promise.allSettled, AbortController.</p>
...
const example = () => {
  ...
  return "hello from async";
      ...
      <Section id="s5" title="5. Performance">
        <p>structuredClone, requestIdleCallback.</p>
...
const example = () => {
  ...
  return "hello from performance";
      ...
      <Section id="s6" title="6. Career">
        <p>Read source code, ship weekly.</p>
        <Code lang="js">{`// Career — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from career";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Tips & Tricks equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
