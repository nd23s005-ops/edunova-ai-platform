...
const RESOURCE: ReaderResource = {
  id: "tableau-real-world-case-study",
  title: "Tableau — Real-world Case Study",
  ...
  heroSubtitle: "Real-world case studies of enterprises using Tableau for sales analytics, executive reporting, marketing dashboards, and operational KPIs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Real-world case studies of enterprises using Tableau for sales analytics, executive reporting, marketing dashboards, and operational KPIs.</p>
