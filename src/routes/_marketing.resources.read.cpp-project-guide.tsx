...
const RESOURCE: ReaderResource = {
  id: "cpp-project-guide",
  title: "C++ — Project Guide",
  ...
  heroSubtitle: "Build real C++ projects — CLI tools, small engines, and multi-threaded programs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Project Guide</b> — practical, modern-C++ coverage.</li>
