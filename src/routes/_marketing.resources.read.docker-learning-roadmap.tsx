...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A structured learning roadmap from Docker novice to a container-fluent DevOps engineer shipping to production.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured learning roadmap from Docker novice to a container-fluent DevOps engineer shipping to production.</p>
