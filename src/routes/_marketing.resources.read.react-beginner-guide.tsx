...
function Counter() {
  ...
  return <button onClick={() => setN(n + 1)}>Clicked {n}</button>;
        ...
        <Callout tone="warning" title="Never mutate state">Always create new objects/arrays — use the spread operator to copy then override, not direct assignment like <code>user.age = 30</code>.</Callout>
      </Section>
