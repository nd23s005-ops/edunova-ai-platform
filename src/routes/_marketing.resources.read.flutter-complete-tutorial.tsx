...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'An end-to-end Flutter walkthrough — Dart, widgets, state, Firebase, Riverpod, and deploying to Play + App Store.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — modern, production-ready Flutter development.</li>
