...
const RESOURCE: ReaderResource = {
  id: "postgresql-complete-tutorial",
  ...
  heroSubtitle: "End-to-end PostgreSQL tutorial from SELECT to CTEs, JSONB, indexes, and tuning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Complete Tutorial</b> — is designed to be self-contained: End-to-end PostgreSQL tutorial from SELECT to CTEs, JSONB, indexes, and tuning.</p>
