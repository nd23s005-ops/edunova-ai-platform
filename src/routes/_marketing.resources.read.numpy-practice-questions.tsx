...
const RESOURCE: ReaderResource = {
  id: "numpy-practice-questions",
  title: "NumPy — Practice Questions",
  ...
  heroSubtitle: "A themed NumPy practice set with progressive difficulty and worked solutions.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Practice Questions</b> — is self-contained: A themed NumPy practice set with progressive difficulty and worked solutions.</p>
