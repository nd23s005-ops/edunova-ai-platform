...
const RESOURCE: ReaderResource = {
  id: "devops-step-by-step-learning-guide",
  title: "DevOps — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A staged learning path — from Git and Linux to CI/CD, Kubernetes, IaC, and SRE.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A staged learning path — from Git and Linux to CI/CD, Kubernetes, IaC, and SRE. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
