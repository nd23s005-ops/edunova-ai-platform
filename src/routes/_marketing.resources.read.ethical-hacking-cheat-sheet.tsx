...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-cheat-sheet",
  title: "Ethical Hacking — Cheat Sheet",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "4 min",
  pages: 4,
  ...
  heroSubtitle: "A printable cheat sheet: authorization, PTES lifecycle, OWASP categories, CVSS ranges, MITRE tactics, and reporting essentials.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A printable cheat sheet: authorization, PTES lifecycle, OWASP categories, CVSS ranges, MITRE tactics, and reporting essentials. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
