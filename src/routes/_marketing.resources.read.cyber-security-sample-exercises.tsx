...
const RESOURCE: ReaderResource = {
  id: "cyber-security-sample-exercises",
  title: "Cyber Security — Sample Exercises",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "17 min",
  pages: 18,
  ...
  heroSubtitle: "300+ authorized defensive exercises — threat modeling, control mapping, IR tabletops, and secure-design reviews.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>300+ authorized defensive exercises — threat modeling, control mapping, IR tabletops, and secure-design reviews. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
