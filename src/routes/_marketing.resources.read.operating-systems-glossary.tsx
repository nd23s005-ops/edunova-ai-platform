...
const RESOURCE: ReaderResource = {
  id: "operating-systems-glossary",
  title: "Operating Systems — Glossary",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 20,
  ...
  heroSubtitle: "Alphabetical Operating Systems glossary: terminology across process management, memory management, scheduling, synchronization, Linux, virtualization, storage systems, security, and kernel concepts.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Glossary.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Alphabetical Operating Systems glossary: terminology across process management, memory management, scheduling, synchronization, Linux, virtualization, storage systems, security, and kernel concepts.</p>
