...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Deep Python — descriptors, metaclasses, asyncio internals, typing generics, and CPython.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Advanced Concepts</b> — is designed to be self-contained: Deep Python — descriptors, metaclasses, asyncio internals, typing generics, and CPython.</p>
