...
const RESOURCE: ReaderResource = {
  id: "c-programming-step-by-step-learning-guide",
  title: "C Programming — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A structured, incremental path from zero to confident C developer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-step-by-step-learning-guide" }],
  }),
  component: Page,
});
