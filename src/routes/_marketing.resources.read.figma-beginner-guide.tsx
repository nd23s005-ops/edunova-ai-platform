...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Beginner-friendly Figma guide covering the interface, frames, pages, layers, constraints, Auto Layout, components, variants, typography, color styles, grids, responsive layouts, collaboration, and Dev Mode.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Beginner Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Beginner-friendly Figma guide covering the interface, frames, pages, layers, constraints, Auto Layout, components, variants, typography, color styles, grids, responsive layouts, collaboration, and Dev Mode.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Beginner Guide</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
