...
const RESOURCE: ReaderResource = {
  id: "operating-systems-answer-key",
  title: "Operating Systems — Answer Key",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "24 min",
  pages: 29,
  ...
  heroSubtitle: "Complete answer key for the OS practice workbook: detailed solutions, multiple approaches, scheduling calculations, synchronization walkthroughs, optimization techniques, Linux command explanations, and evaluation rubrics.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Answer Key.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete answer key for the OS practice workbook: detailed solutions, multiple approaches, scheduling calculations, synchronization walkthroughs, optimization techniques, Linux command explanations, and evaluation rubrics.</p>
