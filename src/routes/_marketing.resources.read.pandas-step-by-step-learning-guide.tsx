...
const RESOURCE: ReaderResource = {
  id: "pandas-step-by-step-learning-guide",
  title: "Pandas — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive path through Pandas — one concept at a time with runnable DataFrame examples.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready Pandas.</li>
