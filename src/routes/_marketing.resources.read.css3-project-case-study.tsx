...
const RESOURCE: ReaderResource = {
  id: "css3-project-case-study",
  title: "CSS3 — Project Case Study",
  ...
  heroSubtitle: 'Deep-dive case study of a production CSS3 project — architecture, tokens, and trade-offs.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Project Case Study</b> — is self-contained: Deep-dive case study of a production CSS3 project — architecture, tokens, and trade-offs.</p>
