...
const RESOURCE: ReaderResource = {
  id: "power-bi-quick-revision-notes",
  title: "Power BI — Quick Revision Notes",
  ...
  heroSubtitle: "Quick revision notes to refresh Power BI essentials before an exam, PL-300 certification, or interview — every core concept in a single scannable pass.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Quick revision notes to refresh Power BI essentials before an exam, PL-300 certification, or interview — every core concept in a single scannable pass.</p>
