...
const RESOURCE: ReaderResource = {
  id: "nodejs-frequently-asked-questions",
  title: "Node.js — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most-asked Node.js questions — versions, modules, deployment, and more.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready Node.js.</li>
