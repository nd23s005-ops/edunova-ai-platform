...
const RESOURCE: ReaderResource = {
  id: "tableau-learning-roadmap",
  title: "Tableau — Learning Roadmap",
  ...
  heroSubtitle: "A structured learning roadmap that takes you from Tableau novice to a certified, dashboard-shipping analytics engineer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured learning roadmap that takes you from Tableau novice to a certified, dashboard-shipping analytics engineer.</p>
