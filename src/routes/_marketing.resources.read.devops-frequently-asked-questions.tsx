...
const RESOURCE: ReaderResource = {
  id: "devops-frequently-asked-questions",
  ...
  heroSubtitle: "Frequently asked questions about DevOps roles, tools, culture, and career growth.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Frequently asked questions about DevOps roles, tools, culture, and career growth. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
