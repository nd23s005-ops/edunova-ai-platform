...
const RESOURCE: ReaderResource = {
  id: "pandas-advanced-concepts",
  title: "Pandas — Advanced Concepts",
  ...
  heroSubtitle: 'MultiIndex, extension arrays, categoricals, PyArrow backends, and advanced Pandas performance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready Pandas.</li>
