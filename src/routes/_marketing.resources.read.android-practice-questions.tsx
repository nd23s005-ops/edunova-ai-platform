...
const RESOURCE: ReaderResource = {
  id: "android-practice-questions",
  title: "Android Development — Practice Questions",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "22 min",
  pages: 40,
  ...
  heroSubtitle: 'Hands-on Android practice — Compose UI, coroutines, Room, Retrofit, and navigation.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Practice Questions</b> — is self-contained: Hands-on Android practice — Compose UI, coroutines, Room, Retrofit, and navigation.</p>
