...
const RESOURCE: ReaderResource = {
  id: "mern-stack-common-mistakes",
  title: "MERN Stack — Common Mistakes",
  ...
  heroSubtitle: 'The MERN pitfalls that bite in production — state bugs, async errors, and security holes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready MERN full-stack development.</li>
