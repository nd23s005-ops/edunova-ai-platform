...
const RESOURCE: ReaderResource = {
  id: "data-analytics-beginner-guide",
  title: "Data Analytics — Beginner Guide",
  ...
  heroSubtitle: 'A friendly first tour of Data Analytics — types of analytics, tools, and your first insights.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, business-ready Data Analytics.</li>
