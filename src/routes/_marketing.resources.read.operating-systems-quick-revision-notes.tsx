...
const RESOURCE: ReaderResource = {
  id: "operating-systems-quick-revision-notes",
  title: "Operating Systems — Quick Revision Notes",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "6 min",
  pages: 10,
  ...
  heroSubtitle: "Concise Operating Systems revision notes for exams and interviews: scheduling summaries, memory shortcuts, process lifecycle diagrams, filesystem comparisons, Linux command references, and quick lookup tables.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Quick Revision Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Concise Operating Systems revision notes for exams and interviews: scheduling summaries, memory shortcuts, process lifecycle diagrams, filesystem comparisons, Linux command references, and quick lookup tables.</p>
