...
const RESOURCE: ReaderResource = {
  id: "ai-agents-project-case-study",
  title: "AI Agents — Project Case Study",
  category: "AI & Data",
  ...
  heroSubtitle: "A worked agent project case study — architecture, trade-offs, and lessons learned.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This project case study focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
