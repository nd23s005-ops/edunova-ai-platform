...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page Next.js cheat sheet — App Router files, rendering modes, and caching at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Cheat Sheet</b> — is self-contained: One-page Next.js cheat sheet — App Router files, rendering modes, and caching at a glance.</p>
