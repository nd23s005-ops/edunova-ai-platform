...
const RESOURCE: ReaderResource = {
  id: "azure-step-by-step-learning-guide",
  title: "Microsoft Azure — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "Staged Azure learning path from Portal basics to VMs, App Service, AKS, and governance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Staged Azure learning path from Portal basics to VMs, App Service, AKS, and governance. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
