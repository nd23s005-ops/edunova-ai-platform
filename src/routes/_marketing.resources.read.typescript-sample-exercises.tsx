...
const RESOURCE: ReaderResource = {
  id: "typescript-sample-exercises",
  title: "TypeScript — Sample Exercises",
  ...
  heroSubtitle: 'Short, focused TypeScript exercises for types, generics, unions, and utility types.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Sample Exercises</b> — is self-contained: Short, focused TypeScript exercises for types, generics, unions, and utility types.</p>
