...
const RESOURCE: ReaderResource = {
  id: "mongodb-common-mistakes",
  title: "MongoDB — Common Mistakes",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "15 min",
  pages: 14,
  ...
  heroSubtitle: 'The MongoDB pitfalls that bite in production — huge docs, missing indexes, and N+1 queries.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready MongoDB.</li>
