...
const RESOURCE: ReaderResource = {
  id: "css3-advanced-concepts",
  title: "CSS3 — Advanced Concepts",
  ...
  heroSubtitle: 'Container queries, subgrid, cascade layers, scroll-driven animations — advanced CSS3.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Advanced Concepts</b> — is self-contained: Container queries, subgrid, cascade layers, scroll-driven animations — advanced CSS3.</p>
