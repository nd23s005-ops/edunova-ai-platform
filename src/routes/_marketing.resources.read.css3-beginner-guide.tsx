...
const RESOURCE: ReaderResource = {
  id: "css3-beginner-guide",
  title: "CSS3 — Beginner Guide",
  ...
  heroSubtitle: 'A friendly first tour of CSS3 — selectors, the box model, and shipping your first styled page.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Beginner Guide</b> — is self-contained: A friendly first tour of CSS3 — selectors, the box model, and shipping your first styled page.</p>
