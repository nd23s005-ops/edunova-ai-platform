...
const RESOURCE: ReaderResource = {
  id: "typescript-frequently-asked-questions",
  title: "TypeScript — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most frequently asked TypeScript questions — from setup to advanced types.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Frequently Asked Questions</b> — is self-contained: Answers to the most frequently asked TypeScript questions — from setup to advanced types.</p>
