...
const RESOURCE: ReaderResource = {
  id: "power-bi-reference-guide",
  title: "Power BI — Reference Guide",
  ...
  heroSubtitle: "A complete Power BI reference — every DAX function category, Power Query connector, visual, and platform feature documented for daily use.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete Power BI reference — every DAX function category, Power Query connector, visual, and platform feature documented for daily use.</p>
