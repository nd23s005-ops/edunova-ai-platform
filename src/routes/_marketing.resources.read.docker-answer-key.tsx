...
const RESOURCE: ReaderResource = {
  id: "docker-answer-key",
  title: "Docker — Answer Key",
  ...
  heroSubtitle: "Detailed answer key explaining the reasoning and commands behind every Docker practice question.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Detailed answer key explaining the reasoning and commands behind every Docker practice question.</p>
