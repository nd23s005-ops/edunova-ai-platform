...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-step-by-step-learning-guide",
  title: "Tailwind CSS — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive path through Tailwind CSS — one utility group at a time, with live component examples.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready Tailwind CSS.</li>
