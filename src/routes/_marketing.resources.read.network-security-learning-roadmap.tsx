...
const RESOURCE: ReaderResource = {
  id: "network-security-learning-roadmap",
  title: "Network Security — Learning Roadmap",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "6 min",
  pages: 6,
  ...
  heroSubtitle: "A structured Network Security roadmap covering networking fundamentals, Linux, routing and switching, security concepts, cloud networking, monitoring, incident response, certifications, and career progression.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured Network Security roadmap covering networking fundamentals, Linux, routing and switching, security concepts, cloud networking, monitoring, incident response, certifications, and career progression. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
