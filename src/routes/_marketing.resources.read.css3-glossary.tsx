...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A concise glossary of CSS3 terms — from cascade and specificity to Flexbox and Grid.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Glossary</b> — is self-contained: A concise glossary of CSS3 terms — from cascade and specificity to Flexbox and Grid.</p>
