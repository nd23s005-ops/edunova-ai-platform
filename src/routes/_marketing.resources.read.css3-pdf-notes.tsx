...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Comprehensive CSS3 notes covering the entire language, layout systems, and ecosystem.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — PDF Notes</b> — is self-contained: Comprehensive CSS3 notes covering the entire language, layout systems, and ecosystem.</p>
