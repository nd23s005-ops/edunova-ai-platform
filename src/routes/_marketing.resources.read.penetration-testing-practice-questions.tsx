...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-practice-questions",
  title: "Penetration Testing — Practice Questions",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "28 min",
  pages: 27,
  ...
  heroSubtitle: "A structured educational workbook containing 350+ theory questions, MCQs, scenario analysis, methodology exercises, reporting practice, risk assessment activities, compliance exercises, and defensive security case studies.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured educational workbook containing 350+ theory questions, MCQs, scenario analysis, methodology exercises, reporting practice, risk assessment activities, compliance exercises, and defensive security case studies. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
