...
const RESOURCE: ReaderResource = {
  id: "cyber-security-project-guide",
  title: "Cyber Security — Project Guide",
  category: "Security",
  ...
  heroSubtitle: "A project guide for building a defensive cybersecurity portfolio through lab exercises and documentation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A project guide for building a defensive cybersecurity portfolio through lab exercises and documentation. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
