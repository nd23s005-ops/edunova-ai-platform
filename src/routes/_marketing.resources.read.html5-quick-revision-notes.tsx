...
const RESOURCE: ReaderResource = {
  id: "html5-quick-revision-notes",
  title: "HTML5 — Quick Revision Notes",
  ...
  heroSubtitle: "Concise HTML5 revision \u2014 semantic comparisons, ARIA reminders, syntax refs, memory tricks.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Semantic Cheatsheet" },
  { id: "s2", label: "2. Form Inputs" },
  { id: "s3", label: "3. Multimedia" },
  { id: "s4", label: "4. Accessibility" },
  { id: "s5", label: "5. SEO" },
  { id: "s6", label: "6. Responsive" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Quick Revision Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>One-page-per-topic revision material for exams and interviews.</p>
      ...
      <Section id="s1" title="1. Semantic Cheatsheet">
        <p>When to use each landmark.</p>
        <Code lang="html">{`<!-- Semantic Cheatsheet — illustrative snippet -->
<section aria-label="semantic cheatsheet">
  <h2>Semantic Cheatsheet</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s2" title="2. Form Inputs">
        <p>All input types at a glance.</p>
        <Code lang="html">{`<!-- Form Inputs — illustrative snippet -->
<section aria-label="form inputs">
  <h2>Form Inputs</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s3" title="3. Multimedia">
        <p>video/audio/picture attributes.</p>
...
<section aria-label="multimedia">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s4" title="4. Accessibility">
        <p>Top 10 ARIA tips.</p>
...
<section aria-label="seo">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s6" title="6. Responsive">
        <p>viewport, srcset patterns.</p>
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Quick Revision Notes equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
