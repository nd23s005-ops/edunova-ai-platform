...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Hands-on Node.js practice problems spanning async, streams, REST APIs, databases, and auth.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready Node.js.</li>
