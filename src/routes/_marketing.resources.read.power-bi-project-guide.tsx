...
const RESOURCE: ReaderResource = {
  id: "power-bi-project-guide",
  title: "Power BI — Project Guide",
  ...
  heroSubtitle: "This project guide walks you through building a full Power BI analytics project — from raw sources to a published, governed executive dashboard.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>This project guide walks you through building a full Power BI analytics project — from raw sources to a published, governed executive dashboard.</p>
