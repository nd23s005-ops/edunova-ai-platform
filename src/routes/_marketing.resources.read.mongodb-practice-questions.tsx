...
const RESOURCE: ReaderResource = {
  id: "mongodb-practice-questions",
  title: "MongoDB — Practice Questions",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "24 min",
  pages: 35,
  ...
  heroSubtitle: 'Hands-on MongoDB practice problems spanning CRUD, operators, aggregation, and schema design.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready MongoDB.</li>
