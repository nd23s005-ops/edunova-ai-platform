...
const RESOURCE: ReaderResource = {
  id: "tableau-common-mistakes",
  title: "Tableau — Common Mistakes",
  ...
  heroSubtitle: "The most common Tableau mistakes and how to avoid them — from overloaded dashboards and heavy calcs to bad joins and ungoverned publishing.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>The most common Tableau mistakes and how to avoid them — from overloaded dashboards and heavy calcs to bad joins and ungoverned publishing.</p>
