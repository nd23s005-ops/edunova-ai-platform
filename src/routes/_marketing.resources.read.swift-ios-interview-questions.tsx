...
const RESOURCE: ReaderResource = {
  id: "swift-ios-interview-questions",
  title: "Swift (iOS) — Interview Questions",
  category: "Mobile",
  ...
  heroSubtitle: "Curated iOS interview questions — Swift, SwiftUI, concurrency, memory, and architecture.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Interview Questions</b> — is designed to be self-contained: Curated iOS interview questions — Swift, SwiftUI, concurrency, memory, and architecture.</p>
