...
const RESOURCE: ReaderResource = {
  id: "swift-ios-glossary",
  title: "Swift (iOS) — Glossary",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 17,
  ...
  heroSubtitle: "A-to-Z glossary of Swift, SwiftUI, and iOS terminology used across this library.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Glossary</b> — is designed to be self-contained: A-to-Z glossary of Swift, SwiftUI, and iOS terminology used across this library.</p>
