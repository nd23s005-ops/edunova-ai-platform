...
const RESOURCE: ReaderResource = {
  id: "azure-pdf-notes",
  title: "Microsoft Azure — PDF Notes",
  ...
  heroSubtitle: "Comprehensive Azure notes — compute, storage, networking, identity, security, and enterprise architecture.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive Azure notes — compute, storage, networking, identity, security, and enterprise architecture. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
