...
const RESOURCE: ReaderResource = {
  id: "cyber-security-tips-tricks",
  title: "Cyber Security — Tips & Tricks",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 16,
  ...
  heroSubtitle: "Productivity tips for defenders — documentation, monitoring, IR readiness, control mapping, and communication.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Productivity tips for defenders — documentation, monitoring, IR readiness, control mapping, and communication. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
