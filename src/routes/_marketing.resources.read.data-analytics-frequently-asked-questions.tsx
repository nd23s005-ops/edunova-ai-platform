...
const RESOURCE: ReaderResource = {
  id: "data-analytics-frequently-asked-questions",
  title: "Data Analytics — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most-asked Data Analytics questions — tools, careers, SQL, and BI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, business-ready Data Analytics.</li>
