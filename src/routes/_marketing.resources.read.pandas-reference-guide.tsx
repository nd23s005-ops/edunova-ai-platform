...
const RESOURCE: ReaderResource = {
  id: "pandas-reference-guide",
  title: "Pandas — Reference Guide",
  ...
  heroSubtitle: 'A complete reference for Pandas — I/O, selection, groupby, merge, time series, and config.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Reference Guide</b> — practical, production-ready Pandas.</li>
