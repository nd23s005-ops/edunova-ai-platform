...
const RESOURCE: ReaderResource = {
  id: "dsa-reference-guide",
  title: "Data Structures & Algorithms — Reference Guide",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "31 min",
  pages: 65,
  ...
  heroSubtitle: "Comprehensive DSA reference: complexity tables, sorting/searching, graph algorithms, tree traversals, DP and recursion templates, common patterns, optimization strategies, and interview cheat sheets.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Reference Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive DSA reference: complexity tables, sorting/searching, graph algorithms, tree traversals, DP and recursion templates, common patterns, optimization strategies, and interview cheat sheets.</p>
