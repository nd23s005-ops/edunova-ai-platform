...
const RESOURCE: ReaderResource = {
  id: "swift-ios-cheat-sheet",
  title: "Swift (iOS) — Cheat Sheet",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "5 min",
  pages: 2,
  ...
  heroSubtitle: "One-page Swift + SwiftUI cheat sheet — syntax, modifiers, and one-liners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Cheat Sheet</b> — is designed to be self-contained: One-page Swift + SwiftUI cheat sheet — syntax, modifiers, and one-liners.</p>
