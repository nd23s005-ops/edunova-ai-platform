...
const RESOURCE: ReaderResource = {
  id: "expressjs-glossary",
  title: "Express.js — Glossary",
  ...
  heroSubtitle: "Every Express.js term you'll meet — middleware, router, CORS, JWT, RBAC, and more.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Glossary</b> — is self-contained: Every Express.js term you'll meet — middleware, router, CORS, JWT, RBAC, and more.</p>
