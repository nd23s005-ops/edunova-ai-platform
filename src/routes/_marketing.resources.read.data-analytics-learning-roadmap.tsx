...
const RESOURCE: ReaderResource = {
  id: "data-analytics-learning-roadmap",
  title: "Data Analytics — Learning Roadmap",
  ...
  heroSubtitle: 'A month-by-month Data Analytics roadmap from Excel + SQL basics to enterprise BI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, business-ready Data Analytics.</li>
