...
const RESOURCE: ReaderResource = {
  id: "dsa-real-world-case-study",
  title: "Data Structures & Algorithms — Real-world Case Study",
  category: "CS Core",
  ...
  heroSubtitle: "Enterprise DSA case study: recommendation systems, search engines, route optimization, fraud detection, caching, indexing, graph analytics, and performance optimization.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Real-world Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Enterprise DSA case study: recommendation systems, search engines, route optimization, fraud detection, caching, indexing, graph analytics, and performance optimization.</p>
