...
const RESOURCE: ReaderResource = {
  id: "swift-ios-beginner-guide",
  title: "Swift (iOS) — Beginner Guide",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "17 min",
  pages: 25,
  ...
  heroSubtitle: "A friendly first tour of Swift and iOS — Xcode, playgrounds, and your first SwiftUI app.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Beginner Guide</b> — is designed to be self-contained: A friendly first tour of Swift and iOS — Xcode, playgrounds, and your first SwiftUI app.</p>
