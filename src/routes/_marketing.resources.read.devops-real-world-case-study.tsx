...
const RESOURCE: ReaderResource = {
  id: "devops-real-world-case-study",
  title: "DevOps — Real-world Case Study",
  ...
  heroSubtitle: "Real-world DevOps case study — from monolith release pain to safe, frequent, automated deployments.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Real-world DevOps case study — from monolith release pain to safe, frequent, automated deployments. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
