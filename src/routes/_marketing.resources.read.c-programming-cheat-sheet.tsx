...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "One-page C cheat sheet — syntax, pointers, format specifiers, and stdlib one-liners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-cheat-sheet" }],
  }),
  component: Page,
});
