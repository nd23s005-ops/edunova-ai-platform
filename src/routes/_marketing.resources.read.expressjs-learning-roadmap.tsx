...
const RESOURCE: ReaderResource = {
  id: "expressjs-learning-roadmap",
  title: "Express.js — Learning Roadmap",
  ...
  heroSubtitle: 'A month-by-month Express.js roadmap from beginner backend to enterprise Node.js developer.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Learning Roadmap</b> — is self-contained: A month-by-month Express.js roadmap from beginner backend to enterprise Node.js developer.</p>
