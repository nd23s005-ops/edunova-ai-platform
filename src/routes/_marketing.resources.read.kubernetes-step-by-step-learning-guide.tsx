...
const RESOURCE: ReaderResource = {
  id: "kubernetes-step-by-step-learning-guide",
  title: "Kubernetes — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "Follow a structured path from your first pod to a production-ready cluster on any cloud.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-step-by-step-learning-guide" }],
  }),
  component: Page,
});
