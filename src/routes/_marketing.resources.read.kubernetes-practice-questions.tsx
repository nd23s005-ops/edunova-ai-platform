...
const RESOURCE: ReaderResource = {
  id: "kubernetes-practice-questions",
  ...
  heroSubtitle: "Practice questions to strengthen your Kubernetes fundamentals across every core concept.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-practice-questions" }],
  }),
  component: Page,
});
