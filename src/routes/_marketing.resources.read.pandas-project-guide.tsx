...
const RESOURCE: ReaderResource = {
  id: "pandas-project-guide",
  title: "Pandas — Project Guide",
  ...
  heroSubtitle: 'Build a production-ready Pandas project — ETL pipeline, analytics, and reproducible reports.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — practical, production-ready Pandas.</li>
