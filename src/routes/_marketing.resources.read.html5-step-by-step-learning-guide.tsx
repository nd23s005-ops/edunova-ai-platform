...
const RESOURCE: ReaderResource = {
  id: "html5-step-by-step-learning-guide",
  title: "HTML5 — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "Week-by-week HTML5 plan \u2014 lessons, milestones, exercises, mini projects, portfolio, accessibility, interview prep.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Week 1 — Elements" },
  { id: "s2", label: "2. Week 2 — Semantics" },
  { id: "s3", label: "3. Week 3 — Forms" },
  { id: "s4", label: "4. Week 4 — Media & Images" },
  { id: "s5", label: "5. Week 5 — Accessibility" },
  { id: "s6", label: "6. Week 6 — SEO & Metadata" },
  { id: "s7", label: "7. Week 7 — Mini Projects" },
  { id: "s8", label: "8. Week 8 — Portfolio & Interview" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Step-by-Step Learning Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured 8-week path from zero to portfolio-ready HTML5 developer.</p>
      ...
      <Section id="s1" title="1. Week 1 — Elements">
        <p>Doctype through basic text.</p>
        <Code lang="html">{`<!-- Week 1 — Elements — illustrative snippet -->
<section aria-label="week 1 — elements">
  <h2>Week 1 — Elements</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s2" title="2. Week 2 — Semantics">
        <p>Landmark elements & outline.</p>
        <Code lang="html">{`<!-- Week 2 — Semantics — illustrative snippet -->
<section aria-label="week 2 — semantics">
  <h2>Week 2 — Semantics</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s3" title="3. Week 3 — Forms">
        <p>Inputs, validation.</p>
        <Code lang="html">{`<!-- Week 3 — Forms — illustrative snippet -->
<section aria-label="week 3 — forms">
  <h2>Week 3 — Forms</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s4" title="4. Week 4 — Media & Images">
        <p>Responsive images.</p>
        <Code lang="html">{`<!-- Week 4 — Media & Images — illustrative snippet -->
<section aria-label="week 4 — media & images">
  <h2>Week 4 — Media & Images</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s5" title="5. Week 5 — Accessibility">
        <p>ARIA, screen readers.</p>
        <Code lang="html">{`<!-- Week 5 — Accessibility — illustrative snippet -->
<section aria-label="week 5 — accessibility">
  <h2>Week 5 — Accessibility</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s6" title="6. Week 6 — SEO & Metadata">
        <p>OG, JSON-LD.</p>
        <Code lang="html">{`<!-- Week 6 — SEO & Metadata — illustrative snippet -->
<section aria-label="week 6 — seo & metadata">
  <h2>Week 6 — SEO & Metadata</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s7" title="7. Week 7 — Mini Projects">
        <p>Landing page, blog, form.</p>
        <Code lang="html">{`<!-- Week 7 — Mini Projects — illustrative snippet -->
<section aria-label="week 7 — mini projects">
  <h2>Week 7 — Mini Projects</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s8" title="8. Week 8 — Portfolio & Interview">
        <p>Deploy & rehearse.</p>
        <Code lang="html">{`<!-- Week 8 — Portfolio & Interview — illustrative snippet -->
<section aria-label="week 8 — portfolio & interview">
  <h2>Week 8 — Portfolio & Interview</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Step-by-Step Learning Guide equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
