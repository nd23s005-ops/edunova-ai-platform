...
const RESOURCE: ReaderResource = {
  id: "kubernetes-frequently-asked-questions",
  ...
  heroSubtitle: "The Kubernetes questions learners and engineers ask most often, answered clearly.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-frequently-asked-questions" }],
  }),
  component: Page,
});
