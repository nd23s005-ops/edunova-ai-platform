...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-glossary",
  title: "Ethical Hacking — Glossary",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 17,
  ...
  heroSubtitle: "An alphabetical ethical hacking glossary — PTES, OWASP, MITRE, CVSS, CVE, CWE, PKI, SIEM, Zero Trust, and governance terms.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>An alphabetical ethical hacking glossary — PTES, OWASP, MITRE, CVSS, CVE, CWE, PKI, SIEM, Zero Trust, and governance terms. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
