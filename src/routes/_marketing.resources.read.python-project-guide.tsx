...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Build real Python projects — CLI tools, APIs, scrapers, and small automations.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Project Guide</b> — is designed to be self-contained: Build real Python projects — CLI tools, APIs, scrapers, and small automations.</p>
