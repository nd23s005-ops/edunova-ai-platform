...
const RESOURCE: ReaderResource = {
  id: "mern-stack-complete-tutorial",
  ...
  heroSubtitle: 'An end-to-end MERN walkthrough — set up Node + Express, connect MongoDB with Mongoose, build a React frontend, add auth, and deploy.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, production-ready MERN full-stack development.</li>
