...
const RESOURCE: ReaderResource = {
  id: "gcp-project-case-study",
  title: "Google Cloud Platform — Project Case Study",
  ...
  heroSubtitle: "Deep dive into a real cloud-native project on Google Cloud with architecture, code, and trade-offs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-project-case-study" }],
  }),
  component: Page,
});
