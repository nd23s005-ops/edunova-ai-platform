...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Battle-tested Express.js practices — folder structure, async handling, security, and maintainability.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Best Practices</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Best Practices</b> — is self-contained: Battle-tested Express.js practices — folder structure, async handling, security, and maintainability.</p>
