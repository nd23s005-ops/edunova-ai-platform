...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Practical C++ tips — auto, ranges, structured bindings, and shortcuts that save time.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Tips & Tricks</b> — practical, modern-C++ coverage.</li>
