...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "NullPointerExceptions, mutable state, checked exceptions, and other classic Java pitfalls.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Common Mistakes</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Common Mistakes</b> — is designed to be self-contained: NullPointerExceptions, mutable state, checked exceptions, and other classic Java pitfalls.</p>
