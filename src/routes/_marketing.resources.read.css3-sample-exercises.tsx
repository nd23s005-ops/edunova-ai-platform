...
const RESOURCE: ReaderResource = {
  id: "css3-sample-exercises",
  title: "CSS3 — Sample Exercises",
  ...
  heroSubtitle: 'Short, focused CSS3 exercises for selectors, Flexbox, Grid, and animations.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Sample Exercises</b> — is self-contained: Short, focused CSS3 exercises for selectors, Flexbox, Grid, and animations.</p>
