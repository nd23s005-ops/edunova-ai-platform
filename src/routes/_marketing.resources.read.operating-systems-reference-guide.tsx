...
const RESOURCE: ReaderResource = {
  id: "operating-systems-reference-guide",
  title: "Operating Systems — Reference Guide",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "58 min",
  pages: 86,
  ...
  heroSubtitle: "Comprehensive OS reference handbook: process lifecycle, CPU scheduling algorithms, synchronization primitives, deadlock handling, memory management, paging, segmentation, virtual memory, Linux commands, filesystem hierarchy, and kernel architecture.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Reference Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive OS reference handbook: process lifecycle, CPU scheduling algorithms, synchronization primitives, deadlock handling, memory management, paging, segmentation, virtual memory, Linux commands, filesystem hierarchy, and kernel architecture.</p>
