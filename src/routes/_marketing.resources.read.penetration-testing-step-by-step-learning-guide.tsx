...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-step-by-step-learning-guide",
  title: "Penetration Testing — Step-by-Step Learning Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "20 min",
  pages: 41,
  ...
  heroSubtitle: "A structured week-by-week roadmap covering cybersecurity foundations, networking, Linux, web security, pentest methodology, OWASP, vulnerability assessment, reporting, certifications, portfolio projects, and career development.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured week-by-week roadmap covering cybersecurity foundations, networking, Linux, web security, pentest methodology, OWASP, vulnerability assessment, reporting, certifications, portfolio projects, and career development. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
