...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A month-by-month Node.js roadmap from beginner JavaScript to enterprise backend engineer.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready Node.js.</li>
