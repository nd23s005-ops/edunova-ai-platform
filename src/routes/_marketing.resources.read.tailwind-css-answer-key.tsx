...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-answer-key",
  title: "Tailwind CSS — Answer Key",
  ...
  heroSubtitle: 'Complete worked solutions and explanations for the Tailwind CSS practice question set.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready Tailwind CSS.</li>
