...
const RESOURCE: ReaderResource = {
  id: "gcp-reference-guide",
  title: "Google Cloud Platform — Reference Guide",
  ...
  heroSubtitle: "A comprehensive Google Cloud reference for services, commands, and patterns.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-reference-guide" }],
  }),
  component: Page,
});
