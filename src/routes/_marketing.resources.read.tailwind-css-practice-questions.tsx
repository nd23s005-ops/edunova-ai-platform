...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-practice-questions",
  title: "Tailwind CSS — Practice Questions",
  ...
  heroSubtitle: 'Hands-on Tailwind CSS practice questions covering utilities, layout, and real UI scenarios.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready Tailwind CSS.</li>
