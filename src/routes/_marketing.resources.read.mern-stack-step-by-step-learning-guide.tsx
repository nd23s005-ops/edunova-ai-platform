...
const RESOURCE: ReaderResource = {
  id: "mern-stack-step-by-step-learning-guide",
  title: "MERN Stack — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive MERN path — from JavaScript foundations to a production full-stack app with auth, REST, and deployment.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready MERN full-stack development.</li>
