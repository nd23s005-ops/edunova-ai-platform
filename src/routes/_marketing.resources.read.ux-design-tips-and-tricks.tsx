...
const RESOURCE: ReaderResource = {
  id: "ux-design-tips-and-tricks",
  title: "UX Design — Tips & Tricks",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 11,
  ...
  heroSubtitle: "Practical UX Design productivity tips: research shortcuts, workshop facilitation, usability testing, accessibility reminders, wireframing workflows, prototyping strategies, and stakeholder communication.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-tips-and-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-tips-and-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Tips & Tricks.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Practical UX Design productivity tips: research shortcuts, workshop facilitation, usability testing, accessibility reminders, wireframing workflows, prototyping strategies, and stakeholder communication.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Tips & Tricks</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
