...
const RESOURCE: ReaderResource = {
  id: "data-science-practice-questions",
  title: "Data Science — Practice Questions",
  ...
  heroSubtitle: 'Hands-on Data Science practice problems spanning EDA, feature engineering, ML, and evaluation.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-science-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-science-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready Data Science.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Data Science combines <b>statistics</b>, <b>programming</b>, and <b>domain knowledge</b> to turn raw data into decisions and products. From dashboards and forecasts to recommender systems and LLM agents, it's the discipline behind most modern data-driven features. This resource — <b>Data Science — Practice Questions</b> — is self-contained: Hands-on Data Science practice problems spanning EDA, feature engineering, ML, and evaluation.</p>
