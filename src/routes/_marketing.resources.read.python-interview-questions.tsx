...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Curated Python interview questions — language internals, OOP, concurrency, and design.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Interview Questions</b> — is designed to be self-contained: Curated Python interview questions — language internals, OOP, concurrency, and design.</p>
