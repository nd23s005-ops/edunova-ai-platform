...
const RESOURCE: ReaderResource = {
  id: "c-programming-sample-exercises",
  title: "C Programming — Sample Exercises",
  ...
  heroSubtitle: "Bite-size C exercises with sample inputs, outputs, and hints.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-sample-exercises" }],
  }),
  component: Page,
});
