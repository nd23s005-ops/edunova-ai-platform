...
const RESOURCE: ReaderResource = {
  id: "nodejs-project-case-study",
  title: "Node.js — Project Case Study",
  ...
  heroSubtitle: 'Anatomy of a real Node.js project — decisions, trade-offs, folder structure, and lessons learned.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready Node.js.</li>
