...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A printable cybersecurity cheat sheet — CIA Triad, key controls, common ports, incident response phases, and frameworks.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A printable cybersecurity cheat sheet — CIA Triad, key controls, common ports, incident response phases, and frameworks. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
