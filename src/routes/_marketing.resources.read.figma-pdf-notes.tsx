...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Comprehensive chapter-wise Figma notes covering interface, frames, Auto Layout, constraints, typography, colors, grids, components, variants, variables, design systems, prototyping, Smart Animate, Dev Mode, plugins, accessibility, and responsive UI.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — PDF Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive chapter-wise Figma notes covering interface, frames, Auto Layout, constraints, typography, colors, grids, components, variants, variables, design systems, prototyping, Smart Animate, Dev Mode, plugins, accessibility, and responsive UI.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>PDF Notes</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
