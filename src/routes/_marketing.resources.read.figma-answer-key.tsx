...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Complete Answer Key for Figma practice questions \u2014 detailed explanations, recommended workflows, design decisions, accessibility improvements, responsive solutions, prototyping walkthroughs, and evaluation rubrics.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Answer Key.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete Answer Key for Figma practice questions — detailed explanations, recommended workflows, design decisions, accessibility improvements, responsive solutions, prototyping walkthroughs, and evaluation rubrics.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Answer Key</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
