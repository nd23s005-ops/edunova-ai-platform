...
const RESOURCE: ReaderResource = {
  id: "kubernetes-sample-exercises",
  title: "Kubernetes — Sample Exercises",
  ...
  heroSubtitle: "Hands-on lab exercises — build, deploy, scale, and troubleshoot Kubernetes workloads step by step.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-sample-exercises" }],
  }),
  component: Page,
});
