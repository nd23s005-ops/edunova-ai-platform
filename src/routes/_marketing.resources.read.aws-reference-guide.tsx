...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Reference guide covering AWS services, CLI, IAM, networking, and Well-Architected pillars.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This reference guide focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
