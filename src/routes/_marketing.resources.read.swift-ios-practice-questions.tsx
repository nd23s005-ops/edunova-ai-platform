...
const RESOURCE: ReaderResource = {
  id: "swift-ios-practice-questions",
  title: "Swift (iOS) — Practice Questions",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "28 min",
  pages: 24,
  ...
  heroSubtitle: "Hands-on Swift and SwiftUI practice questions covering language, views, and state.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Practice Questions</b> — is designed to be self-contained: Hands-on Swift and SwiftUI practice questions covering language, views, and state.</p>
