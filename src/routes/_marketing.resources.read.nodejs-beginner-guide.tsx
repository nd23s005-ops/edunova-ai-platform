...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A friendly first tour of Node.js — the JavaScript runtime, event loop, modules, and building your first server.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready Node.js.</li>
