...
const RESOURCE: ReaderResource = {
  id: "operating-systems-complete-tutorial",
  ...
  heroSubtitle: "Complete Operating Systems tutorial: architecture, process management, CPU scheduling, synchronization, deadlocks, memory management, paging, segmentation, virtual memory, file systems, disk scheduling, I/O, Linux internals, virtualization, containers, security, and performance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Complete Tutorial.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete Operating Systems tutorial: architecture, process management, CPU scheduling, synchronization, deadlocks, memory management, paging, segmentation, virtual memory, file systems, disk scheduling, I/O, Linux internals, virtualization, containers, security, and performance.</p>
