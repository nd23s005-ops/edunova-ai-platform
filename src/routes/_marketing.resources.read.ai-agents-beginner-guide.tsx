...
const RESOURCE: ReaderResource = {
  id: "ai-agents-beginner-guide",
  title: "AI Agents — Beginner Guide",
  category: "AI & Data",
  difficulty: "Beginner",
  readingTime: "13 min",
  pages: 28,
  ...
  heroSubtitle: "A beginner-friendly introduction to AI agents — autonomy, tools, memory, and planning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This beginner guide focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
