...
const RESOURCE: ReaderResource = {
  id: "nodejs-quick-revision-notes",
  title: "Node.js — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid Node.js revision — modules, event loop, async, streams, and core APIs at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready Node.js.</li>
