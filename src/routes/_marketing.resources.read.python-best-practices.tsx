...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Idiomatic Python — PEP 8, typing, testing, packaging, and clean-code guidelines.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Best Practices</b> — is designed to be self-contained: Idiomatic Python — PEP 8, typing, testing, packaging, and clean-code guidelines.</p>
