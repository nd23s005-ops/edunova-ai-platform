...
const RESOURCE: ReaderResource = {
  id: "data-analytics-project-case-study",
  title: "Data Analytics — Project Case Study",
  ...
  heroSubtitle: 'Anatomy of a real analytics project — data model, KPIs, dashboard, and stakeholder decisions.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, business-ready Data Analytics.</li>
