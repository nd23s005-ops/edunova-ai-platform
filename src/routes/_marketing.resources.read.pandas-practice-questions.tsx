...
const RESOURCE: ReaderResource = {
  id: "pandas-practice-questions",
  title: "Pandas — Practice Questions",
  ...
  heroSubtitle: 'Hands-on Pandas practice questions covering cleaning, transformation, groupby, and joins.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready Pandas.</li>
