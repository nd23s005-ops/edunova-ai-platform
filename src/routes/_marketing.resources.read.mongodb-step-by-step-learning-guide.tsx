...
const RESOURCE: ReaderResource = {
  id: "mongodb-step-by-step-learning-guide",
  title: "MongoDB — Step-by-Step Learning Guide",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "25 min",
  pages: 31,
  ...
  heroSubtitle: 'A progressive MongoDB path — install, shell, Compass, CRUD, aggregation, and production.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready MongoDB.</li>
