...
const RESOURCE: ReaderResource = {
  id: "android-project-case-study",
  title: "Android Development — Project Case Study",
  category: "Mobile",
  ...
  heroSubtitle: 'Anatomy of a real Android project — modules, DI, offline-first, and Play Store rollout.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Project Case Study</b> — is self-contained: Anatomy of a real Android project — modules, DI, offline-first, and Play Store rollout.</p>
