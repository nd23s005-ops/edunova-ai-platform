...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Practical Python tips — comprehensions, unpacking, dataclasses, and shortcuts that save time.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Tips & Tricks</b> — is designed to be self-contained: Practical Python tips — comprehensions, unpacking, dataclasses, and shortcuts that save time.</p>
