...
const RESOURCE: ReaderResource = {
  id: "postgresql-sample-exercises",
  title: "PostgreSQL — Sample Exercises",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "15 min",
  pages: 29,
  ...
  heroSubtitle: "Bite-size PostgreSQL exercises with sample schemas, expected outputs, and hints.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Sample Exercises</b> — is designed to be self-contained: Bite-size PostgreSQL exercises with sample schemas, expected outputs, and hints.</p>
