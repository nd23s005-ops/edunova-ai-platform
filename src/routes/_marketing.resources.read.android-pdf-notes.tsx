...
const RESOURCE: ReaderResource = {
  id: "android-pdf-notes",
  title: "Android Development — PDF Notes",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "83 min",
  pages: 90,
  ...
  heroSubtitle: 'Deep printable Android notes — components, Jetpack, Compose, architecture, security, and MLOps for mobile.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — PDF Notes</b> — is self-contained: Deep printable Android notes — components, Jetpack, Compose, architecture, security, and MLOps for mobile.</p>
