...
const RESOURCE: ReaderResource = {
  id: "ai-agents-quick-revision-notes",
  title: "AI Agents — Quick Revision Notes",
  category: "AI & Data",
  difficulty: "Beginner",
  readingTime: "12 min",
  pages: 10,
  ...
  heroSubtitle: "Condensed revision notes on AI agents for interviews and last-minute prep.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This quick revision notes focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
