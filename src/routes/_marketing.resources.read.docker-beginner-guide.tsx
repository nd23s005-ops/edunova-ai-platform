...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "This beginner guide introduces Docker — the industry-standard container platform for packaging, shipping, and running portable applications anywhere.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>This beginner guide introduces Docker — the industry-standard container platform for packaging, shipping, and running portable applications anywhere.</p>
