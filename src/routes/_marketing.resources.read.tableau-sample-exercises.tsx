...
const RESOURCE: ReaderResource = {
  id: "tableau-sample-exercises",
  title: "Tableau — Sample Exercises",
  ...
  heroSubtitle: "Hands-on sample exercises for Tableau — build charts, apply LOD, design KPI dashboards, and practise storytelling with data.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Hands-on sample exercises for Tableau — build charts, apply LOD, design KPI dashboards, and practise storytelling with data.</p>
