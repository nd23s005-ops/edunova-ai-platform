...
const RESOURCE: ReaderResource = {
  id: "javascript-answer-key",
  title: "JavaScript — Answer Key",
  ...
  heroSubtitle: "Complete solutions and explanations for the JavaScript Practice Questions \u2014 with alternative approaches, optimizations, and rubrics.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Solution Format" },
  { id: "s2", label: "2. MCQ Answers" },
  { id: "s3", label: "3. Debugging" },
  { id: "s4", label: "4. Async Solutions" },
  { id: "s5", label: "5. Optimization Tips" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Answer Key.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive walkthroughs for every practice question, including multiple approaches and evaluation rubrics.</p>
      ...
      <Section id="s1" title="1. Solution Format">
        <p>Question → Approach → Code → Complexity → Alternatives.</p>
        <Code lang="js">{`// Solution Format — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from solution format";
};`}</Code>
      </Section>

      <Section id="s2" title="2. MCQ Answers">
        <p>Correct option + why others fail.</p>
        <Code lang="js">{`// MCQ Answers — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from mcq answers";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Debugging">
        <p>Root cause + fix + prevention.</p>
...
const example = () => {
  ...
  return "hello from debugging";
      ...
      <Section id="s4" title="4. Async Solutions">
        <p>Sequential vs parallel breakdowns.</p>
        <Code lang="js">{`// Async Solutions — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from async solutions";
};`}</Code>
      </Section>

      <Section id="s5" title="5. Optimization Tips">
        <p>Before/after complexity.</p>
        <Code lang="js">{`// Optimization Tips — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from optimization tips";
};`}</Code>
      </Section>

      <Section id="s6" title="6. Rubrics">
        <p>Scoring: correctness, efficiency, readability, edge cases.</p>
        <Code lang="js">{`// Rubrics — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from rubrics";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Answer Key equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
