...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "End-to-end SQL tutorial from SELECT to joins, indexes, transactions, and design.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Complete Tutorial</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Complete Tutorial</b> — is designed to be self-contained: End-to-end SQL tutorial from SELECT to joins, indexes, transactions, and design.</p>
