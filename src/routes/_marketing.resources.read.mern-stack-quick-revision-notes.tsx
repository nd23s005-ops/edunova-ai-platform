...
const RESOURCE: ReaderResource = {
  id: "mern-stack-quick-revision-notes",
  title: "MERN Stack — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid MERN revision — MongoDB, Express, React, and Node essentials at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready MERN full-stack development.</li>
