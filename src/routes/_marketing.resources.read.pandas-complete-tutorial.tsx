...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'End-to-end Pandas tutorial — I/O, cleaning, transformation, groupby, joins, time series, and ETL.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, production-ready Pandas.</li>
