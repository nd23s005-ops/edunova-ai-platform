...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A concise glossary of Pandas terms — from Series and DataFrame to MultiIndex and resampling.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, production-ready Pandas.</li>
