...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Deep, printable Java notes covering the language, JVM, and real-world workflows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>PDF Notes</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — PDF Notes</b> — is designed to be self-contained: Deep, printable Java notes covering the language, JVM, and real-world workflows.</p>
