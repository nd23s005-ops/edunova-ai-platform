...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Comprehensive PostgreSQL reference — syntax, joins, JSONB, indexes, and tooling.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Reference Guide</b> — is designed to be self-contained: Comprehensive PostgreSQL reference — syntax, joins, JSONB, indexes, and tooling.</p>
