...
const RESOURCE: ReaderResource = {
  id: "dsa-sample-exercises",
  title: "Data Structures & Algorithms — Sample Exercises",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "19 min",
  pages: 33,
  ...
  heroSubtitle: "Comprehensive DSA workbook with 300+ beginner to advanced exercises across arrays, strings, linked lists, stacks, queues, hash tables, trees, heaps, graphs, recursion, DP, greedy, and competitive programming.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Sample Exercises.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive DSA workbook with 300+ beginner to advanced exercises across arrays, strings, linked lists, stacks, queues, hash tables, trees, heaps, graphs, recursion, DP, greedy, and competitive programming.</p>
