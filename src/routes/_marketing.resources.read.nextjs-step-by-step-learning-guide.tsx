...
const RESOURCE: ReaderResource = {
  id: "nextjs-step-by-step-learning-guide",
  title: "Next.js — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive path through Next.js — one concept at a time with runnable App Router examples.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Step-by-Step Learning Guide</b> — is self-contained: A progressive path through Next.js — one concept at a time with runnable App Router examples.</p>
