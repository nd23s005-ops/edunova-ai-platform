...
const RESOURCE: ReaderResource = {
  id: "power-bi-beginner-guide",
  title: "Power BI — Beginner Guide",
  ...
  heroSubtitle: "This beginner guide introduces Microsoft Power BI — the enterprise BI platform for turning data into interactive reports, dashboards, and executive-ready insights.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>This beginner guide introduces Microsoft Power BI — the enterprise BI platform for turning data into interactive reports, dashboards, and executive-ready insights.</p>
