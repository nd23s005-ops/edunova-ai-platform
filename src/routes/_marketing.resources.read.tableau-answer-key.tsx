...
const RESOURCE: ReaderResource = {
  id: "tableau-answer-key",
  title: "Tableau — Answer Key",
  ...
  heroSubtitle: "Detailed answer key explaining the reasoning, formulas, and design decisions behind every Tableau practice question.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Detailed answer key explaining the reasoning, formulas, and design decisions behind every Tableau practice question.</p>
