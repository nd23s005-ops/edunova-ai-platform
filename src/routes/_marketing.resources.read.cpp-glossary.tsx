...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A-to-Z glossary of C++ and modern-C++ terminology used across this library.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Glossary</b> — practical, modern-C++ coverage.</li>
