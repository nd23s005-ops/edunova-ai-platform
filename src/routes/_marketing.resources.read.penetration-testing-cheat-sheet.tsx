...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-cheat-sheet",
  ...
  heroSubtitle: "A printable educational cheat sheet summarizing pentest lifecycle, PTES phases, OWASP Top 10, vulnerability severity ratings, assessment workflow, reporting checklist, and cybersecurity terminology for quick reference.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A printable educational cheat sheet summarizing pentest lifecycle, PTES phases, OWASP Top 10, vulnerability severity ratings, assessment workflow, reporting checklist, and cybersecurity terminology for quick reference. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
