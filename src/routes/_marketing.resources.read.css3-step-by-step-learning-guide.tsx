...
const RESOURCE: ReaderResource = {
  id: "css3-step-by-step-learning-guide",
  title: "CSS3 — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive path through CSS3 — one concept at a time, with live layout examples.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Step-by-Step Learning Guide</b> — is self-contained: A progressive path through CSS3 — one concept at a time, with live layout examples.</p>
