...
const RESOURCE: ReaderResource = {
  id: "operating-systems-project-guide",
  title: "Operating Systems — Project Guide",
  category: "CS Core",
  ...
  heroSubtitle: "OS project guide: process scheduler simulation, memory manager simulator, virtual file system, shell implementation, CPU scheduling visualizer, synchronization simulator, Linux monitoring, testing, deployment, and documentation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Project Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>OS project guide: process scheduler simulation, memory manager simulator, virtual file system, shell implementation, CPU scheduling visualizer, synchronization simulator, Linux monitoring, testing, deployment, and documentation.</p>
