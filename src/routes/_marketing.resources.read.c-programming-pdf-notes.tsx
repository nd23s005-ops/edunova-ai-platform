...
const RESOURCE: ReaderResource = {
  id: "c-programming-pdf-notes",
  title: "C Programming — PDF Notes",
  ...
  heroSubtitle: "Deep, printable C notes covering the language, memory model, and real-world workflows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-pdf-notes" }],
  }),
  component: Page,
});
