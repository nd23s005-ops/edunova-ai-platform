...
const RESOURCE: ReaderResource = {
  id: "devops-practice-questions",
  title: "DevOps — Practice Questions",
  ...
  heroSubtitle: "Practice sets covering DevOps fundamentals, containers, IaC, pipelines, cloud, and monitoring.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Practice sets covering DevOps fundamentals, containers, IaC, pipelines, cloud, and monitoring. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
...
deploy: kubectl set image deploy/app app=registry/app:$SHA`}</Code>
      ...
      <Section id="questions" title="Practice Set">
        <ol className="list-decimal space-y-1 pl-5">
          <li>Write a GitHub Actions workflow that runs tests on pull requests.</li>
          <li>Author a multi-stage Dockerfile for a Node.js app under 100MB.</li>
          <li>Write a Terraform module that provisions an S3 bucket with versioning.</li>
          <li>Create a Kubernetes Deployment + Service manifest with 3 replicas.</li>
          <li>Configure a Prometheus scrape target for a Node.js exporter.</li>
          <li>Add an Ansible playbook to install and enable nginx.</li>
          <li>Design a Helm chart values.yaml with environment overrides.</li>
          <li>Write a Bash script to rotate log files older than 7 days.</li>
          <li>Implement a canary deployment strategy in Argo Rollouts.</li>
          <li>Add HPA to a Deployment based on CPU above 70%.</li>
        </ol>
      </Section>
