...
const RESOURCE: ReaderResource = {
  id: "angular-pdf-notes",
  title: "Angular — PDF Notes",
  ...
  heroSubtitle: 'Comprehensive Angular notes covering components, DI, RxJS, signals, routing, and enterprise patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — PDF Notes</b> — is self-contained: Comprehensive Angular notes covering components, DI, RxJS, signals, routing, and enterprise patterns.</p>
