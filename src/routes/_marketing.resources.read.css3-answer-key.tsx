...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Complete worked solutions and explanations for the CSS3 practice question set.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Answer Key</b> — is self-contained: Complete worked solutions and explanations for the CSS3 practice question set.</p>
