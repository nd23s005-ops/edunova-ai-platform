...
const RESOURCE: ReaderResource = {
  id: "kubernetes-pdf-notes",
  title: "Kubernetes — PDF Notes",
  ...
  heroSubtitle: "Complete printable Kubernetes notes covering architecture, workloads, networking, storage, security, and observability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-pdf-notes" }],
  }),
  component: Page,
});
