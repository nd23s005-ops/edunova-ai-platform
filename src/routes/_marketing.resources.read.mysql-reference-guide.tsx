...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Comprehensive MySQL reference — syntax, joins, functions, indexes, and tooling.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Reference Guide</b> — is designed to be self-contained: Comprehensive MySQL reference — syntax, joins, functions, indexes, and tooling.</p>
