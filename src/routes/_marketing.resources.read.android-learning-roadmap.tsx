...
const RESOURCE: ReaderResource = {
  id: "android-learning-roadmap",
  title: "Android Development — Learning Roadmap",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "8 min",
  pages: 10,
  ...
  heroSubtitle: 'A month-by-month Android roadmap from Kotlin basics to senior Android engineer.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Learning Roadmap</b> — is self-contained: A month-by-month Android roadmap from Kotlin basics to senior Android engineer.</p>
