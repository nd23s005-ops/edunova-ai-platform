...
const RESOURCE: ReaderResource = {
  id: "cyber-security-real-world-case-study",
  title: "Cyber Security — Real-world Case Study",
  category: "Security",
  ...
  heroSubtitle: "A real-world enterprise case study — how layered defenses reduced risk and improved cyber resilience.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A real-world enterprise case study — how layered defenses reduced risk and improved cyber resilience. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
