...
const RESOURCE: ReaderResource = {
  id: "expressjs-sample-exercises",
  title: "Express.js — Sample Exercises",
  ...
  heroSubtitle: 'Small, focused Express.js exercises to build routing, middleware, validation, and API muscle memory.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Sample Exercises</b> — is self-contained: Small, focused Express.js exercises to build routing, middleware, validation, and API muscle memory.</p>
