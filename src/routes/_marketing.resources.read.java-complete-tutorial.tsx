...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "End-to-end Java tutorial from installation to OOP, collections, streams, and Spring Boot.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Complete Tutorial</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Complete Tutorial</b> — is designed to be self-contained: End-to-end Java tutorial from installation to OOP, collections, streams, and Spring Boot.</p>
