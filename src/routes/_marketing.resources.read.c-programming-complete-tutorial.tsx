...
const RESOURCE: ReaderResource = {
  id: "c-programming-complete-tutorial",
  ...
  heroSubtitle: "End-to-end C tutorial from installation to pointers, structs, files, and small systems programs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-complete-tutorial" }],
  }),
  component: Page,
});
