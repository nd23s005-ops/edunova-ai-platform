...
const RESOURCE: ReaderResource = {
  id: "azure-complete-tutorial",
  title: "Microsoft Azure — Complete Tutorial",
  ...
  heroSubtitle: "End-to-end Azure tutorial — compute, storage, networking, identity, databases, DevOps, and monitoring.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>End-to-end Azure tutorial — compute, storage, networking, identity, databases, DevOps, and monitoring. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
