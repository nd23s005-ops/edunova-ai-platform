...
const RESOURCE: ReaderResource = {
  id: "java-frequently-asked-questions",
  ...
  heroSubtitle: "Answers to the most common Java questions from beginners and working developers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Frequently Asked Questions</b> — is designed to be self-contained: Answers to the most common Java questions from beginners and working developers.</p>
