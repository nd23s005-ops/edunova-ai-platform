...
const RESOURCE: ReaderResource = {
  id: "nodejs-common-mistakes",
  title: "Node.js — Common Mistakes",
  ...
  heroSubtitle: 'The Node.js pitfalls that bite in production — blocking the event loop, async errors, and leaks.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready Node.js.</li>
