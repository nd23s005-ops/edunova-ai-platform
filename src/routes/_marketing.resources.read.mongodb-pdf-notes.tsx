...
const RESOURCE: ReaderResource = {
  id: "mongodb-pdf-notes",
  title: "MongoDB — PDF Notes",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "62 min",
  pages: 91,
  ...
  heroSubtitle: 'Deep printable MongoDB notes — BSON, schema design, aggregation, indexing, replication, and security.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready MongoDB.</li>
