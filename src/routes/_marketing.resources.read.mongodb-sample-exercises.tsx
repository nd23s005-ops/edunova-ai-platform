...
const RESOURCE: ReaderResource = {
  id: "mongodb-sample-exercises",
  title: "MongoDB — Sample Exercises",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "15 min",
  pages: 18,
  ...
  heroSubtitle: 'Small, focused MongoDB exercises to build CRUD, aggregation, and indexing muscle memory.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready MongoDB.</li>
