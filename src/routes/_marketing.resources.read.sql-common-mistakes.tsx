...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "N+1 queries, missing indexes, cartesian joins, and other classic SQL pitfalls.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Common Mistakes</b> — is designed to be self-contained: N+1 queries, missing indexes, cartesian joins, and other classic SQL pitfalls.</p>
