...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page MERN reference — Mongoose schemas, Express router, React hooks, and Node commands.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready MERN full-stack development.</li>
