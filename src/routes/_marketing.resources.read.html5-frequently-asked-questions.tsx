...
const RESOURCE: ReaderResource = {
  id: "html5-frequently-asked-questions",
  title: "HTML5 — Frequently Asked Questions",
  ...
  heroSubtitle: "HTML5 FAQ \u2014 semantics, a11y, forms, multimedia, Canvas, SVG, metadata, SEO, responsive, careers.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Getting Started" },
  { id: "s2", label: "2. Semantics" },
  { id: "s3", label: "3. Accessibility" },
  { id: "s4", label: "4. Forms" },
  { id: "s5", label: "5. SEO" },
  { id: "s6", label: "6. Careers" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Frequently Asked Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>The HTML5 questions we hear most, answered directly.</p>
      ...
      <Section id="s1" title="1. Getting Started">
        <p>Do I need CSS/JS to learn HTML?</p>
        <Code lang="html">{`<!-- Getting Started — illustrative snippet -->
<section aria-label="getting started">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s2" title="2. Semantics">
        <p>Article vs section?</p>
        <Code lang="html">{`<!-- Semantics — illustrative snippet -->
<section aria-label="semantics">
  <h2>Semantics</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>
...
<section aria-label="accessibility">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s4" title="4. Forms">
        <p>When to use novalidate?</p>
...
<section aria-label="seo">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s6" title="6. Careers">
        <p>Is HTML alone enough?</p>
        <Code lang="html">{`<!-- Careers — illustrative snippet -->
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Frequently Asked Questions equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
