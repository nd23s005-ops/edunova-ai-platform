...
const RESOURCE: ReaderResource = {
  id: "cyber-security-pdf-notes",
  title: "Cyber Security — PDF Notes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "54 min",
  pages: 90,
  ...
  heroSubtitle: "Comprehensive chapter-wise notes on cybersecurity — threats, IAM, cryptography, network security, cloud, IR, and compliance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive chapter-wise notes on cybersecurity — threats, IAM, cryptography, network security, cloud, IR, and compliance. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
