...
const RESOURCE: ReaderResource = {
  id: "typescript-advanced-concepts",
  ...
  heroSubtitle: 'Conditional types, mapped types, template literals, and inference — advanced TypeScript.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Advanced Concepts</b> — is self-contained: Conditional types, mapped types, template literals, and inference — advanced TypeScript.</p>
