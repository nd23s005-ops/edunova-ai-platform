...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Idiomatic SQL — clean queries, safe transactions, indexing, and maintainability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Best Practices</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Best Practices</b> — is designed to be self-contained: Idiomatic SQL — clean queries, safe transactions, indexing, and maintainability.</p>
