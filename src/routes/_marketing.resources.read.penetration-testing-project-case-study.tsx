...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-project-case-study",
  title: "Penetration Testing — Project Case Study",
  category: "Security",
  ...
  heroSubtitle: "A production-quality educational case study of an authorized enterprise security assessment — planning through reporting — focusing on methodology, risk prioritization, stakeholder communication, remediation, lessons learned, and measurable improvements.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A production-quality educational case study of an authorized enterprise security assessment — planning through reporting — focusing on methodology, risk prioritization, stakeholder communication, remediation, lessons learned, and measurable improvements. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
