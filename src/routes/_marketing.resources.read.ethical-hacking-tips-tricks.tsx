...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-tips-tricks",
  title: "Ethical Hacking — Tips & Tricks",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 15,
  ...
  heroSubtitle: "Productivity tips for ethical hackers — documentation, evidence capture, mapping to OWASP/MITRE, and clear risk communication.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Productivity tips for ethical hackers — documentation, evidence capture, mapping to OWASP/MITRE, and clear risk communication. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
