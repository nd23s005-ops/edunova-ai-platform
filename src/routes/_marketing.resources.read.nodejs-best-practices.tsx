...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Battle-tested Node.js practices — folder structure, async handling, security, and maintainability.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Best Practices</b> — practical, production-ready Node.js.</li>
