...
const RESOURCE: ReaderResource = {
  id: "mern-stack-answer-key",
  title: "MERN Stack — Answer Key",
  ...
  heroSubtitle: 'Worked answers and explanations for the MERN practice set — code, reasoning, and edge cases.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready MERN full-stack development.</li>
