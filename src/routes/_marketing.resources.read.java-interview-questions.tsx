...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Curated Java interview questions — language, JVM, collections, concurrency, and design.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Interview Questions</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Interview Questions</b> — is designed to be self-contained: Curated Java interview questions — language, JVM, collections, concurrency, and design.</p>
