...
const RESOURCE: ReaderResource = {
  id: "data-science-step-by-step-learning-guide",
  title: "Data Science — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive Data Science path — Python, NumPy/Pandas, SQL, ML, and production models.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-science-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-science-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready Data Science.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Data Science combines <b>statistics</b>, <b>programming</b>, and <b>domain knowledge</b> to turn raw data into decisions and products. From dashboards and forecasts to recommender systems and LLM agents, it's the discipline behind most modern data-driven features. This resource — <b>Data Science — Step-by-Step Learning Guide</b> — is self-contained: A progressive Data Science path — Python, NumPy/Pandas, SQL, ML, and production models.</p>
