...
const RESOURCE: ReaderResource = {
  id: "java-project-case-study",
  title: "Java — Project Case Study",
  ...
  heroSubtitle: "Full case study of a Java project — problem, design, code, testing, and deployment.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Project Case Study</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Project Case Study</b> — is designed to be self-contained: Full case study of a Java project — problem, design, code, testing, and deployment.</p>
