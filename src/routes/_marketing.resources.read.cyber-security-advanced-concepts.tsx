...
const RESOURCE: ReaderResource = {
  id: "cyber-security-advanced-concepts",
  title: "Cyber Security — Advanced Concepts",
  category: "Security",
  difficulty: "Advanced",
  readingTime: "29 min",
  pages: 43,
  ...
  heroSubtitle: "Advanced defensive concepts — Zero Trust, SASE, EDR/XDR, cloud/K8s security, DevSecOps, and AI in cybersecurity.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced defensive concepts — Zero Trust, SASE, EDR/XDR, cloud/K8s security, DevSecOps, and AI in cybersecurity. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
