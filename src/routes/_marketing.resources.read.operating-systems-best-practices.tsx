...
const RESOURCE: ReaderResource = {
  ...
  title: "Operating Systems — Best Practices",
  category: "CS Core",
  ...
  heroSubtitle: "Operating Systems best practices handbook: process optimization, synchronization, memory management, filesystem organization, Linux administration, security hardening, monitoring, troubleshooting, and performance tuning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Best Practices.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Operating Systems best practices handbook: process optimization, synchronization, memory management, filesystem organization, Linux administration, security hardening, monitoring, troubleshooting, and performance tuning.</p>
