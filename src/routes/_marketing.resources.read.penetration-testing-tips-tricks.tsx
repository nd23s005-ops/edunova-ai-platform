...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-tips-tricks",
  title: "Penetration Testing — Tips & Tricks",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "8 min",
  pages: 11,
  ...
  heroSubtitle: "A productivity guide covering documentation, reporting, evidence organization, project planning, note-taking, stakeholder communication, lab setup, portfolio building, certification prep, and workflow optimization for ethical pentesters.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A productivity guide covering documentation, reporting, evidence organization, project planning, note-taking, stakeholder communication, lab setup, portfolio building, certification prep, and workflow optimization for ethical pentesters. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
