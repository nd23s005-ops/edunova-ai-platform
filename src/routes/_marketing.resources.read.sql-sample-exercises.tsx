...
const RESOURCE: ReaderResource = {
  id: "sql-sample-exercises",
  title: "SQL — Sample Exercises",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "18 min",
  pages: 19,
  ...
  heroSubtitle: "Bite-size SQL exercises with sample schemas, expected outputs, and hints.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Sample Exercises</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Sample Exercises</b> — is designed to be self-contained: Bite-size SQL exercises with sample schemas, expected outputs, and hints.</p>
