...
const RESOURCE: ReaderResource = {
  id: "expressjs-pdf-notes",
  title: "Express.js — PDF Notes",
  ...
  heroSubtitle: 'Deep printable notes on Express.js — architecture, request lifecycle, middleware, REST design, and production hardening.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — PDF Notes</b> — is self-contained: Deep printable notes on Express.js — architecture, request lifecycle, middleware, REST design, and production hardening.</p>
