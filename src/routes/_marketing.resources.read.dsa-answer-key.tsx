...
const RESOURCE: ReaderResource = {
  id: "dsa-answer-key",
  title: "Data Structures & Algorithms — Answer Key",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "31 min",
  pages: 34,
  ...
  heroSubtitle: "Complete answer key for the DSA practice workbook: detailed explanations, optimized solutions, alternative approaches, complexity analysis, dry runs, visualization, and evaluation rubrics.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Answer Key.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete answer key for the DSA practice workbook: detailed explanations, optimized solutions, alternative approaches, complexity analysis, dry runs, visualization, and evaluation rubrics.</p>
