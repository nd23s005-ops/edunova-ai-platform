...
const RESOURCE: ReaderResource = {
  id: "expressjs-common-mistakes",
  title: "Express.js — Common Mistakes",
  ...
  heroSubtitle: 'The Express.js pitfalls that bite in production — middleware order, async errors, and leaks.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Common Mistakes</b> — is self-contained: The Express.js pitfalls that bite in production — middleware order, async errors, and leaks.</p>
