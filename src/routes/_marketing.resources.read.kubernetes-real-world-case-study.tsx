...
const RESOURCE: ReaderResource = {
  id: "kubernetes-real-world-case-study",
  title: "Kubernetes — Real-world Case Study",
  ...
  heroSubtitle: "How enterprises run Kubernetes in production — architecture, reliability, and lessons learned.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-real-world-case-study" }],
  }),
  component: Page,
});
