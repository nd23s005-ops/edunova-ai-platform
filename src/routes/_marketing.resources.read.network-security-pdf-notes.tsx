...
const RESOURCE: ReaderResource = {
  id: "network-security-pdf-notes",
  title: "Network Security — PDF Notes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "58 min",
  pages: 159,
  ...
  heroSubtitle: "Comprehensive chapter-wise notes covering Network Security concepts including architecture, OSI/TCP-IP models, firewalls, IDS/IPS, VPNs, VLAN security, DNS security, wireless security, SIEM, Zero Trust, cloud networking, monitoring, and compliance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive chapter-wise notes covering Network Security concepts including architecture, OSI/TCP-IP models, firewalls, IDS/IPS, VPNs, VLAN security, DNS security, wireless security, SIEM, Zero Trust, cloud networking, monitoring, and compliance. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
