...
const RESOURCE: ReaderResource = {
  id: "nextjs-project-case-study",
  title: "Next.js — Project Case Study",
  ...
  heroSubtitle: 'Deep-dive case study of a production Next.js project — architecture, rendering, and trade-offs.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Project Case Study</b> — is self-contained: Deep-dive case study of a production Next.js project — architecture, rendering, and trade-offs.</p>
