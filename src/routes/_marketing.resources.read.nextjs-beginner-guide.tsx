...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A friendly first tour of Next.js — App Router, Server Components, and shipping your first full-stack page.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Beginner Guide</b> — is self-contained: A friendly first tour of Next.js — App Router, Server Components, and shipping your first full-stack page.</p>
