...
const RESOURCE: ReaderResource = {
  id: "mongodb-project-guide",
  title: "MongoDB — Project Guide",
  category: "Databases",
  ...
  heroSubtitle: 'Ship a production-grade MongoDB-backed service — schema, indexes, transactions, backup, and deploy.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — practical, production-ready MongoDB.</li>
