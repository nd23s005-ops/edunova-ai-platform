...
const RESOURCE: ReaderResource = {
  id: "css3-frequently-asked-questions",
  title: "CSS3 — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most frequently asked CSS3 questions — from selectors to advanced layout.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Frequently Asked Questions</b> — is self-contained: Answers to the most frequently asked CSS3 questions — from selectors to advanced layout.</p>
