...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Google Cloud best practices for reliability, security, cost, operations, and performance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-best-practices" }],
  }),
  component: Page,
});
