...
const RESOURCE: ReaderResource = {
  id: "ux-design-real-world-case-study",
  title: "UX Design — Real-world Case Study",
  category: "Design",
  ...
  heroSubtitle: "Real-world enterprise case study showing how UX Design improved user satisfaction, conversion, accessibility, engagement, and product usability through research, iterative design, and analytics.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Real-world Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Real-world enterprise case study showing how UX Design improved user satisfaction, conversion, accessibility, engagement, and product usability through research, iterative design, and analytics.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Real-world Case Study</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
