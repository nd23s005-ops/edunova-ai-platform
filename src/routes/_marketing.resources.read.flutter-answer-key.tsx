...
const RESOURCE: ReaderResource = {
  id: "flutter-answer-key",
  title: "Flutter — Answer Key",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "31 min",
  pages: 47,
  ...
  heroSubtitle: 'Worked answers for the Flutter practice set — code, reasoning, and pitfalls.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — modern, production-ready Flutter development.</li>
