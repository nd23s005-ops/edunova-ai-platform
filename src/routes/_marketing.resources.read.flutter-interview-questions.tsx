...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Curated Flutter interview questions — Dart, widgets, state, architecture, and system design.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — modern, production-ready Flutter development.</li>
