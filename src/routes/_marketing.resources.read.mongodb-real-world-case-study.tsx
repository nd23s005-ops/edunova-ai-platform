...
const RESOURCE: ReaderResource = {
  id: "mongodb-real-world-case-study",
  title: "MongoDB — Real-world Case Study",
  category: "Databases",
  ...
  heroSubtitle: 'How teams run MongoDB in production — Atlas, sharding, observability, and postmortems.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready MongoDB.</li>
