...
const RESOURCE: ReaderResource = {
  id: "pandas-project-case-study",
  title: "Pandas — Project Case Study",
  ...
  heroSubtitle: 'Deep-dive case study of a production Pandas ETL — architecture, quality checks, and trade-offs.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready Pandas.</li>
