...
const RESOURCE: ReaderResource = {
  id: "swift-ios-real-world-case-study",
  title: "Swift (iOS) — Real-world Case Study",
  category: "Mobile",
  ...
  heroSubtitle: "Real production iOS apps — SwiftUI at scale, MVVM, concurrency, and App Store rollout.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Real-world Case Study</b> — is designed to be self-contained: Real production iOS apps — SwiftUI at scale, MVVM, concurrency, and App Store rollout.</p>
