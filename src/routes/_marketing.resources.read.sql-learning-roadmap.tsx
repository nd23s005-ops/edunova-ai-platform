...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A month-by-month SQL roadmap from beginner to production-ready database engineer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Learning Roadmap</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Learning Roadmap</b> — is designed to be self-contained: A month-by-month SQL roadmap from beginner to production-ready database engineer.</p>
