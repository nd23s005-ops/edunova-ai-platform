...
const RESOURCE: ReaderResource = {
  id: "nextjs-frequently-asked-questions",
  title: "Next.js — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most frequently asked Next.js questions — from setup to advanced patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Frequently Asked Questions</b> — is self-contained: Answers to the most frequently asked Next.js questions — from setup to advanced patterns.</p>
