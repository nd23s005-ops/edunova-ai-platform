...
const RESOURCE: ReaderResource = {
  id: "kubernetes-common-mistakes",
  title: "Kubernetes — Common Mistakes",
  ...
  heroSubtitle: "The most common Kubernetes mistakes teams make — and how to avoid them.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-common-mistakes" }],
  }),
  component: Page,
});
