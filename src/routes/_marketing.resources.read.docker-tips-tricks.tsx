...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Power-user Docker tips and tricks — BuildKit, cache mounts, multi-stage builds, and Compose profiles that separate pros from beginners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Power-user Docker tips and tricks — BuildKit, cache mounts, multi-stage builds, and Compose profiles that separate pros from beginners.</p>
