...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Deep C++ — templates, move semantics, concepts, coroutines, and performance tuning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Advanced Concepts</b> — practical, modern-C++ coverage.</li>
