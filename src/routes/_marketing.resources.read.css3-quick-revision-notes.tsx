...
const RESOURCE: ReaderResource = {
  id: "css3-quick-revision-notes",
  title: "CSS3 — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid-fire CSS3 revision — selectors, box model, Flexbox, Grid, and responsive design in minutes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Quick Revision Notes</b> — is self-contained: Rapid-fire CSS3 revision — selectors, box model, Flexbox, Grid, and responsive design in minutes.</p>
