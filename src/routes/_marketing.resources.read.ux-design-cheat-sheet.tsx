...
const RESOURCE: ReaderResource = {
  id: "ux-design-cheat-sheet",
  title: "UX Design — Cheat Sheet",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "5 min",
  pages: 3,
  ...
  heroSubtitle: "Printable UX Design cheat sheet covering the UX process, design thinking stages, usability heuristics, research methods, personas, journey mapping, wireframing, prototyping, and accessibility guidelines.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Cheat Sheet.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Printable UX Design cheat sheet covering the UX process, design thinking stages, usability heuristics, research methods, personas, journey mapping, wireframing, prototyping, and accessibility guidelines.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Cheat Sheet</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
