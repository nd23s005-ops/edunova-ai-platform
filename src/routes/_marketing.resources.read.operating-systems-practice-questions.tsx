...
const RESOURCE: ReaderResource = {
  id: "operating-systems-practice-questions",
  ...
  heroSubtitle: "Structured OS practice workbook with 350+ exercises: MCQs, numerical problems, scheduling calculations, synchronization exercises, Linux command practice, case studies, debugging scenarios, and mini projects.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Practice Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Structured OS practice workbook with 350+ exercises: MCQs, numerical problems, scheduling calculations, synchronization exercises, Linux command practice, case studies, debugging scenarios, and mini projects.</p>
