...
const RESOURCE: ReaderResource = {
  id: "typescript-step-by-step-learning-guide",
  title: "TypeScript — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive path through TypeScript — one concept at a time, with runnable examples.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Step-by-Step Learning Guide</b> — is self-contained: A progressive path through TypeScript — one concept at a time, with runnable examples.</p>
