...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Practical CSS3 tips and tricks — modern selectors, container queries, and productivity boosters.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Tips & Tricks</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Tips & Tricks</b> — is self-contained: Practical CSS3 tips and tricks — modern selectors, container queries, and productivity boosters.</p>
