...
const RESOURCE: ReaderResource = {
  id: "tableau-project-case-study",
  title: "Tableau — Project Case Study",
  ...
  heroSubtitle: "A detailed project case study showing how a Tableau workbook was designed, built, and delivered for a real business use case.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A detailed project case study showing how a Tableau workbook was designed, built, and delivered for a real business use case.</p>
