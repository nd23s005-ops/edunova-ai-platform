...
const RESOURCE: ReaderResource = {
  id: "tableau-frequently-asked-questions",
  title: "Tableau — Frequently Asked Questions",
  ...
  heroSubtitle: "Answers to the most frequently asked Tableau questions — features, licensing, deployment, LOD, performance, and career paths.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Answers to the most frequently asked Tableau questions — features, licensing, deployment, LOD, performance, and career paths.</p>
