...
const RESOURCE: ReaderResource = {
  id: "tableau-step-by-step-learning-guide",
  title: "Tableau — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "This step-by-step learning guide sequences your Tableau journey — one skill per lesson — so you can build real dashboards while learning the underlying concepts.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>This step-by-step learning guide sequences your Tableau journey — one skill per lesson — so you can build real dashboards while learning the underlying concepts.</p>
