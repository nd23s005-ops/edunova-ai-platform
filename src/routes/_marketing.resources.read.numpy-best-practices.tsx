...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "The battle-tested patterns, conventions, and defaults that make NumPy code fast and maintainable.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Best Practices</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Best Practices</b> — is self-contained: The battle-tested patterns, conventions, and defaults that make NumPy code fast and maintainable.</p>
