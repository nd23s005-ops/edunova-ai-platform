...
const RESOURCE: ReaderResource = {
  id: "flutter-real-world-case-study",
  title: "Flutter — Real-world Case Study",
  category: "Mobile",
  ...
  heroSubtitle: 'How teams run Flutter in production — architecture, telemetry, crash reporting, and A/B testing.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — modern, production-ready Flutter development.</li>
