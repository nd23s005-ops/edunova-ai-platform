...
const RESOURCE: ReaderResource = {
  id: "ai-agents-step-by-step-learning-guide",
  title: "AI Agents — Step-by-Step Learning Guide",
  category: "AI & Data",
  difficulty: "Beginner",
  readingTime: "24 min",
  pages: 34,
  ...
  heroSubtitle: "A structured path from your first LLM call to production agentic systems.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This step-by-step learning guide focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
