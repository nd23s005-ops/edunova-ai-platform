...
const RESOURCE: ReaderResource = {
  id: "dsa-project-guide",
  title: "Data Structures & Algorithms — Project Guide",
  category: "CS Core",
  ...
  heroSubtitle: "DSA project guide: route optimization, search engine indexing, recommendation systems, scheduling systems, graph visualizers, algorithm visualizers, benchmarking, testing, documentation, and deployment.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Project Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>DSA project guide: route optimization, search engine indexing, recommendation systems, scheduling systems, graph visualizers, algorithm visualizers, benchmarking, testing, documentation, and deployment.</p>
