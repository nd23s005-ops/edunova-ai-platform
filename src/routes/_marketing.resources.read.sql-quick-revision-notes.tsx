...
const RESOURCE: ReaderResource = {
  id: "sql-quick-revision-notes",
  title: "SQL — Quick Revision Notes",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "6 min",
  pages: 10,
  ...
  heroSubtitle: "Fast recap of SQL syntax, joins, and window functions for exam or interview day.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Quick Revision Notes</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Quick Revision Notes</b> — is designed to be self-contained: Fast recap of SQL syntax, joins, and window functions for exam or interview day.</p>
