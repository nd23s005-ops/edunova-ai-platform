...
const RESOURCE: ReaderResource = {
  id: "mern-stack-beginner-guide",
  title: "MERN Stack — Beginner Guide",
  ...
  heroSubtitle: 'A friendly first tour of the MERN Stack — MongoDB, Express, React, Node — and how the pieces fit into a full-stack app.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready MERN full-stack development.</li>
