...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Advanced DSA: advanced graph algorithms, suffix arrays, suffix trees, Fenwick trees, segment trees, sparse tables, DSU, advanced DP, network flow, string matching, randomized and approximation algorithms.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Advanced Concepts.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced DSA: advanced graph algorithms, suffix arrays, suffix trees, Fenwick trees, segment trees, sparse tables, DSU, advanced DP, network flow, string matching, randomized and approximation algorithms.</p>
