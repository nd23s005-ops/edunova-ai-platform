...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Practical Flutter tips that speed up widgets, DevTools, and store releases.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Tips & Tricks</b> — modern, production-ready Flutter development.</li>
