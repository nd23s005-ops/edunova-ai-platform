...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-sample-exercises",
  title: "Ethical Hacking — Sample Exercises",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "25 min",
  pages: 22,
  ...
  heroSubtitle: "300+ authorized, defensive sample exercises — threat modeling, secure code review, OWASP mapping, MITRE ATT&CK walk-throughs, and IR tabletops.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>300+ authorized, defensive sample exercises — threat modeling, secure code review, OWASP mapping, MITRE ATT&CK walk-throughs, and IR tabletops. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
