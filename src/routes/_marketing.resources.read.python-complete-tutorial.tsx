...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "End-to-end Python tutorial from installation to OOP, files, and standard library mastery.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Complete Tutorial</b> — is designed to be self-contained: End-to-end Python tutorial from installation to OOP, files, and standard library mastery.</p>
