...
const RESOURCE: ReaderResource = {
  id: "azure-cheat-sheet",
  title: "Microsoft Azure — Cheat Sheet",
  ...
  heroSubtitle: "Printable Azure cheat sheet — CLI, PowerShell, ARM/Bicep, and service map.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Printable Azure cheat sheet — CLI, PowerShell, ARM/Bicep, and service map. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
...
az group create -n rg-app -l eastus
az vm create -g rg-app -n vm1 --image UbuntuLTS --admin-username azureuser
az storage account create -g rg-app -n saapp001 --sku Standard_LRS
az webapp up -n my-web -g rg-app --runtime "NODE:20-lts"
az aks create -g rg-app -n aks1 --node-count 2 --enable-aad
az role assignment create --assignee <spn> --role Reader --scope /subscriptions/<id>
...
# Bicep
az deployment group create -g rg-app -f main.bicep`}</Code>
      </Section>
