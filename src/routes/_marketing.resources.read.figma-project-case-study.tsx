...
const RESOURCE: ReaderResource = {
  id: "figma-project-case-study",
  title: "Figma — Project Case Study",
  category: "Design",
  ...
  heroSubtitle: "A production-level Figma project case study covering research, architecture decisions, design systems, accessibility, prototyping workflows, testing, iteration, and final developer handoff.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Project Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>A production-level Figma project case study covering research, architecture decisions, design systems, accessibility, prototyping workflows, testing, iteration, and final developer handoff.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Project Case Study</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
