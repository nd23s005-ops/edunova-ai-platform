...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-frequently-asked-questions",
  title: "Tailwind CSS — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most frequently asked Tailwind CSS questions — from setup to advanced patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready Tailwind CSS.</li>
