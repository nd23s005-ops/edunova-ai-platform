...
const RESOURCE: ReaderResource = {
  id: "tableau-tips-tricks",
  title: "Tableau — Tips & Tricks",
  ...
  heroSubtitle: "Power-user Tableau tips and tricks — shortcuts, hidden features, LOD patterns, and dashboard polish that separate pros from beginners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Power-user Tableau tips and tricks — shortcuts, hidden features, LOD patterns, and dashboard polish that separate pros from beginners.</p>
