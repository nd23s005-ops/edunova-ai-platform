...
const RESOURCE: ReaderResource = {
  id: "angular-real-world-case-study",
  title: "Angular — Real-world Case Study",
  ...
  heroSubtitle: 'How real teams adopt Angular at scale — standalone migration, signals, and performance wins.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Real-world Case Study</b> — is self-contained: How real teams adopt Angular at scale — standalone migration, signals, and performance wins.</p>
