...
const RESOURCE: ReaderResource = {
  id: "mern-stack-glossary",
  title: "MERN Stack — Glossary",
  ...
  heroSubtitle: "Every MERN term you'll meet — hook, middleware, aggregation, JWT, RBAC, and more.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, production-ready MERN full-stack development.</li>
