...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-pdf-notes",
  title: "Penetration Testing — PDF Notes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "62 min",
  pages: 99,
  ...
  heroSubtitle: "Comprehensive chapter-wise educational notes covering pentest fundamentals, cybersecurity concepts, PTES, OWASP Testing Guide overview, reconnaissance concepts, vulnerability assessment, risk analysis, web/cloud security, reporting, compliance, ethics, and remediation strategies.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive chapter-wise educational notes covering pentest fundamentals, cybersecurity concepts, PTES, OWASP Testing Guide overview, reconnaissance concepts, vulnerability assessment, risk analysis, web/cloud security, reporting, compliance, ethics, and remediation strategies. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
