...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A-to-Z glossary of SQL and relational-database terminology used across this library.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Glossary</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Glossary</b> — is designed to be self-contained: A-to-Z glossary of SQL and relational-database terminology used across this library.</p>
