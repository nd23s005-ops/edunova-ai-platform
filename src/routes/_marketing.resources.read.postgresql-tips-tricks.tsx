...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Practical PostgreSQL tips — CTEs, JSONB, window functions, and shortcuts that save time.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Tips & Tricks</b> — is designed to be self-contained: Practical PostgreSQL tips — CTEs, JSONB, window functions, and shortcuts that save time.</p>
