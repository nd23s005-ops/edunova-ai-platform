...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Curated Pandas interview questions on indexing, groupby, joins, performance, and real datasets.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — practical, production-ready Pandas.</li>
