...
const RESOURCE: ReaderResource = {
  id: "typescript-practice-questions",
  title: "TypeScript — Practice Questions",
  ...
  heroSubtitle: 'Hands-on TypeScript practice questions covering language features and real scenarios.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Practice Questions</b> — is self-contained: Hands-on TypeScript practice questions covering language features and real scenarios.</p>
