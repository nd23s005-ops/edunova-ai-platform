...
const RESOURCE: ReaderResource = {
  id: "operating-systems-real-world-case-study",
  title: "Operating Systems — Real-world Case Study",
  category: "CS Core",
  ...
  heroSubtitle: "Real-world enterprise case study on Operating Systems: process scheduling, memory management, storage systems, Linux servers, virtualization, containers, cloud infrastructure, monitoring, debugging, and measurable business outcomes.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Real-world Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Real-world enterprise case study on Operating Systems: process scheduling, memory management, storage systems, Linux servers, virtualization, containers, cloud infrastructure, monitoring, debugging, and measurable business outcomes.</p>
