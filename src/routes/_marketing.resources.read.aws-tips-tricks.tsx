...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Productivity tips and tricks for working with AWS Console, CLI, CloudFormation, and CDK.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This tips & tricks focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
