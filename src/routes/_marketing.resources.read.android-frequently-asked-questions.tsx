...
const RESOURCE: ReaderResource = {
  id: "android-frequently-asked-questions",
  title: "Android Development — Frequently Asked Questions",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "12 min",
  pages: 15,
  ...
  heroSubtitle: 'Answers to the most-asked Android questions — Compose vs XML, MVVM, Jetpack, and Play Store.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Frequently Asked Questions</b> — is self-contained: Answers to the most-asked Android questions — Compose vs XML, MVVM, Jetpack, and Play Store.</p>
