...
const RESOURCE: ReaderResource = {
  id: "power-bi-interview-questions",
  ...
  heroSubtitle: "A curated bank of Power BI interview questions — conceptual, DAX, modeling, and scenario-based — covering measures, RLS, gateways, and performance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A curated bank of Power BI interview questions — conceptual, DAX, modeling, and scenario-based — covering measures, RLS, gateways, and performance.</p>
