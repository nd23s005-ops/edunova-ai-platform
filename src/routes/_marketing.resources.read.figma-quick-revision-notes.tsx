...
const RESOURCE: ReaderResource = {
  id: "figma-quick-revision-notes",
  title: "Figma — Quick Revision Notes",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 6,
  ...
  heroSubtitle: "Concise Figma revision notes optimized for interviews and rapid revision \u2014 workflow summaries, Auto Layout shortcuts, component references, prototyping tips, Dev Mode reminders, and UI design best practices.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Quick Revision Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Concise Figma revision notes optimized for interviews and rapid revision — workflow summaries, Auto Layout shortcuts, component references, prototyping tips, Dev Mode reminders, and UI design best practices.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Quick Revision Notes</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
