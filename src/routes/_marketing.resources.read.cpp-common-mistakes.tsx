...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Raw new/delete, dangling references, slicing, and other classic C++ pitfalls.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Common Mistakes</b> — practical, modern-C++ coverage.</li>
