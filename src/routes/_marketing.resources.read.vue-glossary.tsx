...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A concise glossary of Vue.js terms — from refs and reactivity to Pinia, Nuxt, and SSR.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, production-ready Vue.js.</li>
