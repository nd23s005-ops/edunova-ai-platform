...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Advanced Docker concepts — BuildKit, multi-platform images, rootless mode, Swarm, Scout, Content Trust, and enterprise scale.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced Docker concepts — BuildKit, multi-platform images, rootless mode, Swarm, Scout, Content Trust, and enterprise scale.</p>
