...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Curated SQL interview questions — joins, window functions, indexes, and design.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Interview Questions</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Interview Questions</b> — is designed to be self-contained: Curated SQL interview questions — joins, window functions, indexes, and design.</p>
