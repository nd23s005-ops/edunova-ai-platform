...
const RESOURCE: ReaderResource = {
  id: "power-bi-common-mistakes",
  title: "Power BI — Common Mistakes",
  ...
  heroSubtitle: "The most common Power BI mistakes and how to avoid them — bi-directional relationships, calculated columns overuse, and ungoverned publishing.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>The most common Power BI mistakes and how to avoid them — bi-directional relationships, calculated columns overuse, and ungoverned publishing.</p>
