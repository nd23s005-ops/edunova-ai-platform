...
const RESOURCE: ReaderResource = {
  id: "expressjs-frequently-asked-questions",
  title: "Express.js — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most-asked Express.js questions — versioning, middleware, deployment, and more.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Frequently Asked Questions</b> — is self-contained: Answers to the most-asked Express.js questions — versioning, middleware, deployment, and more.</p>
