...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "An end-to-end tutorial for NumPy \u2014 from ndarray basics to broadcasting, linear algebra, and production numerics.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Complete Tutorial</b> — is self-contained: An end-to-end tutorial for NumPy — from ndarray basics to broadcasting, linear algebra, and production numerics.</p>
