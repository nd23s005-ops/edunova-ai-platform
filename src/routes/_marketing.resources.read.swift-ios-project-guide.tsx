...
const RESOURCE: ReaderResource = {
  id: "swift-ios-project-guide",
  title: "Swift (iOS) — Project Guide",
  category: "Mobile",
  ...
  heroSubtitle: "Build real iOS projects — todos, feeds, cameras, and networked SwiftUI apps.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Project Guide</b> — is designed to be self-contained: Build real iOS projects — todos, feeds, cameras, and networked SwiftUI apps.</p>
