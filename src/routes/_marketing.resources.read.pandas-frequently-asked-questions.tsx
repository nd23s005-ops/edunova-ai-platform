...
const RESOURCE: ReaderResource = {
  id: "pandas-frequently-asked-questions",
  title: "Pandas — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most frequently asked Pandas questions — from indexing to performance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready Pandas.</li>
