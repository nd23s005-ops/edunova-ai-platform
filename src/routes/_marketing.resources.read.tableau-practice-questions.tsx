...
const RESOURCE: ReaderResource = {
  id: "tableau-practice-questions",
  title: "Tableau — Practice Questions",
  ...
  heroSubtitle: "Structured Tableau practice questions to test your understanding of visual analytics, calculations, filters, and dashboard patterns.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Structured Tableau practice questions to test your understanding of visual analytics, calculations, filters, and dashboard patterns.</p>
