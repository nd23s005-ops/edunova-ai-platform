...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Professional JS handbook \u2014 coding standards, modular architecture, async patterns, performance, testing, security.",
};
...
const TOC: TocItem[] = [
  ...
  { id: "s3", label: "3. Modularity" },
  { id: "s4", label: "4. Async Patterns" },
  { id: "s5", label: "5. Performance" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Best Practices.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>The habits and standards that separate maintainable, production-grade JavaScript from throwaway scripts.</p>
      ...
      <Section id="s1" title="1. Coding Standards">
        <p>ESLint, Prettier, naming conventions.</p>
        <Code lang="js">{`// Coding Standards — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from coding standards";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Project Organization">
        <p>Feature folders, colocation.</p>
        <Code lang="js">{`// Project Organization — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from project organization";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Modularity">
        <p>Single responsibility, dependency direction.</p>
        <Code lang="js">{`// Modularity — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from modularity";
};`}</Code>
      </Section>

      <Section id="s4" title="4. Async Patterns">
        <p>Cancellation, retry, backoff.</p>
        <Code lang="js">{`// Async Patterns — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from async patterns";
};`}</Code>
      </Section>

      <Section id="s5" title="5. Performance">
        <p>Debounce, memoize, virtualize.</p>
...
const example = () => {
  ...
  return "hello from performance";
      ...
      <Section id="s6" title="6. Testing">
        <p>Trustworthy tests, no flakes.</p>
...
const example = () => {
  ...
  return "hello from documentation";
      ...
      <Section id="s8" title="8. Security">
        <p>XSS, CSRF, dependency audits.</p>
        <Code lang="js">{`// Security — illustrative snippet
const example = () => {
  // apply concepts covered above
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Best Practices equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
