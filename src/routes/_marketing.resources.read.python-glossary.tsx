...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A-to-Z glossary of Python and CPython terminology used across the docs and this library.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Glossary</b> — is designed to be self-contained: A-to-Z glossary of Python and CPython terminology used across the docs and this library.</p>
