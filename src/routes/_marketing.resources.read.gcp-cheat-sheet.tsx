...
const RESOURCE: ReaderResource = {
  id: "gcp-cheat-sheet",
  title: "Google Cloud Platform — Cheat Sheet",
  ...
  heroSubtitle: "One-page cheat sheet for gcloud CLI, core services, and cloud-native shortcuts.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-cheat-sheet" }],
  }),
  component: Page,
});
