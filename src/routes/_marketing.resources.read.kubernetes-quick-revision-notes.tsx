...
const RESOURCE: ReaderResource = {
  id: "kubernetes-quick-revision-notes",
  title: "Kubernetes — Quick Revision Notes",
  ...
  heroSubtitle: "Speed-revision cheat notes for Kubernetes concepts — perfect right before an interview or exam.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-quick-revision-notes" }],
  }),
  component: Page,
});
