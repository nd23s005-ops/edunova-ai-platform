...
const RESOURCE: ReaderResource = {
  id: "nextjs-complete-tutorial",
  title: "Next.js — Complete Tutorial",
  ...
  heroSubtitle: 'End-to-end Next.js tutorial — routing, rendering, data, Server Actions, auth, and deployment.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Complete Tutorial</b> — is self-contained: End-to-end Next.js tutorial — routing, rendering, data, Server Actions, auth, and deployment.</p>
