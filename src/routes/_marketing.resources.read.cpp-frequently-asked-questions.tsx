...
const RESOURCE: ReaderResource = {
  id: "cpp-frequently-asked-questions",
  title: "C++ — Frequently Asked Questions",
  ...
  heroSubtitle: "Answers to the most common C++ questions from beginners and working developers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Frequently Asked Questions</b> — practical, modern-C++ coverage.</li>
