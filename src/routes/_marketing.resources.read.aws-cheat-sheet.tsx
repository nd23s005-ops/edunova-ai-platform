...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "One-page AWS cheat sheet — services, CLI commands, and architecture patterns at a glance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This cheat sheet focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
