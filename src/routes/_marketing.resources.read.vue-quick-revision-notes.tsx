...
const RESOURCE: ReaderResource = {
  id: "vue-quick-revision-notes",
  title: "Vue.js — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid-fire Vue.js revision — templates, directives, refs, computeds, and watchers in minutes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready Vue.js.</li>
