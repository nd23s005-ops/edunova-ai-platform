...
const RESOURCE: ReaderResource = {
  id: "swift-ios-sample-exercises",
  title: "Swift (iOS) — Sample Exercises",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "25 min",
  pages: 22,
  ...
  heroSubtitle: "Bite-size Swift and SwiftUI exercises with sample code, expected outputs, and hints.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Sample Exercises</b> — is designed to be self-contained: Bite-size Swift and SwiftUI exercises with sample code, expected outputs, and hints.</p>
