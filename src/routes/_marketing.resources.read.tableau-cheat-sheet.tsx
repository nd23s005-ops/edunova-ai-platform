...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A single-page Tableau cheat sheet — shortcuts, function categories, LOD syntax, chart selection, and dashboarding actions at your fingertips.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A single-page Tableau cheat sheet — shortcuts, function categories, LOD syntax, chart selection, and dashboarding actions at your fingertips.</p>
