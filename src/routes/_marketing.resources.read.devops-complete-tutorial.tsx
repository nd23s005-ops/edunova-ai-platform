...
const RESOURCE: ReaderResource = {
  id: "devops-complete-tutorial",
  title: "DevOps — Complete Tutorial",
  ...
  heroSubtitle: "End-to-end DevOps tutorial covering Git, CI/CD, Docker, Kubernetes, Terraform, Ansible, and observability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>End-to-end DevOps tutorial covering Git, CI/CD, Docker, Kubernetes, Terraform, Ansible, and observability. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
