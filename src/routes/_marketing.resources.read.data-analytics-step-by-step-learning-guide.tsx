...
const RESOURCE: ReaderResource = {
  id: "data-analytics-step-by-step-learning-guide",
  title: "Data Analytics — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive Data Analytics path — Excel, SQL, Python, statistics, visualization, and BI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, business-ready Data Analytics.</li>
