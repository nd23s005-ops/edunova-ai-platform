...
const RESOURCE: ReaderResource = {
  id: "aws-frequently-asked-questions",
  title: "AWS — Frequently Asked Questions",
  ...
  heroSubtitle: "Frequently asked questions about AWS — accounts, services, pricing, security, and certifications.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This frequently asked questions focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
