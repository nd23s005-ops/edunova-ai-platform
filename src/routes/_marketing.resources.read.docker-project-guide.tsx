...
const RESOURCE: ReaderResource = {
  id: "docker-project-guide",
  title: "Docker — Project Guide",
  ...
  heroSubtitle: "This project guide walks you through containerizing a real application — Dockerfile, Compose, CI/CD, and production deployment end-to-end.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>This project guide walks you through containerizing a real application — Dockerfile, Compose, CI/CD, and production deployment end-to-end.</p>
