...
const RESOURCE: ReaderResource = {
  id: "vue-frequently-asked-questions",
  title: "Vue.js — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most frequently asked Vue.js questions — from setup to advanced patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready Vue.js.</li>
