...
const RESOURCE: ReaderResource = {
  id: "numpy-project-guide",
  title: "NumPy — Project Guide",
  ...
  heroSubtitle: "A hands-on NumPy project brief \u2014 requirements, milestones, and a review checklist.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Project Guide</b> — is self-contained: A hands-on NumPy project brief — requirements, milestones, and a review checklist.</p>
