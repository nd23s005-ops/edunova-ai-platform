...
const RESOURCE: ReaderResource = {
  id: "docker-step-by-step-learning-guide",
  title: "Docker — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A step-by-step Docker learning guide that sequences skills one lesson at a time, from your first container to production-ready deployments.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A step-by-step Docker learning guide that sequences skills one lesson at a time, from your first container to production-ready deployments.</p>
