...
const RESOURCE: ReaderResource = {
  id: "power-bi-practice-questions",
  title: "Power BI — Practice Questions",
  ...
  heroSubtitle: "Structured Power BI practice questions to test your understanding of Power Query, DAX, modeling, and report design.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Structured Power BI practice questions to test your understanding of Power Query, DAX, modeling, and report design.</p>
