...
const RESOURCE: ReaderResource = {
  id: "android-step-by-step-learning-guide",
  title: "Android Development — Step-by-Step Learning Guide",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "23 min",
  pages: 31,
  ...
  heroSubtitle: 'A progressive Android path — Kotlin, XML + Compose, Jetpack, architecture, and shipping.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Step-by-Step Learning Guide</b> — is self-contained: A progressive Android path — Kotlin, XML + Compose, Jetpack, architecture, and shipping.</p>
