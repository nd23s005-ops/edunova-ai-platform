...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A complete Docker tutorial — from installing Docker Desktop to writing Dockerfiles, orchestrating with Compose, and shipping images through CI/CD.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete Docker tutorial — from installing Docker Desktop to writing Dockerfiles, orchestrating with Compose, and shipping images through CI/CD.</p>
