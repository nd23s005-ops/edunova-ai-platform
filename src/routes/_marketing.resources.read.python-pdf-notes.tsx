...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Deep, printable Python notes covering language, libraries, and real-world workflows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — PDF Notes</b> — is designed to be self-contained: Deep, printable Python notes covering language, libraries, and real-world workflows.</p>
