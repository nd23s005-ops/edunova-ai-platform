...
const RESOURCE: ReaderResource = {
  id: "data-analytics-quick-revision-notes",
  title: "Data Analytics — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid Data Analytics revision — SQL, Pandas, statistics, KPIs, and BI at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, business-ready Data Analytics.</li>
