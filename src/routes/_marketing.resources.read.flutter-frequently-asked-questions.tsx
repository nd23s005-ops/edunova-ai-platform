...
const RESOURCE: ReaderResource = {
  id: "flutter-frequently-asked-questions",
  title: "Flutter — Frequently Asked Questions",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 15,
  ...
  heroSubtitle: 'Answers to the most-asked Flutter questions — Riverpod vs Bloc, Firebase, navigation, and deployment.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — modern, production-ready Flutter development.</li>
