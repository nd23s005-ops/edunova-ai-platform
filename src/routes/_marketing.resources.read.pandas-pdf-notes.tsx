...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Comprehensive Pandas notes covering Series, DataFrames, cleaning, groupby, joins, and time series.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready Pandas.</li>
