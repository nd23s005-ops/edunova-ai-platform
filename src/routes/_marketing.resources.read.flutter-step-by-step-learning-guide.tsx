...
const RESOURCE: ReaderResource = {
  id: "flutter-step-by-step-learning-guide",
  title: "Flutter — Step-by-Step Learning Guide",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "18 min",
  pages: 41,
  ...
  heroSubtitle: 'A progressive Flutter path — Dart, widgets, layouts, state, navigation, networking, and shipping.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — modern, production-ready Flutter development.</li>
