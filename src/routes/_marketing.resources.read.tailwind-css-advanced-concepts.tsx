...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-advanced-concepts",
  title: "Tailwind CSS — Advanced Concepts",
  ...
  heroSubtitle: 'Plugins, presets, CSS-first configuration, custom variants, and advanced Tailwind CSS patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready Tailwind CSS.</li>
