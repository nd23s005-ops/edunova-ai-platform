...
const RESOURCE: ReaderResource = {
  id: "operating-systems-pdf-notes",
  title: "Operating Systems — PDF Notes",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "63 min",
  pages: 106,
  ...
  heroSubtitle: "Comprehensive chapter-wise Operating Systems notes: architecture, processes, threads, CPU scheduling, synchronization, semaphores, deadlocks, memory management, virtual memory, paging, segmentation, filesystems, storage, Linux, virtualization, containers, security.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — PDF Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive chapter-wise Operating Systems notes: architecture, processes, threads, CPU scheduling, synchronization, semaphores, deadlocks, memory management, virtual memory, paging, segmentation, filesystems, storage, Linux, virtualization, containers, security.</p>
