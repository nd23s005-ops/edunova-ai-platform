...
const RESOURCE: ReaderResource = {
  id: "html5-sample-exercises",
  title: "HTML5 — Sample Exercises",
  ...
  heroSubtitle: "HTML5 workbook \u2014 semantic, ARIA, forms, media, SVG, Canvas, SEO, responsive, validation, mini projects.",
};
...
const TOC: TocItem[] = [
  ...
  { id: "s2", label: "2. Semantic Drills" },
  { id: "s3", label: "3. Form Drills" },
  { id: "s4", label: "4. Media Drills" },
  { id: "s5", label: "5. SVG Drills" },
  { id: "s6", label: "6. SEO Drills" },
  { id: "s7", label: "7. Projects" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Sample Exercises.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Curated exercises from single-tag drills to multi-page mini projects.</p>
      ...
      <Section id="s1" title="1. Warm-ups">
        <p>Element identification.</p>
        <Code lang="html">{`<!-- Warm-ups — illustrative snippet -->
<section aria-label="warm-ups">
  <h2>Warm-ups</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s2" title="2. Semantic Drills">
        <p>Convert div soup to semantic.</p>
        <Code lang="html">{`<!-- Semantic Drills — illustrative snippet -->
<section aria-label="semantic drills">
  <h2>Semantic Drills</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s3" title="3. Form Drills">
        <p>Build accessible forms.</p>
        <Code lang="html">{`<!-- Form Drills — illustrative snippet -->
<section aria-label="form drills">
  <h2>Form Drills</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s4" title="4. Media Drills">
        <p>Responsive picture element.</p>
        <Code lang="html">{`<!-- Media Drills — illustrative snippet -->
<section aria-label="media drills">
  <h2>Media Drills</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s5" title="5. SVG Drills">
        <p>Inline SVG icons.</p>
        <Code lang="html">{`<!-- SVG Drills — illustrative snippet -->
<section aria-label="svg drills">
  <h2>SVG Drills</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s6" title="6. SEO Drills">
        <p>Metadata for a blog.</p>
        <Code lang="html">{`<!-- SEO Drills — illustrative snippet -->
<section aria-label="seo drills">
  <h2>SEO Drills</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s7" title="7. Projects">
        <p>Landing page, portfolio.</p>
        <Code lang="html">{`<!-- Projects — illustrative snippet -->
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Sample Exercises equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
