...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "The best-practices playbook for Power BI — modeling, DAX, Power Query, performance, governance, and enterprise BI architecture.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>The best-practices playbook for Power BI — modeling, DAX, Power Query, performance, governance, and enterprise BI architecture.</p>
