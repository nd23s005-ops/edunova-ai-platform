...
const RESOURCE: ReaderResource = {
  id: "java-sample-exercises",
  title: "Java — Sample Exercises",
  ...
  heroSubtitle: "Bite-size Java exercises with sample inputs, outputs, and hints.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Sample Exercises</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Sample Exercises</b> — is designed to be self-contained: Bite-size Java exercises with sample inputs, outputs, and hints.</p>
