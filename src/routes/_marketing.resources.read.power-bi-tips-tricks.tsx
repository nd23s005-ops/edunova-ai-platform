...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Power-user Power BI tips and tricks — shortcuts, hidden features, DAX patterns, and report polish that separate pros from beginners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Power-user Power BI tips and tricks — shortcuts, hidden features, DAX patterns, and report polish that separate pros from beginners.</p>
