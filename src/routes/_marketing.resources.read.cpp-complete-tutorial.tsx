...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "End-to-end modern C++ tutorial from installation to classes, templates, STL, and small projects.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Complete Tutorial</b> — practical, modern-C++ coverage.</li>
