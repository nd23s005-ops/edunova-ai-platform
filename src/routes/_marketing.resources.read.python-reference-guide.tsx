...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Comprehensive Python reference — syntax, standard library, typing, packaging, and tooling.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Reference Guide</b> — is designed to be self-contained: Comprehensive Python reference — syntax, standard library, typing, packaging, and tooling.</p>
