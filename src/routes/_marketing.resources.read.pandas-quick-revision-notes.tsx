...
const RESOURCE: ReaderResource = {
  id: "pandas-quick-revision-notes",
  title: "Pandas — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid-fire Pandas revision — indexing, filtering, groupby, and joins in minutes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready Pandas.</li>
