...
const RESOURCE: ReaderResource = {
  id: "angular-common-mistakes",
  title: "Angular — Common Mistakes",
  ...
  heroSubtitle: 'The most common Angular mistakes and how to fix them — subscriptions, change detection, and DI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Common Mistakes</b> — is self-contained: The most common Angular mistakes and how to fix them — subscriptions, change detection, and DI.</p>
