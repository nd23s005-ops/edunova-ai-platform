...
const RESOURCE: ReaderResource = {
  id: "cpp-beginner-guide",
  title: "C++ — Beginner Guide",
  ...
  heroSubtitle: "A friendly first tour of modern C++ — syntax, objects, RAII, and your first working programs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Beginner Guide</b> — practical, modern-C++ coverage.</li>
