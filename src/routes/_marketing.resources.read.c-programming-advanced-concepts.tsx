...
const RESOURCE: ReaderResource = {
  id: "c-programming-advanced-concepts",
  title: "C Programming — Advanced Concepts",
  ...
  heroSubtitle: "Deep C — memory model, bit manipulation, endianness, system calls, and performance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-advanced-concepts" }],
  }),
  component: Page,
});
