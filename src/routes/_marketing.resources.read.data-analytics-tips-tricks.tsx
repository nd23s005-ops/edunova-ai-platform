...
const RESOURCE: ReaderResource = {
  id: "data-analytics-tips-tricks",
  title: "Data Analytics — Tips & Tricks",
  ...
  heroSubtitle: 'Practical Data Analytics tips that speed up cleaning, SQL, and dashboard building.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Tips & Tricks</b> — practical, business-ready Data Analytics.</li>
