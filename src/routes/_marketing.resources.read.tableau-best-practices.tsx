...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "The best practices playbook for Tableau — data modeling, dashboard design, performance, accessibility, and governance in enterprise environments.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>The best practices playbook for Tableau — data modeling, dashboard design, performance, accessibility, and governance in enterprise environments.</p>
