...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-pdf-notes",
  title: "Tailwind CSS — PDF Notes",
  ...
  heroSubtitle: 'Comprehensive Tailwind CSS notes covering utilities, theming, plugins, and the entire ecosystem.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready Tailwind CSS.</li>
