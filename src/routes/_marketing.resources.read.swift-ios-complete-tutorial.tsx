...
const RESOURCE: ReaderResource = {
  id: "swift-ios-complete-tutorial",
  title: "Swift (iOS) — Complete Tutorial",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "55 min",
  pages: 60,
  ...
  heroSubtitle: "End-to-end Swift + SwiftUI tutorial from language basics to a shippable iOS app.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Complete Tutorial</b> — is designed to be self-contained: End-to-end Swift + SwiftUI tutorial from language basics to a shippable iOS app.</p>
