...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Every Flutter term you'll meet — Widget, Element, RenderObject, InheritedWidget, Riverpod, Bloc, and more.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — modern, production-ready Flutter development.</li>
