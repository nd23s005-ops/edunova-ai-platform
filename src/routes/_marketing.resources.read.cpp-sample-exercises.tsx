...
const RESOURCE: ReaderResource = {
  id: "cpp-sample-exercises",
  title: "C++ — Sample Exercises",
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Sample Exercises</b> — practical, modern-C++ coverage.</li>
