...
const RESOURCE: ReaderResource = {
  id: "dsa-practice-questions",
  title: "Data Structures & Algorithms — Practice Questions",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "24 min",
  pages: 22,
  ...
  heroSubtitle: "Structured DSA practice workbook: 400+ exercises with MCQs, coding problems, debugging exercises, algorithm tracing, complexity analysis, competitive programming, and interview-level problems.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Practice Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Structured DSA practice workbook: 400+ exercises with MCQs, coding problems, debugging exercises, algorithm tracing, complexity analysis, competitive programming, and interview-level problems.</p>
