...
const RESOURCE: ReaderResource = {
  id: "flutter-beginner-guide",
  title: "Flutter — Beginner Guide",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "15 min",
  pages: 16,
  ...
  heroSubtitle: 'A friendly first tour of Flutter — Dart, widgets, hot reload, and your first cross-platform app.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — modern, production-ready Flutter development.</li>
