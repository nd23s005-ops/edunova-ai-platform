...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-complete-tutorial",
  ...
  heroSubtitle: 'End-to-end Tailwind CSS tutorial from setup and utilities to dark mode, plugins, and production builds.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, production-ready Tailwind CSS.</li>
