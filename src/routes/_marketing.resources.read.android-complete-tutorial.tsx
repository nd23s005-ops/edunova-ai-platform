...
const RESOURCE: ReaderResource = {
  id: "android-complete-tutorial",
  title: "Android Development — Complete Tutorial",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "46 min",
  pages: 82,
  ...
  heroSubtitle: 'An end-to-end Android walkthrough — Kotlin, Jetpack Compose, MVVM, Room, Retrofit, and Play Store.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Complete Tutorial</b> — is self-contained: An end-to-end Android walkthrough — Kotlin, Jetpack Compose, MVVM, Room, Retrofit, and Play Store.</p>
