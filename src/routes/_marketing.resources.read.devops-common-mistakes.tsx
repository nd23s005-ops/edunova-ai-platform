...
const RESOURCE: ReaderResource = {
  id: "devops-common-mistakes",
  title: "DevOps — Common Mistakes",
  ...
  heroSubtitle: "Pitfalls to avoid in DevOps — flaky pipelines, manual infra, missing observability, and weak security.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Pitfalls to avoid in DevOps — flaky pipelines, manual infra, missing observability, and weak security. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
