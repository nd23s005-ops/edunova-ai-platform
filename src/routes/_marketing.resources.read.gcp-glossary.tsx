...
const RESOURCE: ReaderResource = {
  id: "gcp-glossary",
  title: "Google Cloud Platform — Glossary",
  ...
  heroSubtitle: "A concise glossary of Google Cloud terminology and acronyms.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-glossary" }],
  }),
  component: Page,
});
