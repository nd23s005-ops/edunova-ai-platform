...
const RESOURCE: ReaderResource = {
  id: "azure-practice-questions",
  title: "Microsoft Azure — Practice Questions",
  ...
  heroSubtitle: "Practice sets covering Azure fundamentals, VMs, storage, networking, identity, and monitoring.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Practice sets covering Azure fundamentals, VMs, storage, networking, identity, and monitoring. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
...
az monitor app-insights component create -g rg-app -a ai-my-web --location eastus`}</Code>
      ...
      <Section id="questions" title="Practice Set">
        <ol className="list-decimal space-y-1 pl-5">
          <li>Deploy a Linux VM in a specific region and enable managed identity.</li>
          <li>Create a storage account with private endpoint for Blob.</li>
          <li>Provision an Azure SQL Database with private access only.</li>
          <li>Set up an App Service with slot-based blue/green deployments.</li>
          <li>Configure a VNet with three subnets and NSGs.</li>
          <li>Assign an RBAC Reader role at the resource group scope.</li>
          <li>Store a secret in Key Vault and consume via managed identity.</li>
          <li>Create an alert in Azure Monitor for VM CPU &gt; 80%.</li>
          <li>Deploy an AKS cluster with Azure CNI and RBAC.</li>
          <li>Write a Bicep file to deploy a storage account.</li>
        </ol>
      </Section>
