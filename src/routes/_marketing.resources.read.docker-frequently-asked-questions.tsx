...
const RESOURCE: ReaderResource = {
  id: "docker-frequently-asked-questions",
  title: "Docker — Frequently Asked Questions",
  ...
  heroSubtitle: "Answers to the most frequently asked Docker questions — licensing, Desktop vs Engine, Compose vs Swarm vs Kubernetes, and career paths.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Answers to the most frequently asked Docker questions — licensing, Desktop vs Engine, Compose vs Swarm vs Kubernetes, and career paths.</p>
