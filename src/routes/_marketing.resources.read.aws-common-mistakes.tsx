...
const RESOURCE: ReaderResource = {
  id: "aws-common-mistakes",
  title: "AWS — Common Mistakes",
  ...
  heroSubtitle: "Common AWS mistakes and how to avoid them — IAM, networking, cost, and reliability pitfalls.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This common mistakes focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
