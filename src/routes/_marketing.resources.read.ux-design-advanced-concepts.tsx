...
const RESOURCE: ReaderResource = {
  id: "ux-design-advanced-concepts",
  title: "UX Design — Advanced Concepts",
  category: "Design",
  difficulty: "Advanced",
  readingTime: "37 min",
  pages: 35,
  ...
  heroSubtitle: "Advanced UX Design handbook: advanced research methodologies, behavioral psychology, cognitive load, information architecture, interaction design, accessibility engineering, service design, experimentation, A/B testing, analytics-driven UX, AI-assisted UX, and enterprise workflows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Advanced Concepts.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced UX Design handbook: advanced research methodologies, behavioral psychology, cognitive load, information architecture, interaction design, accessibility engineering, service design, experimentation, A/B testing, analytics-driven UX, AI-assisted UX, and enterprise workflows.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Advanced Concepts</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
