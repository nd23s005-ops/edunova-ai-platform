...
const RESOURCE: ReaderResource = {
  id: "azure-tips-tricks",
  title: "Microsoft Azure — Tips & Tricks",
  ...
  heroSubtitle: "High-leverage Azure tips for Portal, CLI, Bicep, RBAC, and cost optimization.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>High-leverage Azure tips for Portal, CLI, Bicep, RBAC, and cost optimization. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
