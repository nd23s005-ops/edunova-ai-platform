...
const RESOURCE: ReaderResource = {
  id: "network-security-real-world-case-study",
  title: "Network Security — Real-world Case Study",
  category: "Security",
  ...
  heroSubtitle: "A real-world enterprise case study showing how modern Network Security improved resilience, prevented cyber threats, enhanced compliance, strengthened monitoring, and reduced security risks.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A real-world enterprise case study showing how modern Network Security improved resilience, prevented cyber threats, enhanced compliance, strengthened monitoring, and reduced security risks. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
