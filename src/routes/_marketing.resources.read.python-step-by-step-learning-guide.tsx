...
const RESOURCE: ReaderResource = {
  id: "python-step-by-step-learning-guide",
  title: "Python — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A structured, incremental path from zero to confident Python developer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Step-by-Step Learning Guide</b> — is designed to be self-contained: A structured, incremental path from zero to confident Python developer.</p>
