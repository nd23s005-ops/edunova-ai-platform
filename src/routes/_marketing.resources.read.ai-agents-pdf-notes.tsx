...
const RESOURCE: ReaderResource = {
  id: "ai-agents-pdf-notes",
  title: "AI Agents — PDF Notes",
  category: "AI & Data",
  difficulty: "Beginner",
  readingTime: "80 min",
  pages: 94,
  ...
  heroSubtitle: "Comprehensive study notes on agents — architectures, ReAct, planning, memory, RAG, MCP, and safety.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This pdf notes focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
