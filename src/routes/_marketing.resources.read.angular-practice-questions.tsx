...
const RESOURCE: ReaderResource = {
  id: "angular-practice-questions",
  title: "Angular — Practice Questions",
  ...
  heroSubtitle: 'Hands-on Angular practice questions covering components, forms, routing, and observables.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Practice Questions</b> — is self-contained: Hands-on Angular practice questions covering components, forms, routing, and observables.</p>
