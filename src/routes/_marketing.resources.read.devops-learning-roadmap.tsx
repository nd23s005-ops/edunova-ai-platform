...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A 6-month roadmap to become a job-ready DevOps engineer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A 6-month roadmap to become a job-ready DevOps engineer. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
...
deploy: kubectl set image deploy/app app=registry/app:$SHA`}</Code>
      ...
      <Section id="roadmap" title="6-Month Roadmap">
        <ol className="list-decimal space-y-1 pl-5">
          <li><b>Month 1</b> — Linux, Bash, networking, Git fundamentals.</li>
          <li><b>Month 2</b> — CI/CD with GitHub Actions or GitLab CI; testing basics.</li>
          <li><b>Month 3</b> — Docker, Docker Compose, container fundamentals.</li>
          <li><b>Month 4</b> — Kubernetes core objects, Helm, Ingress.</li>
          <li><b>Month 5</b> — Terraform and a cloud (AWS/Azure/GCP).</li>
          <li><b>Month 6</b> — Observability, SRE, DevSecOps, portfolio project.</li>
        </ol>
      </Section>
