...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "One-page Python cheat sheet — syntax, comprehensions, slicing, and standard-library one-liners.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Cheat Sheet</b> — is designed to be self-contained: One-page Python cheat sheet — syntax, comprehensions, slicing, and standard-library one-liners.</p>
