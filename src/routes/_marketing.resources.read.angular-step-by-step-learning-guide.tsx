...
const RESOURCE: ReaderResource = {
  id: "angular-step-by-step-learning-guide",
  title: "Angular — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive path through Angular — one concept at a time with runnable standalone examples.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Step-by-Step Learning Guide</b> — is self-contained: A progressive path through Angular — one concept at a time with runnable standalone examples.</p>
