...
const RESOURCE: ReaderResource = {
  id: "azure-project-case-study",
  title: "Microsoft Azure — Project Case Study",
  ...
  heroSubtitle: "Case study of an enterprise Azure landing zone deployment with governance and cost controls.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Case study of an enterprise Azure landing zone deployment with governance and cost controls. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
