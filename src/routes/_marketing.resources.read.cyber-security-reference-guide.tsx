...
const RESOURCE: ReaderResource = {
  id: "cyber-security-reference-guide",
  title: "Cyber Security — Reference Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "57 min",
  pages: 90,
  ...
  heroSubtitle: "A reference handbook: NIST CSF, ISO 27001, CIS Controls, OWASP, MITRE ATT&CK, CVSS, and hardening checklists.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A reference handbook: NIST CSF, ISO 27001, CIS Controls, OWASP, MITRE ATT&CK, CVSS, and hardening checklists. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
