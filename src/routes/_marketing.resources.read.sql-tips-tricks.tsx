...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Practical SQL tips — CTEs, window functions, and shortcuts that save time.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Tips & Tricks</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Tips & Tricks</b> — is designed to be self-contained: Practical SQL tips — CTEs, window functions, and shortcuts that save time.</p>
