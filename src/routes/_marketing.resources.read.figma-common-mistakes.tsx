...
const RESOURCE: ReaderResource = {
  id: "figma-common-mistakes",
  title: "Figma — Common Mistakes",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "14 min",
  pages: 10,
  ...
  heroSubtitle: "Troubleshooting handbook: common Figma mistakes involving Auto Layout, spacing, component duplication, organization, accessibility, prototypes, design system inconsistencies, and inefficient workflows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Common Mistakes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Troubleshooting handbook: common Figma mistakes involving Auto Layout, spacing, component duplication, organization, accessibility, prototypes, design system inconsistencies, and inefficient workflows.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Common Mistakes</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
