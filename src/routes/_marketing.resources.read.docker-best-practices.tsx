...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "The best-practices playbook for Docker — image design, security, performance, observability, and enterprise container workflows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>The best-practices playbook for Docker — image design, security, performance, observability, and enterprise container workflows.</p>
