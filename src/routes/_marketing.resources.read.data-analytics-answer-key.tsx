...
const RESOURCE: ReaderResource = {
  id: "data-analytics-answer-key",
  title: "Data Analytics — Answer Key",
  ...
  heroSubtitle: 'Worked answers and explanations for the Data Analytics practice set with queries and reasoning.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, business-ready Data Analytics.</li>
