...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A complete Docker reference — every CLI command, Dockerfile directive, Compose key, and platform feature documented for daily use.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete Docker reference — every CLI command, Dockerfile directive, Compose key, and platform feature documented for daily use.</p>
