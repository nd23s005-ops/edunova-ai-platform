...
const RESOURCE: ReaderResource = {
  id: "figma-practice-questions",
  title: "Figma — Practice Questions",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "28 min",
  pages: 39,
  ...
  heroSubtitle: "350+ Figma practice questions and exercises \u2014 UI design tasks, Auto Layout, component creation, responsive design, prototyping, accessibility reviews, collaborative workflows, case studies, and mini projects.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Practice Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>350+ Figma practice questions and exercises — UI design tasks, Auto Layout, component creation, responsive design, prototyping, accessibility reviews, collaborative workflows, case studies, and mini projects.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Practice Questions</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
