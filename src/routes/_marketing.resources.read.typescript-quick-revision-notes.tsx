...
const RESOURCE: ReaderResource = {
  id: "typescript-quick-revision-notes",
  title: "TypeScript — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid-fire TypeScript revision — types, generics, utility types, and narrowing in minutes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Quick Revision Notes</b> — is self-contained: Rapid-fire TypeScript revision — types, generics, utility types, and narrowing in minutes.</p>
