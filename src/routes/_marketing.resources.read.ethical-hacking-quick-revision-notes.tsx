...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-quick-revision-notes",
  title: "Ethical Hacking — Quick Revision Notes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "7 min",
  pages: 7,
  ...
  heroSubtitle: "Concise revision notes summarizing ethical hacking principles, PTES phases, OWASP Top 10, MITRE, CVSS, and defensive best practices.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Concise revision notes summarizing ethical hacking principles, PTES phases, OWASP Top 10, MITRE, CVSS, and defensive best practices. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
