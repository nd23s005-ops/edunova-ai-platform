...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "UX Design best practices: user-centered design, research planning, accessibility (WCAG), journey mapping, information architecture, wireframing, prototyping, usability testing, stakeholder communication, and documentation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Best Practices.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>UX Design best practices: user-centered design, research planning, accessibility (WCAG), journey mapping, information architecture, wireframing, prototyping, usability testing, stakeholder communication, and documentation.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Best Practices</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
