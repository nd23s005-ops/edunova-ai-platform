...
const RESOURCE: ReaderResource = {
  id: "ux-design-learning-roadmap",
  title: "UX Design — Learning Roadmap",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "6 min",
  pages: 10,
  ...
  heroSubtitle: "Structured UX Design learning roadmap covering foundations, research methods, wireframing, prototyping, accessibility, usability testing, portfolio creation, internships, interview preparation, and career progression.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Learning Roadmap.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Structured UX Design learning roadmap covering foundations, research methods, wireframing, prototyping, accessibility, usability testing, portfolio creation, internships, interview preparation, and career progression.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Learning Roadmap</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
