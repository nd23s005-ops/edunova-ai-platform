...
const RESOURCE: ReaderResource = {
  id: "tableau-interview-questions",
  ...
  heroSubtitle: "A curated bank of Tableau interview questions — conceptual, scenario-based, and hands-on — covering calculations, LOD, performance, and dashboard design.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A curated bank of Tableau interview questions — conceptual, scenario-based, and hands-on — covering calculations, LOD, performance, and dashboard design.</p>
