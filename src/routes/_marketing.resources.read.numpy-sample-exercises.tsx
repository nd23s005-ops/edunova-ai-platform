...
const RESOURCE: ReaderResource = {
  id: "numpy-sample-exercises",
  title: "NumPy — Sample Exercises",
  ...
  heroSubtitle: "Warm-up and applied exercises for NumPy, grouped by concept for spaced practice.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Sample Exercises</b> — is self-contained: Warm-up and applied exercises for NumPy, grouped by concept for spaced practice.</p>
