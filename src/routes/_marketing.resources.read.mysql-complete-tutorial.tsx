...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "End-to-end MySQL tutorial from SELECT to joins, indexes, transactions, and tuning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Complete Tutorial</b> — is designed to be self-contained: End-to-end MySQL tutorial from SELECT to joins, indexes, transactions, and tuning.</p>
