...
const RESOURCE: ReaderResource = {
  id: "ai-agents-frequently-asked-questions",
  ...
  heroSubtitle: "Frequently asked questions about AI agents — frameworks, memory, tools, and MCP.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This frequently asked questions focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
