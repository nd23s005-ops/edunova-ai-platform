...
const RESOURCE: ReaderResource = {
  id: "azure-beginner-guide",
  title: "Microsoft Azure — Beginner Guide",
  ...
  heroSubtitle: "Beginner-friendly introduction to Microsoft Azure — global infrastructure, core services, and cloud fundamentals.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Beginner-friendly introduction to Microsoft Azure — global infrastructure, core services, and cloud fundamentals. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
