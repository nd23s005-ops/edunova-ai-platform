...
const RESOURCE: ReaderResource = {
  id: "css3-learning-roadmap",
  title: "CSS3 — Learning Roadmap",
  ...
  heroSubtitle: 'A staged roadmap for learning CSS3 — from basics to enterprise-grade design systems.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Learning Roadmap</b> — is self-contained: A staged roadmap for learning CSS3 — from basics to enterprise-grade design systems.</p>
