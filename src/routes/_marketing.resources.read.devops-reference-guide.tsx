...
const RESOURCE: ReaderResource = {
  id: "devops-reference-guide",
  title: "DevOps — Reference Guide",
  ...
  heroSubtitle: "Reference guide to DevOps commands, YAML manifests, Terraform blocks, and official documentation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Reference guide to DevOps commands, YAML manifests, Terraform blocks, and official documentation. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
...
deploy: kubectl set image deploy/app app=registry/app:$SHA`}</Code>
      ...
      <Section id="ref" title="Reference Snippets">
        <Code>{`# GitHub Actions minimal CI
name: ci
...
jobs:
  test:
    ...
    steps:
      ...
      - run: npm ci
      - run: npm test`}</Code>
        <Code>{`# Kubernetes Deployment (excerpt)
apiVersion: apps/v1
kind: Deployment
metadata:
  name: web
