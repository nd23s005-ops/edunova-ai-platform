...
const RESOURCE: ReaderResource = {
  id: "data-analytics-pdf-notes",
  title: "Data Analytics — PDF Notes",
  ...
  heroSubtitle: 'Deep printable Data Analytics notes — SQL, Excel, Python, statistics, BI, and reporting.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, business-ready Data Analytics.</li>
