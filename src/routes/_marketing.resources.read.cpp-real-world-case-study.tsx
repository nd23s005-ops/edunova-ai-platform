...
const RESOURCE: ReaderResource = {
  id: "cpp-real-world-case-study",
  title: "C++ — Real-world Case Study",
  ...
  heroSubtitle: "Real production C++ systems — engines, HFT, databases, and lessons learned.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Real-world Case Study</b> — practical, modern-C++ coverage.</li>
