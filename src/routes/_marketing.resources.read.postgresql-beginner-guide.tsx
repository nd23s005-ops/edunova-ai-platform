...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A friendly first tour of PostgreSQL — install, psql, tables, and your first real queries.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Beginner Guide</b> — is designed to be self-contained: A friendly first tour of PostgreSQL — install, psql, tables, and your first real queries.</p>
