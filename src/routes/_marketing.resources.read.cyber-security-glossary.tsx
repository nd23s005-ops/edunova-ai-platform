...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "An alphabetical cybersecurity glossary — CIA, IAM, PKI, TLS, SIEM, EDR, Zero Trust, MITRE, NIST, and compliance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>An alphabetical cybersecurity glossary — CIA, IAM, PKI, TLS, SIEM, EDR, Zero Trust, MITRE, NIST, and compliance. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
