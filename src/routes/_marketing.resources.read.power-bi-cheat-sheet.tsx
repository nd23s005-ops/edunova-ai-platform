...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A single-page Power BI cheat sheet — shortcuts, DAX function categories, M snippets, model rules, and dashboard patterns at your fingertips.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A single-page Power BI cheat sheet — shortcuts, DAX function categories, M snippets, model rules, and dashboard patterns at your fingertips.</p>
