...
const RESOURCE: ReaderResource = {
  id: "ux-design-frequently-asked-questions",
  title: "UX Design — Frequently Asked Questions",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 12,
  ...
  heroSubtitle: "Comprehensive UX Design FAQ from beginner to advanced \u2014 research, personas, journey mapping, information architecture, usability testing, accessibility, prototyping, UX writing, design systems, portfolios, and careers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Frequently Asked Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive UX Design FAQ from beginner to advanced — research, personas, journey mapping, information architecture, usability testing, accessibility, prototyping, UX writing, design systems, portfolios, and careers.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Frequently Asked Questions</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
