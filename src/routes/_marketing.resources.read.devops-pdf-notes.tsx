...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Comprehensive DevOps notes — culture, pipelines, containers, Kubernetes, IaC, cloud-native, DevSecOps, and SRE.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive DevOps notes — culture, pipelines, containers, Kubernetes, IaC, cloud-native, DevSecOps, and SRE. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
