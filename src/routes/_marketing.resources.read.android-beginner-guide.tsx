...
const RESOURCE: ReaderResource = {
  id: "android-beginner-guide",
  title: "Android Development — Beginner Guide",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 20,
  ...
  heroSubtitle: 'A friendly first tour of Android — SDK, Android Studio, Kotlin, and your first app.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Beginner Guide</b> — is self-contained: A friendly first tour of Android — SDK, Android Studio, Kotlin, and your first app.</p>
