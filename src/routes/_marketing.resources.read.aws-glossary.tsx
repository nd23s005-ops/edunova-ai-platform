...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A concise glossary of AWS and cloud terminology.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This glossary focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
