...
const RESOURCE: ReaderResource = {
  id: "kubernetes-answer-key",
  title: "Kubernetes — Answer Key",
  ...
  heroSubtitle: "Fully worked answers with explanations for the Kubernetes practice questions set.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-answer-key" }],
  }),
  component: Page,
});
