...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-common-mistakes",
  title: "Tailwind CSS — Common Mistakes",
  ...
  heroSubtitle: 'The most common Tailwind CSS mistakes and how to fix them with confidence.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready Tailwind CSS.</li>
