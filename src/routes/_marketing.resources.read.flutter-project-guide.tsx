...
const RESOURCE: ReaderResource = {
  id: "flutter-project-guide",
  title: "Flutter — Project Guide",
  category: "Mobile",
  ...
  heroSubtitle: 'Ship a production-grade Flutter app — Clean Architecture, Riverpod, Dio, Hive, Firebase, and CI/CD.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — modern, production-ready Flutter development.</li>
