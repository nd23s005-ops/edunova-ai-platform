...
const RESOURCE: ReaderResource = {
  id: "aws-quick-revision-notes",
  title: "AWS — Quick Revision Notes",
  ...
  heroSubtitle: "Condensed AWS revision notes for last-minute review and certification prep.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This quick revision notes focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
