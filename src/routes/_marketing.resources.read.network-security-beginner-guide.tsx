...
const RESOURCE: ReaderResource = {
  id: "network-security-beginner-guide",
  title: "Network Security — Beginner Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "18 min",
  pages: 18,
  ...
  heroSubtitle: "A beginner-friendly guide introducing Network Security fundamentals — CIA Triad, defense in depth, OSI and TCP/IP models, firewalls, IDS/IPS, VPNs, wireless security, authentication, encryption, and risk management.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A beginner-friendly guide introducing Network Security fundamentals — CIA Triad, defense in depth, OSI and TCP/IP models, firewalls, IDS/IPS, VPNs, wireless security, authentication, encryption, and risk management. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
