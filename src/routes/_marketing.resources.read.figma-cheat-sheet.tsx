...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Printable Figma cheat sheet: keyboard shortcuts, Auto Layout settings, constraints, components, variants, variables, prototyping shortcuts, Smart Animate, Dev Mode features, plugins, and UI workflow references.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Cheat Sheet.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Printable Figma cheat sheet: keyboard shortcuts, Auto Layout settings, constraints, components, variants, variables, prototyping shortcuts, Smart Animate, Dev Mode features, plugins, and UI workflow references.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Cheat Sheet</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
