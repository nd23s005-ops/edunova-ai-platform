...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A comprehensive Tableau glossary — every term, feature, and concept explained in plain English with examples.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive Tableau glossary — every term, feature, and concept explained in plain English with examples.</p>
