...
const RESOURCE: ReaderResource = {
  id: "data-analytics-sample-exercises",
  title: "Data Analytics — Sample Exercises",
  ...
  heroSubtitle: 'Small, focused Data Analytics exercises to build Excel, SQL, and Pandas fluency.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, business-ready Data Analytics.</li>
