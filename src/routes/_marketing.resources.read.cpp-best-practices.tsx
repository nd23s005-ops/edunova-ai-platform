...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Idiomatic modern C++ — RAII, smart pointers, const-correctness, and the Core Guidelines.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Best Practices</b> — practical, modern-C++ coverage.</li>
