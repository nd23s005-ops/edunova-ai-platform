...
const RESOURCE: ReaderResource = {
  id: "figma-real-world-case-study",
  title: "Figma — Real-world Case Study",
  category: "Design",
  ...
  heroSubtitle: "Enterprise case study on scaling products with Figma \u2014 reusable design systems, collaboration between designers and developers, design consistency, and accelerated product delivery.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Real-world Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Enterprise case study on scaling products with Figma — reusable design systems, collaboration between designers and developers, design consistency, and accelerated product delivery.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Real-world Case Study</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
