...
const RESOURCE: ReaderResource = {
  id: "devops-sample-exercises",
  title: "DevOps — Sample Exercises",
  ...
  heroSubtitle: "Guided DevOps exercises — Dockerfiles, GitHub Actions, Terraform modules, Kubernetes manifests, monitoring.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Guided DevOps exercises — Dockerfiles, GitHub Actions, Terraform modules, Kubernetes manifests, monitoring. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
