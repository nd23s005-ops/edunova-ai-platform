...
const RESOURCE: ReaderResource = {
  id: "devops-quick-revision-notes",
  title: "DevOps — Quick Revision Notes",
  ...
  heroSubtitle: "Fast-recall DevOps notes for interviews and exams — pipelines, Docker, Kubernetes, IaC, observability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Fast-recall DevOps notes for interviews and exams — pipelines, Docker, Kubernetes, IaC, observability. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
