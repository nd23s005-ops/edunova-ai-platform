...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A structured AWS learning roadmap from fundamentals to associate and professional certifications.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This learning roadmap focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
