...
const RESOURCE: ReaderResource = {
  id: "c-programming-best-practices",
  title: "C Programming — Best Practices",
  ...
  heroSubtitle: "Idiomatic C — clean code, defensive programming, testing, and secure-coding habits.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-best-practices" }],
  }),
  component: Page,
});
