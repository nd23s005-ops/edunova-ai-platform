...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Advanced Node.js — clustering, worker threads, streams, microservices, and clean architecture.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nodejs-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nodejs-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready Node.js.</li>
