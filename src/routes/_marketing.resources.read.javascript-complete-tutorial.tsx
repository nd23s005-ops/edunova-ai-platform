...
const RESOURCE: ReaderResource = {
  id: "javascript-complete-tutorial",
  ...
  heroSubtitle: "End-to-end JavaScript \u2014 from syntax to closures, prototypes, classes, modules, async/await, testing, and deployment.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Language Foundations" },
  { id: "s2", label: "2. Functions Deep Dive" },
  { id: "s3", label: "3. Objects & Prototypes" },
  { id: "s4", label: "4. Async JS" },
  { id: "s5", label: "5. Modules" },
  { id: "s6", label: "6. DOM & Events" },
  { id: "s7", label: "7. Fetch & APIs" },
  { id: "s8", label: "8. Functional Programming" },
  { id: "s9", label: "9. ES2020+" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Complete Tutorial.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>This complete tutorial takes you from zero to production-ready JavaScript engineering.</p>
      ...
      <Section id="s1" title="1. Language Foundations">
        <p>Types, coercion, equality, scope, hoisting.</p>
        <Code lang="js">{`// Language Foundations — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from language foundations";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Functions Deep Dive">
        <p>First-class functions, closures, this, bind/call/apply.</p>
        <Code lang="js">{`// Functions Deep Dive — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from functions deep dive";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Objects & Prototypes">
        <p>Prototype chain, __proto__, Object.create, classes.</p>
        <Code lang="js">{`// Objects & Prototypes — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from objects & prototypes";
};`}</Code>
      </Section>

      <Section id="s4" title="4. Async JS">
        <p>Callbacks, Promises, async/await, error handling.</p>
        <Code lang="js">{`// Async JS — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from async js";
      ...
      <Section id="s5" title="5. Modules">
        <p>ES modules, dynamic import(), tree shaking.</p>
...
const example = () => {
  ...
  return "hello from modules";
      ...
      <Section id="s6" title="6. DOM & Events">
        <p>Selection, mutation, delegation, custom events.</p>
        <Code lang="js">{`// DOM & Events — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from dom & events";
};`}</Code>
      </Section>

      <Section id="s7" title="7. Fetch & APIs">
        <p>fetch(), AbortController, JSON, CORS.</p>
        <Code lang="js">{`// Fetch & APIs — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from fetch & apis";
};`}</Code>
      </Section>

      <Section id="s8" title="8. Functional Programming">
        <p>map/filter/reduce, immutability, composition.</p>
        <Code lang="js">{`// Functional Programming — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from functional programming";
};`}</Code>
      </Section>

      <Section id="s9" title="9. ES2020+">
        <p>Optional chaining, nullish coalescing, top-level await, WeakRef.</p>
...
const example = () => {
  ...
  return "hello from es2020+";
      ...
      <Section id="s10" title="10. Performance">
        <p>Debouncing, throttling, memoization, memory leaks.</p>
...
const example = () => {
  ...
  return "hello from performance";
      ...
      <Section id="s11" title="11. Testing">
        <p>Vitest/Jest — unit, integration, mocks.</p>
        <Code lang="js">{`// Testing — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from testing";
      ...
      <Section id="s12" title="12. Deployment">
        <p>Bundling with Vite/Webpack, CI/CD, minification.</p>
        <Code lang="js">{`// Deployment — illustrative snippet
const example = () => {
  // apply concepts covered above
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Complete Tutorial equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
