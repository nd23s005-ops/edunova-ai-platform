...
const RESOURCE: ReaderResource = {
  id: "pandas-real-world-case-study",
  title: "Pandas — Real-world Case Study",
  ...
  heroSubtitle: 'How real teams use Pandas at scale — sales analytics, finance, and marketing pipelines.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready Pandas.</li>
