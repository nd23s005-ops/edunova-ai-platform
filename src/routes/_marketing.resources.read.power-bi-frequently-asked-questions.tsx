...
const RESOURCE: ReaderResource = {
  id: "power-bi-frequently-asked-questions",
  title: "Power BI — Frequently Asked Questions",
  ...
  heroSubtitle: "Answers to the most frequently asked Power BI questions — licensing, gateways, DAX vs M, Fabric, and career paths.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Answers to the most frequently asked Power BI questions — licensing, gateways, DAX vs M, Fabric, and career paths.</p>
