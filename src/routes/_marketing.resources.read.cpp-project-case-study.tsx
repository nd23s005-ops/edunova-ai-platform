...
const RESOURCE: ReaderResource = {
  id: "cpp-project-case-study",
  title: "C++ — Project Case Study",
  ...
  heroSubtitle: "Full case study of a C++ project — problem, design, code, testing, and delivery.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Project Case Study</b> — practical, modern-C++ coverage.</li>
