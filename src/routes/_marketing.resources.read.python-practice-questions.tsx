...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Hands-on Python practice questions covering syntax, data structures, and small programs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Practice Questions</b> — is designed to be self-contained: Hands-on Python practice questions covering syntax, data structures, and small programs.</p>
