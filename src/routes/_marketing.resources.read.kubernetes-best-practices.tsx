...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Production Kubernetes best practices — reliability, security, autoscaling, GitOps, and cost.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-best-practices" }],
  }),
  component: Page,
});
