...
const RESOURCE: ReaderResource = {
  id: "pandas-beginner-guide",
  title: "Pandas — Beginner Guide",
  ...
  heroSubtitle: 'A friendly first tour of Pandas — Series, DataFrames, and your first real data analysis in Python.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready Pandas.</li>
