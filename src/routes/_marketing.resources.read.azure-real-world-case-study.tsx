...
const RESOURCE: ReaderResource = {
  id: "azure-real-world-case-study",
  title: "Microsoft Azure — Real-world Case Study",
  ...
  heroSubtitle: "Real-world Azure case study — from on-prem to cloud-native with AKS, Cosmos DB, and observability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Real-world Azure case study — from on-prem to cloud-native with AKS, Cosmos DB, and observability. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
