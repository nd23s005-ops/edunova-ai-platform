...
const RESOURCE: ReaderResource = {
  id: "postgresql-practice-questions",
  title: "PostgreSQL — Practice Questions",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "28 min",
  pages: 37,
  ...
  heroSubtitle: "Hands-on PostgreSQL practice questions covering queries, joins, CTEs, and JSONB.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Practice Questions</b> — is designed to be self-contained: Hands-on PostgreSQL practice questions covering queries, joins, CTEs, and JSONB.</p>
