...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Glossary of DevOps terms — CI/CD, IaC, container, pod, SLO, GitOps, observability, and more.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Glossary of DevOps terms — CI/CD, IaC, container, pod, SLO, GitOps, observability, and more. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
...
deploy: kubectl set image deploy/app app=registry/app:$SHA`}</Code>
      ...
      <Section id="terms" title="Glossary of Terms">
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li><b>CD</b> — Continuous Delivery/Deployment.</li>
          <li><b>IaC</b> — Infrastructure as Code.</li>
          <li><b>Container</b> — Isolated user-space runtime sharing the host kernel.</li>
          <li><b>Pod</b> — Smallest deployable unit in Kubernetes.</li>
          <li><b>Deployment</b> — Kubernetes controller managing ReplicaSets for rolling updates.</li>
          <li><b>Helm</b> — Kubernetes package manager (charts and templates).</li>
          <li><b>SLI / SLO / SLA</b> — Indicator / Objective / Agreement of reliability.</li>
          <li><b>GitOps</b> — Git as the single source of truth for infra and deploys.</li>
          <li><b>Observability</b> — Logs, metrics, and traces.</li>
          <li><b>Service Mesh</b> — Sidecar-based traffic control (Istio, Linkerd).</li>
          <li><b>DevSecOps</b> — Security integrated across the pipeline.</li>
          <li><b>SBOM</b> — Software Bill of Materials.</li>
          <li><b>Blue/Green</b> — Two identical environments swapped at release.</li>
          <li><b>Canary</b> — Gradual traffic shift to a new version.</li>
        </ul>
      </Section>
