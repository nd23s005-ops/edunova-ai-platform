...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-glossary",
  title: "Tailwind CSS — Glossary",
  ...
  heroSubtitle: 'A concise glossary of Tailwind CSS terms — from utilities and variants to tokens and JIT.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, production-ready Tailwind CSS.</li>
