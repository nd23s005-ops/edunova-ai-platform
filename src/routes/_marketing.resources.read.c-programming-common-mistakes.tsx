...
const RESOURCE: ReaderResource = {
  id: "c-programming-common-mistakes",
  title: "C Programming — Common Mistakes",
  ...
  heroSubtitle: "Uninitialized memory, off-by-one errors, buffer overflows, and other classic C pitfalls.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-common-mistakes" }],
  }),
  component: Page,
});
