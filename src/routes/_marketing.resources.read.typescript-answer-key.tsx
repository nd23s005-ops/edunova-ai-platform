...
const RESOURCE: ReaderResource = {
  id: "typescript-answer-key",
  title: "TypeScript — Answer Key",
  ...
  heroSubtitle: 'Complete worked solutions and explanations for the TypeScript practice question set.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Answer Key</b> — is self-contained: Complete worked solutions and explanations for the TypeScript practice question set.</p>
