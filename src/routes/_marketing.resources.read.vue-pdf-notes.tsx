...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Comprehensive Vue.js notes covering SFCs, reactivity, Composition API, Vue Router, and Pinia.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready Vue.js.</li>
