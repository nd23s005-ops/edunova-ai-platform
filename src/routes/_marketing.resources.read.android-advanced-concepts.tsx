...
const RESOURCE: ReaderResource = {
  id: "android-advanced-concepts",
  title: "Android Development — Advanced Concepts",
  category: "Mobile",
  difficulty: "Advanced",
  readingTime: "32 min",
  pages: 44,
  ...
  heroSubtitle: 'Advanced Android — multi-module Clean Architecture, baseline profiles, KMP, and on-device AI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Advanced Concepts</b> — is self-contained: Advanced Android — multi-module Clean Architecture, baseline profiles, KMP, and on-device AI.</p>
