...
const RESOURCE: ReaderResource = {
  id: "typescript-pdf-notes",
  title: "TypeScript — PDF Notes",
  ...
  heroSubtitle: 'Comprehensive TypeScript notes covering the entire language, tsconfig, and ecosystem.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — PDF Notes</b> — is self-contained: Comprehensive TypeScript notes covering the entire language, tsconfig, and ecosystem.</p>
