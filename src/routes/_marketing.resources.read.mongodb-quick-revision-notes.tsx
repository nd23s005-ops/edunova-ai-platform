...
const RESOURCE: ReaderResource = {
  id: "mongodb-quick-revision-notes",
  title: "MongoDB — Quick Revision Notes",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 5,
  ...
  heroSubtitle: 'Rapid MongoDB revision — CRUD, operators, aggregation stages, and indexes at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready MongoDB.</li>
