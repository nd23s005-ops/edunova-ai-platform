...
const RESOURCE: ReaderResource = {
  id: "html5-project-guide",
  title: "HTML5 — Project Guide",
  ...
  heroSubtitle: "Production-ready HTML5 \u2014 planning, semantic architecture, a11y, SEO, responsive, validation, testing, deployment.",
};
...
const TOC: TocItem[] = [
  ...
  { id: "s2", label: "2. Semantic Architecture" },
  { id: "s3", label: "3. Accessibility-First" },
  { id: "s4", label: "4. SEO" },
  { id: "s5", label: "5. Responsive" },
  { id: "s6", label: "6. Validation" },
  { id: "s7", label: "7. Testing" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Project Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>A playbook for shipping an HTML5 project with quality baked in.</p>
      ...
      <Section id="s1" title="1. Planning">
        <p>User stories, IA, wireframes.</p>
        <Code lang="html">{`<!-- Planning — illustrative snippet -->
<section aria-label="planning">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s2" title="2. Semantic Architecture">
        <p>Document outline & landmarks.</p>
        <Code lang="html">{`<!-- Semantic Architecture — illustrative snippet -->
<section aria-label="semantic architecture">
  <h2>Semantic Architecture</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s3" title="3. Accessibility-First">
        <p>WCAG checklist from day one.</p>
        <Code lang="html">{`<!-- Accessibility-First — illustrative snippet -->
<section aria-label="accessibility-first">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s4" title="4. SEO">
        <p>Metadata, sitemap, structured data.</p>
...
<section aria-label="seo">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s5" title="5. Responsive">
        <p>Mobile-first, srcset.</p>
        <Code lang="html">{`<!-- Responsive — illustrative snippet -->
<section aria-label="responsive">
  <h2>Responsive</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s6" title="6. Validation">
        <p>W3C validator, HTMLHint.</p>
...
<section aria-label="validation">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s7" title="7. Testing">
        <p>axe, Lighthouse, screen readers.</p>
        <Code lang="html">{`<!-- Testing — illustrative snippet -->
<section aria-label="testing">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s8" title="8. Deployment">
        <p>Static hosting, cache headers.</p>
        <Code lang="html">{`<!-- Deployment — illustrative snippet -->
<section aria-label="deployment">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s9" title="9. Maintenance">
        <p>Content audits, link checks.</p>
        <Code lang="html">{`<!-- Maintenance — illustrative snippet -->
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Project Guide equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
