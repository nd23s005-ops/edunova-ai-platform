...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-quick-revision-notes",
  title: "Tailwind CSS — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid-fire Tailwind CSS revision — spacing, layout, Flex, Grid, and responsive prefixes in minutes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready Tailwind CSS.</li>
