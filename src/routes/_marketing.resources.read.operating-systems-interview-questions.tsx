...
const RESOURCE: ReaderResource = {
  id: "operating-systems-interview-questions",
  ...
  heroSubtitle: "OS interview handbook with 350+ questions covering CPU scheduling, processes, threads, synchronization, deadlocks, memory management, virtual memory, paging, Linux internals, system calls, HR questions, and mock interviews.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Interview Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>OS interview handbook with 350+ questions covering CPU scheduling, processes, threads, synchronization, deadlocks, memory management, virtual memory, paging, Linux internals, system calls, HR questions, and mock interviews.</p>
