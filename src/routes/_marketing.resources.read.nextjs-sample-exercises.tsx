...
const RESOURCE: ReaderResource = {
  id: "nextjs-sample-exercises",
  title: "Next.js — Sample Exercises",
  ...
  heroSubtitle: 'Short, focused Next.js exercises for layouts, Server Components, data fetching, and mutations.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Sample Exercises</b> — is self-contained: Short, focused Next.js exercises for layouts, Server Components, data fetching, and mutations.</p>
