...
const RESOURCE: ReaderResource = {
  id: "docker-real-world-case-study",
  ...
  heroSubtitle: "Real-world Docker case studies — microservices, monolith-to-container migration, and platform teams shipping with containers.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Real-world Docker case studies — microservices, monolith-to-container migration, and platform teams shipping with containers.</p>
