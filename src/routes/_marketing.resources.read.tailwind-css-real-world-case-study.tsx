...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-real-world-case-study",
  title: "Tailwind CSS — Real-world Case Study",
  ...
  heroSubtitle: 'How real teams adopt Tailwind CSS at scale — design systems, tokens, and lessons learned.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready Tailwind CSS.</li>
