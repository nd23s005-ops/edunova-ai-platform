...
const RESOURCE: ReaderResource = {
  id: "python-sample-exercises",
  title: "Python — Sample Exercises",
  ...
  heroSubtitle: "Bite-size Python exercises with sample inputs, outputs, and hints.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Sample Exercises</b> — is designed to be self-contained: Bite-size Python exercises with sample inputs, outputs, and hints.</p>
