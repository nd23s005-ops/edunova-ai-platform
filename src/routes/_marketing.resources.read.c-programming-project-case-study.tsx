...
const RESOURCE: ReaderResource = {
  id: "c-programming-project-case-study",
  title: "C Programming — Project Case Study",
  ...
  heroSubtitle: "Full case study of a C project — problem, design, code, testing, and deployment.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-project-case-study" }],
  }),
  component: Page,
});
