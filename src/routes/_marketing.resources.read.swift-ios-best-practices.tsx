...
const RESOURCE: ReaderResource = {
  id: "swift-ios-best-practices",
  title: "Swift (iOS) — Best Practices",
  category: "Mobile",
  ...
  heroSubtitle: "Idiomatic Swift — value types, protocol-oriented design, safe concurrency, and clean SwiftUI.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Best Practices</b> — is designed to be self-contained: Idiomatic Swift — value types, protocol-oriented design, safe concurrency, and clean SwiftUI.</p>
