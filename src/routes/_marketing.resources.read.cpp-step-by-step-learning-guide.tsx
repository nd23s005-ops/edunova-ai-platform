...
const RESOURCE: ReaderResource = {
  id: "cpp-step-by-step-learning-guide",
  title: "C++ — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A structured, incremental path from zero to confident modern C++ developer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Step-by-Step Learning Guide</b> — practical, modern-C++ coverage.</li>
