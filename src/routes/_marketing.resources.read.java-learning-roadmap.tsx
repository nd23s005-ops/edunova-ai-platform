...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A month-by-month Java roadmap from beginner to production-ready backend engineer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Learning Roadmap</b> — is designed to be self-contained: A month-by-month Java roadmap from beginner to production-ready backend engineer.</p>
