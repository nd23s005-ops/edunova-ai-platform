...
const RESOURCE: ReaderResource = {
  id: "ux-design-pdf-notes",
  title: "UX Design — PDF Notes",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "53 min",
  pages: 141,
  ...
  heroSubtitle: "Comprehensive chapter-wise UX Design notes covering principles, research, interviews, surveys, personas, empathy maps, journey maps, information architecture, user flows, wireframing, prototyping, usability testing, accessibility, UX writing, analytics, and design systems.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — PDF Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive chapter-wise UX Design notes covering principles, research, interviews, surveys, personas, empathy maps, journey maps, information architecture, user flows, wireframing, prototyping, usability testing, accessibility, UX writing, analytics, and design systems.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>PDF Notes</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
