...
const RESOURCE: ReaderResource = {
  id: "dsa-glossary",
  title: "Data Structures & Algorithms — Glossary",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 11,
  ...
  heroSubtitle: "Alphabetical DSA glossary: algorithm concepts, complexity notation, graph theory, tree terminology, DP vocabulary, competitive programming terms, and practical definitions.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Glossary.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Alphabetical DSA glossary: algorithm concepts, complexity notation, graph theory, tree terminology, DP vocabulary, competitive programming terms, and practical definitions.</p>
