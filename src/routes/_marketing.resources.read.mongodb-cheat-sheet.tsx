...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page MongoDB reference — shell commands, query operators, aggregation stages, and index syntax.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready MongoDB.</li>
