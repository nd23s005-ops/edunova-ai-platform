...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "The essential NumPy syntax, patterns, and gotchas on a single, printable reference sheet.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Cheat Sheet</b> — is self-contained: The essential NumPy syntax, patterns, and gotchas on a single, printable reference sheet.</p>
