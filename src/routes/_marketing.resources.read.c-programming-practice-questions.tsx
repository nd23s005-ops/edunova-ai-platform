...
const RESOURCE: ReaderResource = {
  id: "c-programming-practice-questions",
  ...
  heroSubtitle: "Hands-on C practice questions covering syntax, arrays, pointers, and small programs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-practice-questions" }],
  }),
  component: Page,
});
