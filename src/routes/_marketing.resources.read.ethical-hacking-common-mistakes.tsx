...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-common-mistakes",
  title: "Ethical Hacking — Common Mistakes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 11,
  ...
  heroSubtitle: "Common mistakes in ethical hacking programs — unclear scope, missing authorization, weak reporting, and poor remediation follow-through.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Common mistakes in ethical hacking programs — unclear scope, missing authorization, weak reporting, and poor remediation follow-through. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
