...
const RESOURCE: ReaderResource = {
  id: "data-analytics-project-guide",
  title: "Data Analytics — Project Guide",
  ...
  heroSubtitle: 'Ship a portfolio-grade analytics project — problem framing, ETL, dashboard, and insights.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — practical, business-ready Data Analytics.</li>
