...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Every MongoDB term you'll meet — BSON, ObjectId, replica set, shard, oplog, aggregation, and more.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, production-ready MongoDB.</li>
