...
const RESOURCE: ReaderResource = {
  id: "ai-agents-project-guide",
  title: "AI Agents — Project Guide",
  category: "AI & Data",
  ...
  heroSubtitle: "Guided blueprint for building and deploying a production-grade agent system.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ai-agents-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ai-agents-project-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>AI agents are LLM-powered systems that <b>observe, reason, plan, and act</b> — using tools and memory to accomplish goals autonomously across multiple steps. This project guide focuses on the architectures, patterns, and frameworks used to build reliable, production-grade agentic systems.</p>
