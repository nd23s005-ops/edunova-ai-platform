...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page Vue.js cheat sheet — directives, Composition API, Pinia, and Vue Router at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready Vue.js.</li>
