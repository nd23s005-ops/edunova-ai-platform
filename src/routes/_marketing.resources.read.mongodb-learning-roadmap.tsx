...
const RESOURCE: ReaderResource = {
  id: "mongodb-learning-roadmap",
  title: "MongoDB — Learning Roadmap",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "8 min",
  pages: 12,
  ...
  heroSubtitle: 'A month-by-month MongoDB roadmap from beginner CRUD to enterprise NoSQL architect.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready MongoDB.</li>
