...
const RESOURCE: ReaderResource = {
  id: "vue-project-guide",
  title: "Vue.js — Project Guide",
  ...
  heroSubtitle: 'Build a production-ready Vue.js project — auth, routing, Pinia, HTTP, and deployment.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — practical, production-ready Vue.js.</li>
