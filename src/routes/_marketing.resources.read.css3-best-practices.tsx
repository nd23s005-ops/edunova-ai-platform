...
const RESOURCE: ReaderResource = {
  id: "css3-best-practices",
  title: "CSS3 — Best Practices",
  ...
  heroSubtitle: 'CSS3 best practices — architecture, accessibility, responsive design, and performance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Best Practices</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Best Practices</b> — is self-contained: CSS3 best practices — architecture, accessibility, responsive design, and performance.</p>
