...
const RESOURCE: ReaderResource = {
  id: "android-interview-questions",
  title: "Android Development — Interview Questions",
  category: "Mobile",
  ...
  heroSubtitle: 'Curated Android interview questions — Kotlin, Jetpack, Compose, MVVM, and system design.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Interview Questions</b> — is self-contained: Curated Android interview questions — Kotlin, Jetpack, Compose, MVVM, and system design.</p>
