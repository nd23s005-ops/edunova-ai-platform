...
const RESOURCE: ReaderResource = {
  id: "aws-real-world-case-study",
  title: "AWS — Real-world Case Study",
  ...
  heroSubtitle: "Real-world enterprise architecture on AWS — scale, resilience, security, and cost.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This real-world case study focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
