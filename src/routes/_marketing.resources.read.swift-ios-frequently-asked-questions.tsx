...
const RESOURCE: ReaderResource = {
  id: "swift-ios-frequently-asked-questions",
  title: "Swift (iOS) — Frequently Asked Questions",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 8,
  ...
  tags: ["Swift", "SwiftUI"],
  heroImage: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1800&q=80",
  heroSubtitle: "Answers to the most common Swift and iOS questions from beginners and working developers.",
};
...
const RELATED = [
  { title: "Swift (iOS) — Beginner Guide", tag: "SQL", time: "11 min" },
  { title: "Swift (iOS) — Cheat Sheet", tag: "SQL", time: "6 min" },
  { title: "Swift (iOS) — Interview Questions", tag: "SQL", time: "33 min" },
];

export const Route = createFileRoute("/_marketing/resources/read/swift-ios-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Frequently Asked Questions</b> — is designed to be self-contained: Answers to the most common Swift and iOS questions from beginners and working developers.</p>
...
ORDER  BY 1;`}</Code>
      ...
      <Section id="references" title="Further Reading & Official References">
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li><a className="text-primary hover:underline" href="https://dev.mysql.com/doc/workbench/en/" target="_blank" rel="noreferrer">MySQL Workbench</a> · <a className="text-primary hover:underline" href="https://dev.mysql.com/doc/swift-ios-shell/8.0/en/" target="_blank" rel="noreferrer">MySQL Shell</a></li>
