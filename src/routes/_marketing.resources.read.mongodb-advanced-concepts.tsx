...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Advanced MongoDB — aggregation internals, sharding, transactions, change streams, and clean architecture.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready MongoDB.</li>
