...
const RESOURCE: ReaderResource = {
  id: "postgresql-real-world-case-study",
  title: "PostgreSQL — Real-world Case Study",
  category: "Databases",
  ...
  heroSubtitle: "Real production PostgreSQL systems — analytics warehouses and OLTP databases at scale.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Real-world Case Study</b> — is designed to be self-contained: Real production PostgreSQL systems — analytics warehouses and OLTP databases at scale.</p>
