...
const RESOURCE: ReaderResource = {
  id: "kubernetes-learning-roadmap",
  ...
  heroSubtitle: "A month-by-month roadmap from Kubernetes beginner to CKA/CKAD/CKS ready.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-learning-roadmap" }],
  }),
  component: Page,
});
