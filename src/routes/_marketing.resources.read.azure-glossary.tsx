...
const RESOURCE: ReaderResource = {
  id: "azure-glossary",
  title: "Microsoft Azure — Glossary",
  ...
  heroSubtitle: "Glossary of Azure terms — resource group, region, AZ, RBAC, managed identity, and more.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Glossary of Azure terms — resource group, region, AZ, RBAC, managed identity, and more. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
...
az monitor app-insights component create -g rg-app -a ai-my-web --location eastus`}</Code>
      ...
      <Section id="terms" title="Glossary of Terms">
        <ul className="list-disc space-y-1 pl-5">
          <li><b>Region</b> — Geographic area containing one or more datacenters.</li>
          <li><b>Availability Zone</b> — Physically separate datacenter within a region.</li>
          <li><b>Resource Group</b> — Logical container for related Azure resources.</li>
          <li><b>ARM</b> — Azure Resource Manager, the deployment/control plane.</li>
          <li><b>Bicep</b> — Domain-specific language for authoring ARM templates.</li>
          <li><b>Entra ID</b> — Microsoft's identity platform (formerly Azure AD).</li>
          <li><b>RBAC</b> — Role-Based Access Control.</li>
          <li><b>Managed Identity</b> — Azure-managed service principal for workloads.</li>
          <li><b>VNet</b> — Virtual Network isolating Azure resources.</li>
          <li><b>NSG</b> — Network Security Group; stateful firewall rules.</li>
          <li><b>App Service</b> — Managed platform for web apps and APIs.</li>
          <li><b>AKS</b> — Azure Kubernetes Service.</li>
          <li><b>Key Vault</b> — Secrets, keys, and certificates service.</li>
          <li><b>Landing Zone</b> — Pre-provisioned, governed environment for workloads.</li>
          <li><b>WAF pillars</b> — Reliability, Security, Cost, Operations, Performance.</li>
        </ul>
      </Section>
