...
const RESOURCE: ReaderResource = {
  id: "cyber-security-beginner-guide",
  title: "Cyber Security — Beginner Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "13 min",
  pages: 24,
  ...
  heroSubtitle: "A beginner-friendly, defense-first introduction to Cyber Security — CIA Triad, defense in depth, threat landscape, and everyday protective habits.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A beginner-friendly, defense-first introduction to Cyber Security — CIA Triad, defense in depth, threat landscape, and everyday protective habits. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
