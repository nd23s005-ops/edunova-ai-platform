...
const RESOURCE: ReaderResource = {
  id: "c-programming-real-world-case-study",
  title: "C Programming — Real-world Case Study",
  ...
  heroSubtitle: "Real production C systems — kernels, databases, and embedded firmware lessons learned.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-real-world-case-study" }],
  }),
  component: Page,
});
