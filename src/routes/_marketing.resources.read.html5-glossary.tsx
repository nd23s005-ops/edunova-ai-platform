...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Alphabetical HTML5 glossary \u2014 elements, attributes, ARIA, SEO, multimedia, browser APIs, standards.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/html5-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Glossary.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Every HTML term defined in plain language with examples.</p>
      ...
      <Section id="s1" title="1. A — E">
        <p>Attribute, ARIA, Canvas, DOM, Element.</p>
        <Code lang="html">{`<!-- A — E — illustrative snippet -->
<section aria-label="a — e">
  <h2>A — E</h2>
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s2" title="2. F — J">
        <p>Form, Global attribute, Heading, iframe, JSON-LD.</p>
        <Code lang="html">{`<!-- F — J — illustrative snippet -->
<section aria-label="f — j">
  <h2>F — J</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>
      ...
      <Section id="s3" title="3. K — O">
        <p>Label, Landmark, Metadata, Noscript, OG.</p>
        <Code lang="html">{`<!-- K — O — illustrative snippet -->
<section aria-label="k — o">
  <h2>K — O</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>
      ...
      <Section id="s4" title="4. P — T">
        <p>Picture, Role, Semantic, SVG, Template.</p>
        <Code lang="html">{`<!-- P — T — illustrative snippet -->
<section aria-label="p — t">
  <h2>P — T</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>
      ...
      <Section id="s5" title="5. U — Z">
        <p>URL, Viewport, WCAG, XML, Zebra tables.</p>
        <Code lang="html">{`<!-- U — Z — illustrative snippet -->
<section aria-label="u — z">
  <h2>U — Z</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Glossary equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
