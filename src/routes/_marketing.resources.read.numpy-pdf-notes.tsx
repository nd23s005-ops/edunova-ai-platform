...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Complete chapter-wise notes for NumPy, formatted for revision and offline study.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>PDF Notes</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — PDF Notes</b> — is self-contained: Complete chapter-wise notes for NumPy, formatted for revision and offline study.</p>
