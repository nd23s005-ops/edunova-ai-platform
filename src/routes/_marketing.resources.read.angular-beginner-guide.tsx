...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A friendly first tour of Angular — standalone components, DI, signals, and shipping your first SPA.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Beginner Guide</b> — is self-contained: A friendly first tour of Angular — standalone components, DI, signals, and shipping your first SPA.</p>
