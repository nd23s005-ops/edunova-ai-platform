...
const RESOURCE: ReaderResource = {
  id: "sql-project-guide",
  title: "SQL — Project Guide",
  category: "Databases",
  ...
  heroSubtitle: "Build real SQL projects — analytics dashboards, reporting layers, and OLTP schemas.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Project Guide</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Project Guide</b> — is designed to be self-contained: Build real SQL projects — analytics dashboards, reporting layers, and OLTP schemas.</p>
