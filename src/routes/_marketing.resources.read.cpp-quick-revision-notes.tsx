...
const RESOURCE: ReaderResource = {
  id: "cpp-quick-revision-notes",
  title: "C++ — Quick Revision Notes",
  ...
  heroSubtitle: "Fast recap of C++ syntax, STL, and memory model for exam or interview day.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Quick Revision Notes</b> — practical, modern-C++ coverage.</li>
