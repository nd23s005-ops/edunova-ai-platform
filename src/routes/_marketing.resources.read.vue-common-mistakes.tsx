...
const RESOURCE: ReaderResource = {
  id: "vue-common-mistakes",
  title: "Vue.js — Common Mistakes",
  ...
  heroSubtitle: 'The most common Vue.js mistakes and how to fix them — reactivity loss, keys, and prop mutation.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready Vue.js.</li>
