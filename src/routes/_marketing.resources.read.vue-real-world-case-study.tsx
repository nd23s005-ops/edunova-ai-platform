...
const RESOURCE: ReaderResource = {
  id: "vue-real-world-case-study",
  title: "Vue.js — Real-world Case Study",
  ...
  heroSubtitle: 'How real teams adopt Vue.js at scale — Composition API migration, Pinia, and performance wins.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready Vue.js.</li>
