...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "The comprehensive Kubernetes reference — objects, APIs, commands, and production patterns.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-reference-guide" }],
  }),
  component: Page,
});
