...
const RESOURCE: ReaderResource = {
  id: "mern-stack-practice-questions",
  title: "MERN Stack — Practice Questions",
  ...
  heroSubtitle: 'Hands-on MERN practice problems — REST APIs, hooks, state, MongoDB queries, and auth flows.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready MERN full-stack development.</li>
