...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-quick-revision-notes",
  title: "Penetration Testing — Quick Revision Notes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "7 min",
  pages: 7,
  ...
  heroSubtitle: "Concise revision notes summarizing pentest methodology, PTES phases, OWASP Top 10, CVSS scoring, vulnerability management lifecycle, reporting process, compliance concepts, and cybersecurity terminology.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Concise revision notes summarizing pentest methodology, PTES phases, OWASP Top 10, CVSS scoring, vulnerability management lifecycle, reporting process, compliance concepts, and cybersecurity terminology. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
