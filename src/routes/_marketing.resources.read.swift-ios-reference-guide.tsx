...
const RESOURCE: ReaderResource = {
  id: "swift-ios-reference-guide",
  title: "Swift (iOS) — Reference Guide",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "43 min",
  pages: 66,
  ...
  heroSubtitle: "Comprehensive Swift + iOS reference — language, SwiftUI, UIKit, concurrency, and tooling.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-reference-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Reference Guide</b> — is designed to be self-contained: Comprehensive Swift + iOS reference — language, SwiftUI, UIKit, concurrency, and tooling.</p>
