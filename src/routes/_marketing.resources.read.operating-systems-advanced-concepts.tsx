...
const RESOURCE: ReaderResource = {
  id: "operating-systems-advanced-concepts",
  ...
  heroSubtitle: "Advanced OS handbook: kernel architecture, advanced scheduling, NUMA, memory allocators, page replacement algorithms, journaling filesystems, distributed OS, virtualization, hypervisors, containers, Linux kernel internals, and OS design.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Advanced Concepts.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced OS handbook: kernel architecture, advanced scheduling, NUMA, memory allocators, page replacement algorithms, journaling filesystems, distributed OS, virtualization, hypervisors, containers, Linux kernel internals, and OS design.</p>
