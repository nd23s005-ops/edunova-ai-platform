...
const RESOURCE: ReaderResource = {
  id: "ux-design-practice-questions",
  title: "UX Design — Practice Questions",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "34 min",
  pages: 40,
  ...
  heroSubtitle: "350+ UX Design practice questions and exercises \u2014 research tasks, persona creation, journey mapping, usability evaluations, accessibility reviews, wireframing, prototyping, case studies, and mini projects.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Practice Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>350+ UX Design practice questions and exercises — research tasks, persona creation, journey mapping, usability evaluations, accessibility reviews, wireframing, prototyping, case studies, and mini projects.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Practice Questions</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
