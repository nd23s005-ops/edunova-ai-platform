...
const RESOURCE: ReaderResource = {
  id: "sql-real-world-case-study",
  title: "SQL — Real-world Case Study",
  category: "Databases",
  ...
  heroSubtitle: "Real production SQL systems — analytics warehouses and OLTP databases at scale.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Real-world Case Study</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Real-world Case Study</b> — is designed to be self-contained: Real production SQL systems — analytics warehouses and OLTP databases at scale.</p>
