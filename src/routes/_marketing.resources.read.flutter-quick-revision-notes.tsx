...
const RESOURCE: ReaderResource = {
  id: "flutter-quick-revision-notes",
  title: "Flutter — Quick Revision Notes",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "6 min",
  pages: 8,
  ...
  heroSubtitle: 'Rapid Flutter revision — widgets, state management, navigation, and Firebase at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — modern, production-ready Flutter development.</li>
