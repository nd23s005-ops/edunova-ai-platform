...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Practical C tips — pointer patterns, macros, and shortcuts that save time.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-tips-tricks" }],
  }),
  component: Page,
});
