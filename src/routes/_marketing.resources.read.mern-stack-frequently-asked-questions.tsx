...
const RESOURCE: ReaderResource = {
  id: "mern-stack-frequently-asked-questions",
  title: "MERN Stack — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most-asked MERN questions — versioning, deployment, auth, databases, and more.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready MERN full-stack development.</li>
