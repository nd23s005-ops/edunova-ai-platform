...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Curated C++ interview questions — OOP, templates, STL, RAII, move semantics, concurrency.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cpp-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cpp-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Interview Questions</b> — practical, modern-C++ coverage.</li>
