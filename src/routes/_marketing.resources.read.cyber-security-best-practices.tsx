...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Cybersecurity best practices covering IAM, network, endpoint, cloud, IR, awareness, and governance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Cybersecurity best practices covering IAM, network, endpoint, cloud, IR, awareness, and governance. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
