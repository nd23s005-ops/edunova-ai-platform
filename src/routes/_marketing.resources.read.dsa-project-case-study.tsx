...
const RESOURCE: ReaderResource = {
  id: "dsa-project-case-study",
  title: "Data Structures & Algorithms — Project Case Study",
  category: "CS Core",
  ...
  heroSubtitle: "Production-level DSA project case study: architecture, algorithm selection, complexity trade-offs, optimization, testing, deployment, maintenance, and engineering decisions.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Project Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Production-level DSA project case study: architecture, algorithm selection, complexity trade-offs, optimization, testing, deployment, maintenance, and engineering decisions.</p>
