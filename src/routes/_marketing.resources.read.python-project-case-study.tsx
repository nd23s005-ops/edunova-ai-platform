...
const RESOURCE: ReaderResource = {
  id: "python-project-case-study",
  title: "Python — Project Case Study",
  ...
  heroSubtitle: "Full case study of a Python project — problem, design, code, testing, and deployment.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Project Case Study</b> — is designed to be self-contained: Full case study of a Python project — problem, design, code, testing, and deployment.</p>
