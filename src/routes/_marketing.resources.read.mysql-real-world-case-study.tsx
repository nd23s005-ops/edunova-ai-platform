...
const RESOURCE: ReaderResource = {
  id: "mysql-real-world-case-study",
  title: "MySQL — Real-world Case Study",
  category: "Databases",
  ...
  heroSubtitle: "Real production MySQL systems — analytics warehouses and OLTP databases at scale.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-real-world-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Real-world Case Study</b> — is designed to be self-contained: Real production MySQL systems — analytics warehouses and OLTP databases at scale.</p>
