...
const RESOURCE: ReaderResource = {
  id: "c-programming-project-guide",
  title: "C Programming — Project Guide",
  ...
  heroSubtitle: "Build real C projects — CLI tools, small servers, and embedded-flavor programs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-project-guide" }],
  }),
  component: Page,
});
