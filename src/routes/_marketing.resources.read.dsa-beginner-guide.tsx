...
const RESOURCE: ReaderResource = {
  id: "dsa-beginner-guide",
  title: "Data Structures & Algorithms — Beginner Guide",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "12 min",
  pages: 19,
  ...
  heroSubtitle: "Beginner-friendly DSA guide: algorithmic thinking, Big-O notation, arrays, strings, linked lists, stacks, queues, hash tables, trees, graphs, recursion, sorting, searching, and problem-solving strategies.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Beginner Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Beginner-friendly DSA guide: algorithmic thinking, Big-O notation, arrays, strings, linked lists, stacks, queues, hash tables, trees, graphs, recursion, sorting, searching, and problem-solving strategies.</p>
