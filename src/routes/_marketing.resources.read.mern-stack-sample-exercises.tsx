...
const RESOURCE: ReaderResource = {
  id: "mern-stack-sample-exercises",
  title: "MERN Stack — Sample Exercises",
  ...
  heroSubtitle: 'Small, focused MERN exercises to build routing, components, database, and API muscle memory.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — practical, production-ready MERN full-stack development.</li>
