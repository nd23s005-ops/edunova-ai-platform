...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-glossary",
  ...
  heroSubtitle: "A comprehensive alphabetical glossary covering pentest terminology, cybersecurity concepts, vulnerability management, OWASP, CVE, CWE, CVSS, PTES, NIST, compliance frameworks, and enterprise security vocabulary.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-glossary" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive alphabetical glossary covering pentest terminology, cybersecurity concepts, vulnerability management, OWASP, CVE, CWE, CVSS, PTES, NIST, compliance frameworks, and enterprise security vocabulary. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
