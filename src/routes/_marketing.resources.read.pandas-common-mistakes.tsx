...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'The most common Pandas mistakes and how to fix them — SettingWithCopy, dtypes, and slow loops.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready Pandas.</li>
