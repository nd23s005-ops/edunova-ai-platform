...
const RESOURCE: ReaderResource = {
  id: "tailwind-css-project-case-study",
  title: "Tailwind CSS — Project Case Study",
  ...
  heroSubtitle: 'Deep-dive case study of a production Tailwind CSS project — architecture, tokens, and trade-offs.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/tailwind-css-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tailwind-css-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready Tailwind CSS.</li>
