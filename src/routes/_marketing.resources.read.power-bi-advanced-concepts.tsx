...
const RESOURCE: ReaderResource = {
  id: "power-bi-advanced-concepts",
  title: "Power BI — Advanced Concepts",
  ...
  heroSubtitle: "Advanced Power BI concepts — composite models, aggregations, incremental refresh, XMLA endpoints, Fabric/OneLake, and enterprise-scale performance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced Power BI concepts — composite models, aggregations, incremental refresh, XMLA endpoints, Fabric/OneLake, and enterprise-scale performance.</p>
