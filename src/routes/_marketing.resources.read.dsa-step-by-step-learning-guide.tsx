...
const RESOURCE: ReaderResource = {
  id: "dsa-step-by-step-learning-guide",
  title: "Data Structures & Algorithms — Step-by-Step Learning Guide",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "24 min",
  pages: 39,
  ...
  heroSubtitle: "Structured week-by-week DSA learning guide: fundamentals, coding practice, problem-solving patterns, visualization, interview prep, revision plans, mock coding rounds, and portfolio building.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Step-by-Step Learning Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Structured week-by-week DSA learning guide: fundamentals, coding practice, problem-solving patterns, visualization, interview prep, revision plans, mock coding rounds, and portfolio building.</p>
