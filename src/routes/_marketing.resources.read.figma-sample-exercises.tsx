...
const RESOURCE: ReaderResource = {
  id: "figma-sample-exercises",
  title: "Figma — Sample Exercises",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "17 min",
  pages: 33,
  ...
  heroSubtitle: "300+ practical Figma exercises covering frames, Auto Layout, constraints, responsive layouts, components, variants, design systems, typography, grids, prototyping, Smart Animate, accessibility, Dev Mode, plugins, and collaboration.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Sample Exercises.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>300+ practical Figma exercises covering frames, Auto Layout, constraints, responsive layouts, components, variants, design systems, typography, grids, prototyping, Smart Animate, accessibility, Dev Mode, plugins, and collaboration.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Sample Exercises</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
