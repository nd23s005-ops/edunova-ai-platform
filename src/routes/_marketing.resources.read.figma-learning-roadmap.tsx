...
const RESOURCE: ReaderResource = {
  id: "figma-learning-roadmap",
  title: "Figma — Learning Roadmap",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 7,
  ...
  heroSubtitle: "Structured Figma learning roadmap covering fundamentals, UI design, Auto Layout, components, responsive design, design systems, prototyping, accessibility, portfolio development, freelance readiness, and UI/UX career progression.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Learning Roadmap.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Structured Figma learning roadmap covering fundamentals, UI design, Auto Layout, components, responsive design, design systems, prototyping, accessibility, portfolio development, freelance readiness, and UI/UX career progression.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Learning Roadmap</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
