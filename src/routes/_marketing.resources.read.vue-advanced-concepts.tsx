...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Reactivity internals, custom renderers, Suspense, Teleport, and advanced Vue.js patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready Vue.js.</li>
