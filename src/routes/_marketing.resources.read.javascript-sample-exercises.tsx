...
const RESOURCE: ReaderResource = {
  id: "javascript-sample-exercises",
  title: "JavaScript — Sample Exercises",
  ...
  heroSubtitle: "250+ hands-on exercises \u2014 variables, arrays, objects, closures, DOM, events, async, Fetch, ES6+, modules, debugging, mini projects.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Warm-ups" },
  { id: "s2", label: "2. Array Drills" },
  { id: "s3", label: "3. Object Drills" },
  { id: "s4", label: "4. Closure Puzzles" },
  { id: "s5", label: "5. Async Drills" },
  { id: "s6", label: "6. DOM Drills" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Sample Exercises.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>A carefully curated exercise book that progresses from single-line drills to multi-file mini projects.</p>
      ...
      <Section id="s1" title="1. Warm-ups">
        <p>Variables, operators, string manipulation.</p>
        <Code lang="js">{`// Warm-ups — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from warm-ups";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Array Drills">
        <p>Map/filter/reduce challenges.</p>
        <Code lang="js">{`// Array Drills — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from array drills";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Object Drills">
        <p>Destructuring, spread, deep clone.</p>
        <Code lang="js">{`// Object Drills — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from object drills";
};`}</Code>
      </Section>

      <Section id="s4" title="4. Closure Puzzles">
        <p>Counter, memoize, once.</p>
        <Code lang="js">{`// Closure Puzzles — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from closure puzzles";
};`}</Code>
      </Section>

      <Section id="s5" title="5. Async Drills">
        <p>fetch, retry, Promise.all races.</p>
        <Code lang="js">{`// Async Drills — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from async drills";
};`}</Code>
      </Section>

      <Section id="s6" title="6. DOM Drills">
        <p>Todo list, tab switcher.</p>
        <Code lang="js">{`// DOM Drills — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from dom drills";
};`}</Code>
      </Section>

      <Section id="s7" title="7. Mini Projects">
        <p>Calculator, quiz, weather widget.</p>
        <Code lang="js">{`// Mini Projects — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from mini projects";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Sample Exercises equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
