...
const RESOURCE: ReaderResource = {
  id: "javascript-practice-questions",
  ...
  heroSubtitle: "350+ structured JS exercises \u2014 MCQs, debugging, output prediction, async, DOM, functional programming, and mini projects.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. MCQs (100 Qs)" },
  { id: "s2", label: "2. Output Prediction (80 Qs)" },
  { id: "s3", label: "3. Debugging (60 Qs)" },
  { id: "s4", label: "4. Async (40 Qs)" },
  { id: "s5", label: "5. DOM (30 Qs)" },
  { id: "s6", label: "6. Functional (25 Qs)" },
  { id: "s7", label: "7. Mini Projects (15)" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Practice Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Practice systematically from fundamentals to advanced with progressive difficulty.</p>
      ...
      <Section id="s1" title="1. MCQs (100 Qs)">
        <p>Language basics, operators, types.</p>
        <Code lang="js">{`// MCQs (100 Qs) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from mcqs (100 qs)";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Output Prediction (80 Qs)">
        <p>Hoisting, closures, this.</p>
        <Code lang="js">{`// Output Prediction (80 Qs) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from output prediction (80 qs)";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Debugging (60 Qs)">
        <p>Fix broken snippets.</p>
        <Code lang="js">{`// Debugging (60 Qs) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from debugging (60 qs)";
};`}</Code>
      </Section>

      <Section id="s4" title="4. Async (40 Qs)">
        <p>Promise chains, async/await.</p>
        <Code lang="js">{`// Async (40 Qs) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from async (40 qs)";
};`}</Code>
      </Section>

      <Section id="s5" title="5. DOM (30 Qs)">
        <p>Selection & manipulation.</p>
        <Code lang="js">{`// DOM (30 Qs) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from dom (30 qs)";
};`}</Code>
      </Section>

      <Section id="s6" title="6. Functional (25 Qs)">
        <p>map/filter/reduce chains.</p>
        <Code lang="js">{`// Functional (25 Qs) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from functional (25 qs)";
};`}</Code>
      </Section>

      <Section id="s7" title="7. Mini Projects (15)">
        <p>Calculator, weather app, todo, quiz.</p>
        <Code lang="js">{`// Mini Projects (15) — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from mini projects (15)";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Practice Questions equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
