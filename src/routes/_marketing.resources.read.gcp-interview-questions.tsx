...
const RESOURCE: ReaderResource = {
  id: "gcp-interview-questions",
  title: "Google Cloud Platform — Interview Questions",
  ...
  heroSubtitle: "Curated Google Cloud interview questions for cloud, DevOps, and SRE roles.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-interview-questions" }],
  }),
  component: Page,
});
