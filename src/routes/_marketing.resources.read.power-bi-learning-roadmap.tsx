...
const RESOURCE: ReaderResource = {
  id: "power-bi-learning-roadmap",
  title: "Power BI — Learning Roadmap",
  ...
  heroSubtitle: "A structured learning roadmap that takes you from Power BI novice to PL-300 certified, dashboard-shipping BI developer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured learning roadmap that takes you from Power BI novice to PL-300 certified, dashboard-shipping BI developer.</p>
