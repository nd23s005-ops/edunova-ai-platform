...
const RESOURCE: ReaderResource = {
  id: "devops-advanced-concepts",
  title: "DevOps — Advanced Concepts",
  ...
  heroSubtitle: "Advanced DevOps — GitOps, progressive delivery, service mesh, platform engineering, SLOs, and policy-as-code.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/devops-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/devops-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Advanced DevOps — GitOps, progressive delivery, service mesh, platform engineering, SLOs, and policy-as-code. DevOps is a cultural and technical movement that unifies development and operations to deliver software safely, frequently, and reliably.</p>
