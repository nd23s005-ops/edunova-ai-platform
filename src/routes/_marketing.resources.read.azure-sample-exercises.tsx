...
const RESOURCE: ReaderResource = {
  id: "azure-sample-exercises",
  title: "Microsoft Azure — Sample Exercises",
  ...
  heroSubtitle: "Guided Azure exercises — deploy a VM, App Service, storage account, VNet, and AKS cluster.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Guided Azure exercises — deploy a VM, App Service, storage account, VNet, and AKS cluster. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
