...
const RESOURCE: ReaderResource = {
  id: "data-analytics-real-world-case-study",
  title: "Data Analytics — Real-world Case Study",
  ...
  heroSubtitle: 'How enterprises run Data Analytics in production — governance, BI, monitoring, and impact.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, business-ready Data Analytics.</li>
