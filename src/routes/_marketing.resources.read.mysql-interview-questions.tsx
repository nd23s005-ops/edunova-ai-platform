...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Curated MySQL interview questions — joins, indexes, InnoDB, replication, and tuning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Interview Questions</b> — is designed to be self-contained: Curated MySQL interview questions — joins, indexes, InnoDB, replication, and tuning.</p>
