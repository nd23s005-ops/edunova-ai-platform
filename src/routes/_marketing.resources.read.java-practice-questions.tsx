...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Hands-on Java practice questions covering syntax, OOP, and small programs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Practice Questions</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Practice Questions</b> — is designed to be self-contained: Hands-on Java practice questions covering syntax, OOP, and small programs.</p>
