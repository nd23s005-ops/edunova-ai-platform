...
const RESOURCE: ReaderResource = {
  id: "figma-reference-guide",
  title: "Figma — Reference Guide",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "58 min",
  pages: 45,
  ...
  heroSubtitle: "Comprehensive Figma reference handbook: keyboard shortcuts, Auto Layout, constraints, components, variants, variables, styles, design systems, responsive layouts, Smart Animate, Dev Mode, plugins, accessibility, and production UI workflows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Reference Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive Figma reference handbook: keyboard shortcuts, Auto Layout, constraints, components, variants, variables, styles, design systems, responsive layouts, Smart Animate, Dev Mode, plugins, accessibility, and production UI workflows.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Reference Guide</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
