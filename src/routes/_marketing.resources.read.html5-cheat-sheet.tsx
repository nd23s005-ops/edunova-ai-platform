...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Printable one-pager \u2014 document structure, semantic elements, forms, media, tables, accessibility, metadata, SEO, entities.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Structure" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Cheat Sheet.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Quickest possible HTML5 reference for the coder's desk.</p>
      ...
      <Section id="s1" title="1. Structure">
        <p>&lt;!DOCTYPE html&gt;, html/head/body.</p>
        <Code lang="html">{`<!-- Structure — illustrative snippet -->
...
<section aria-label="forms">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s4" title="4. Media">
        <p>img, picture, video, audio.</p>
        <Code lang="html">{`<!-- Media — illustrative snippet -->
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Cheat Sheet equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
