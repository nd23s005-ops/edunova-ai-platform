...
const RESOURCE: ReaderResource = {
  id: "numpy-real-world-case-study",
  title: "NumPy — Real-world Case Study",
  ...
  heroSubtitle: "How a real team applied NumPy to a business problem \u2014 problem, solution, and lessons learned.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Real-world Case Study</b> — is self-contained: How a real team applied NumPy to a business problem — problem, solution, and lessons learned.</p>
