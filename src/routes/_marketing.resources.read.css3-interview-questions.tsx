...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Curated CSS3 interview questions on specificity, layout, responsive design, and performance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Interview Questions</b> — is self-contained: Curated CSS3 interview questions on specificity, layout, responsive design, and performance.</p>
