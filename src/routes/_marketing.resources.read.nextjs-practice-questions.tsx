...
const RESOURCE: ReaderResource = {
  id: "nextjs-practice-questions",
  title: "Next.js — Practice Questions",
  ...
  heroSubtitle: 'Hands-on Next.js practice questions covering routing, rendering, and Server Actions.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Practice Questions</b> — is self-contained: Hands-on Next.js practice questions covering routing, rendering, and Server Actions.</p>
