...
const RESOURCE: ReaderResource = {
  id: "gcp-common-mistakes",
  title: "Google Cloud Platform — Common Mistakes",
  ...
  heroSubtitle: "Common Google Cloud mistakes teams make — and how to avoid them.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-common-mistakes" }],
  }),
  component: Page,
});
