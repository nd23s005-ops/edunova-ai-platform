...
const RESOURCE: ReaderResource = {
  id: "power-bi-sample-exercises",
  title: "Power BI — Sample Exercises",
  ...
  heroSubtitle: "Hands-on Power BI exercises — clean data with Power Query, build a star schema, write DAX, and design KPI dashboards.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-sample-exercises" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Hands-on Power BI exercises — clean data with Power Query, build a star schema, write DAX, and design KPI dashboards.</p>
