...
const RESOURCE: ReaderResource = {
  id: "swift-ios-learning-roadmap",
  title: "Swift (iOS) — Learning Roadmap",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 7,
  ...
  heroSubtitle: "A month-by-month iOS roadmap from beginner to production-ready SwiftUI engineer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Learning Roadmap</b> — is designed to be self-contained: A month-by-month iOS roadmap from beginner to production-ready SwiftUI engineer.</p>
