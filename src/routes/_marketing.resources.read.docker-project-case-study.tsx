...
const RESOURCE: ReaderResource = {
  id: "docker-project-case-study",
  title: "Docker — Project Case Study",
  ...
  heroSubtitle: "A detailed Docker project case study — architecture, images, orchestration, and pipeline choices for a real business scenario.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-project-case-study" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A detailed Docker project case study — architecture, images, orchestration, and pipeline choices for a real business scenario.</p>
