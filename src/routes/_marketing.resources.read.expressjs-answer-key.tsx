...
const RESOURCE: ReaderResource = {
  id: "expressjs-answer-key",
  title: "Express.js — Answer Key",
  ...
  heroSubtitle: 'Worked answers and explanations for the Express.js practice set — code, reasoning, and edge cases.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Answer Key</b> — is self-contained: Worked answers and explanations for the Express.js practice set — code, reasoning, and edge cases.</p>
