...
const RESOURCE: ReaderResource = {
  id: "android-project-guide",
  title: "Android Development — Project Guide",
  category: "Mobile",
  ...
  heroSubtitle: 'Ship a production-grade Android app — Clean Architecture, MVVM, Room, Retrofit, and CI/CD.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Project Guide</b> — is self-contained: Ship a production-grade Android app — Clean Architecture, MVVM, Room, Retrofit, and CI/CD.</p>
