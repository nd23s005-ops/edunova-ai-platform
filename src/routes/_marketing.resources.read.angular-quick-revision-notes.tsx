...
const RESOURCE: ReaderResource = {
  id: "angular-quick-revision-notes",
  title: "Angular — Quick Revision Notes",
  ...
  heroSubtitle: 'Rapid-fire Angular revision — templates, bindings, DI, RxJS, and signals in minutes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Quick Revision Notes</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Quick Revision Notes</b> — is self-contained: Rapid-fire Angular revision — templates, bindings, DI, RxJS, and signals in minutes.</p>
