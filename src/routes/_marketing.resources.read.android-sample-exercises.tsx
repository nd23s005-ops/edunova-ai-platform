...
const RESOURCE: ReaderResource = {
  id: "android-sample-exercises",
  title: "Android Development — Sample Exercises",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "25 min",
  pages: 30,
  ...
  heroSubtitle: 'Small, focused Android exercises to build Kotlin, Compose, and Jetpack muscle memory.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Sample Exercises</b> — is self-contained: Small, focused Android exercises to build Kotlin, Compose, and Jetpack muscle memory.</p>
