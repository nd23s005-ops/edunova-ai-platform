...
const RESOURCE: ReaderResource = {
  id: "c-programming-reference-guide",
  title: "C Programming — Reference Guide",
  ...
  heroSubtitle: "Comprehensive C reference — syntax, standard library, memory model, and tooling.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-reference-guide" }],
  }),
  component: Page,
});
