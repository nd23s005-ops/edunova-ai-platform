...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-best-practices",
  title: "Ethical Hacking — Best Practices",
  category: "Security",
  ...
  heroSubtitle: "Best practices for authorized security testing — scoping, ethics, PTES, OWASP mapping, responsible disclosure, and remediation planning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Best practices for authorized security testing — scoping, ethics, PTES, OWASP mapping, responsible disclosure, and remediation planning. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
