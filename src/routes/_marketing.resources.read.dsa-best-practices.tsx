...
const RESOURCE: ReaderResource = {
  ...
  title: "Data Structures & Algorithms — Best Practices",
  category: "CS Core",
  ...
  heroSubtitle: "DSA best practices: algorithm selection, complexity optimization, scalable patterns, memory optimization, clean code, benchmarking, testing, debugging, and interview-ready implementation.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Best Practices.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>DSA best practices: algorithm selection, complexity optimization, scalable patterns, memory optimization, clean code, benchmarking, testing, debugging, and interview-ready implementation.</p>
