...
const RESOURCE: ReaderResource = {
  id: "swift-ios-pdf-notes",
  title: "Swift (iOS) — PDF Notes",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "52 min",
  pages: 86,
  ...
  heroSubtitle: "Deep, printable Swift and iOS notes covering language, SwiftUI, concurrency, and deployment.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — PDF Notes</b> — is designed to be self-contained: Deep, printable Swift and iOS notes covering language, SwiftUI, concurrency, and deployment.</p>
