...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A friendly first tour of Python — syntax, data types, and your first working programs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Beginner Guide</b> — is designed to be self-contained: A friendly first tour of Python — syntax, data types, and your first working programs.</p>
