...
const RESOURCE: ReaderResource = {
  id: "javascript-project-case-study",
  title: "JavaScript — Project Case Study",
  ...
  heroSubtitle: "How a JS team designed, built, tested, deployed, and maintained a scalable web application \u2014 real numbers, real trade-offs.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Context" },
  { id: "s2", label: "2. Architecture" },
  { id: "s3", label: "3. Build Pipeline" },
  { id: "s4", label: "4. Performance" },
  { id: "s5", label: "5. Testing Strategy" },
  { id: "s6", label: "6. Deployment" },
  { id: "s7", label: "7. Incidents & Learnings" },
  { id: "s8", label: "8. Outcome" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Project Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Follow the full journey of a real-world JavaScript product from prototype to 100K DAU.</p>
      ...
      <Section id="s1" title="1. Context">
        <p>Product goals, constraints, team.</p>
        <Code lang="js">{`// Context — illustrative snippet
const example = () => {
  ...
  return "hello from context";
      ...
      <Section id="s2" title="2. Architecture">
        <p>Frontend, BFF, third-party integrations.</p>
...
const example = () => {
  ...
  return "hello from architecture";
      ...
      <Section id="s3" title="3. Build Pipeline">
        <p>Vite, code splitting, caching.</p>
        <Code lang="js">{`// Build Pipeline — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from build pipeline";
};`}</Code>
      </Section>
...
const example = () => {
  ...
  return "hello from performance";
      ...
      <Section id="s5" title="5. Testing Strategy">
        <p>Test pyramid, coverage targets.</p>
        <Code lang="js">{`// Testing Strategy — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from testing strategy";
};`}</Code>
      </Section>

      <Section id="s6" title="6. Deployment">
        <p>Blue-green rollout, feature flags.</p>
...
const example = () => {
  ...
  return "hello from deployment";
      ...
      <Section id="s7" title="7. Incidents & Learnings">
        <p>Two P1 outages and their fixes.</p>
        <Code lang="js">{`// Incidents & Learnings — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from incidents & learnings";
};`}</Code>
      </Section>

      <Section id="s8" title="8. Outcome">
        <p>3x conversion lift, 40% cost reduction.</p>
        <Code lang="js">{`// Outcome — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from outcome";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Project Case Study equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
