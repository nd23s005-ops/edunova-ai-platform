...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Idiomatic MyMySQL — clean queries, safe transactions, indexing, and maintainability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Best Practices</b> — is designed to be self-contained: Idiomatic MyMySQL — clean queries, safe transactions, indexing, and maintainability.</p>
