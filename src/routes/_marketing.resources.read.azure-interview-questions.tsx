...
const RESOURCE: ReaderResource = {
  id: "azure-interview-questions",
  title: "Microsoft Azure — Interview Questions",
  ...
  heroSubtitle: "300+ Azure interview questions across fundamentals, compute, networking, identity, and DevOps.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>300+ Azure interview questions across fundamentals, compute, networking, identity, and DevOps. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
...
az monitor app-insights component create -g rg-app -a ai-my-web --location eastus`}</Code>
      ...
      <Section id="questions" title="Interview Question Bank (Highlights)">
        <p>Selection of 300+ Azure interview questions across fundamentals, compute, storage, networking, identity, DevOps, and architecture.</p>
        <ol className="list-decimal space-y-1 pl-5">
          <li>What are Azure Regions and Availability Zones?</li>
          <li>Explain the role of a Resource Group.</li>
          <li>Compare Azure VM, App Service, Functions, and Container Apps.</li>
          <li>What is Azure Resource Manager (ARM)?</li>
          <li>ARM Templates vs Bicep vs Terraform on Azure.</li>
          <li>Explain Blob, File, Queue, and Table storage.</li>
          <li>Azure SQL Database vs Cosmos DB — when to choose which?</li>
          <li>VNet, subnets, NSGs, and route tables?</li>
          <li>Azure Load Balancer vs Application Gateway vs Front Door.</li>
          <li>What is Microsoft Entra ID (Azure AD)?</li>
          <li>Explain RBAC roles and scope hierarchy.</li>
          <li>What is a Managed Identity?</li>
          <li>Explain Key Vault and secret rotation.</li>
          <li>Azure Monitor, Log Analytics, and Application Insights.</li>
          <li>Availability Sets vs Availability Zones vs Zone-Redundant services.</li>
          <li>Explain Azure Policy and Blueprints.</li>
          <li>How does AKS integrate with Entra ID and networking?</li>
          <li>Describe hub-and-spoke network topology.</li>
          <li>Well-Architected Framework — five pillars.</li>
          <li>How does Azure Cost Management work?</li>
        </ol>
      </Section>
