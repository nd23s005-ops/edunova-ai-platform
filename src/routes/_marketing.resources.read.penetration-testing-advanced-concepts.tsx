...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-advanced-concepts",
  title: "Penetration Testing — Advanced Concepts",
  category: "Security",
  difficulty: "Advanced",
  readingTime: "29 min",
  pages: 36,
  ...
  heroSubtitle: "An advanced educational handbook: enterprise pentest methodologies, threat modeling, attack surface management, adversary emulation concepts, cloud/container security assessment, Active Directory security, API security methodology, security automation, purple team collaboration, AI-assisted security, reporting, and governance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>An advanced educational handbook: enterprise pentest methodologies, threat modeling, attack surface management, adversary emulation concepts, cloud/container security assessment, Active Directory security, API security methodology, security automation, purple team collaboration, AI-assisted security, reporting, and governance. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
