...
const RESOURCE: ReaderResource = {
  id: "aws-step-by-step-learning-guide",
  title: "AWS — Step-by-Step Learning Guide",
  ...
  heroSubtitle: "A guided path through AWS — from your first account to production-ready cloud-native architectures.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This step-by-step learning guide focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
