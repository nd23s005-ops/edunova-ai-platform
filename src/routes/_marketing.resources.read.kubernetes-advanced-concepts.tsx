...
const RESOURCE: ReaderResource = {
  id: "kubernetes-advanced-concepts",
  ...
  heroSubtitle: "Advanced Kubernetes — operators, CRDs, service mesh, multi-cluster, and enterprise scale.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-advanced-concepts" }],
  }),
  component: Page,
});
