...
const RESOURCE: ReaderResource = {
  id: "postgresql-learning-roadmap",
  ...
  heroSubtitle: "A month-by-month PostgreSQL roadmap from beginner to production-ready database engineer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — Learning Roadmap</b> — is designed to be self-contained: A month-by-month PostgreSQL roadmap from beginner to production-ready database engineer.</p>
