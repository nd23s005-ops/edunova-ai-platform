...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Printable DSA cheat sheet: Big-O, common algorithms, sorting methods, searching algorithms, graph and tree traversals, recursion templates, DP patterns, and interview quick references.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Cheat Sheet.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Printable DSA cheat sheet: Big-O, common algorithms, sorting methods, searching algorithms, graph and tree traversals, recursion templates, DP patterns, and interview quick references.</p>
