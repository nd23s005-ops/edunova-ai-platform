...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-answer-key",
  title: "Penetration Testing — Answer Key",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "27 min",
  pages: 36,
  ...
  heroSubtitle: "A complete Answer Key with detailed explanations, methodology discussions, defensive recommendations, reporting guidance, risk assessment analysis, evaluation rubrics, and educational references.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A complete Answer Key with detailed explanations, methodology discussions, defensive recommendations, reporting guidance, risk assessment analysis, evaluation rubrics, and educational references. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
