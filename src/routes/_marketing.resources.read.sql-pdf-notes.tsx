...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Deep, printable SQL notes covering querying, joins, indexing, and administration.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>PDF Notes</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — PDF Notes</b> — is designed to be self-contained: Deep, printable SQL notes covering querying, joins, indexing, and administration.</p>
