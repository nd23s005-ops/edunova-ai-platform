...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'An end-to-end MongoDB walkthrough — CRUD, aggregation, indexing, replication, sharding, and Atlas.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Complete Tutorial</b> — practical, production-ready MongoDB.</li>
