...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Battle-tested MERN practices — folder structure, async handling, security, and maintainability.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Best Practices</b> — practical, production-ready MERN full-stack development.</li>
