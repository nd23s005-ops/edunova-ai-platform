...
const RESOURCE: ReaderResource = {
  id: "numpy-tips-tricks",
  title: "NumPy — Tips & Tricks",
  ...
  heroSubtitle: "Practical productivity tips, idioms, and shortcuts for working faster with NumPy.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/numpy-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/numpy-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Tips & Tricks</b> — practical, production-ready NumPy for numerical computing.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>NumPy is the foundation of the Python scientific computing stack. Its <code>ndarray</code> — a strided, homogeneous, N-dimensional array — powers Pandas, SciPy, Scikit-learn, TensorFlow, PyTorch, and virtually every data-science tool in Python. This resource — <b>NumPy — Tips & Tricks</b> — is self-contained: Practical productivity tips, idioms, and shortcuts for working faster with NumPy.</p>
