...
const RESOURCE: ReaderResource = {
  id: "gcp-sample-exercises",
  title: "Google Cloud Platform — Sample Exercises",
  ...
  heroSubtitle: "Guided exercises to build muscle memory across Google Cloud services.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-sample-exercises" }],
  }),
  component: Page,
});
