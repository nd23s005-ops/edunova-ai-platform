...
const RESOURCE: ReaderResource = {
  id: "android-answer-key",
  title: "Android Development — Answer Key",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "35 min",
  pages: 32,
  ...
  heroSubtitle: 'Worked answers and explanations for the Android practice set — code, reasoning, and pitfalls.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/android-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/android-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — modern, production-ready Android development.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Android powers over 3 billion active devices — from phones and tablets to TVs, wearables, and cars. Modern Android is a <b>Kotlin-first</b> platform built around <b>Jetpack Compose</b>, Coroutines, and a curated set of Jetpack libraries that codify years of best practice. This resource — <b>Android Development — Answer Key</b> — is self-contained: Worked answers and explanations for the Android practice set — code, reasoning, and pitfalls.</p>
