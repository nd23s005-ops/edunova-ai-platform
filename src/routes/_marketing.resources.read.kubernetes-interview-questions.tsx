...
const RESOURCE: ReaderResource = {
  id: "kubernetes-interview-questions",
  ...
  heroSubtitle: "Curated Kubernetes interview questions across architecture, workloads, networking, storage, and security.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/kubernetes-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/kubernetes-interview-questions" }],
  }),
  component: Page,
});
