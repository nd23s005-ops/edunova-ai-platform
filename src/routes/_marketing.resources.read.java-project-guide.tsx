...
const RESOURCE: ReaderResource = {
  id: "java-project-guide",
  title: "Java — Project Guide",
  ...
  heroSubtitle: "Build real Java projects — CLI tools, REST APIs, and small Spring Boot apps.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Project Guide</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Project Guide</b> — is designed to be self-contained: Build real Java projects — CLI tools, REST APIs, and small Spring Boot apps.</p>
