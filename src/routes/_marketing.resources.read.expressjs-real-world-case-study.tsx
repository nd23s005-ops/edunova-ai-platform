...
const RESOURCE: ReaderResource = {
  id: "expressjs-real-world-case-study",
  title: "Express.js — Real-world Case Study",
  ...
  heroSubtitle: 'How teams use Express.js in production — scaling patterns, observability, and postmortems.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Real-world Case Study</b> — is self-contained: How teams use Express.js in production — scaling patterns, observability, and postmortems.</p>
