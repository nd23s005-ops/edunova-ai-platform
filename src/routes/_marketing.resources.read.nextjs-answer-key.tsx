...
const RESOURCE: ReaderResource = {
  id: "nextjs-answer-key",
  title: "Next.js — Answer Key",
  ...
  heroSubtitle: 'Complete worked solutions and explanations for the Next.js practice question set.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Answer Key</b> — is self-contained: Complete worked solutions and explanations for the Next.js practice question set.</p>
