...
const RESOURCE: ReaderResource = {
  id: "cyber-security-learning-roadmap",
  ...
  heroSubtitle: "A structured cybersecurity learning roadmap covering fundamentals, IAM, network, cloud, IR, certifications, and career progression.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/cyber-security-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/cyber-security-learning-roadmap" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured cybersecurity learning roadmap covering fundamentals, IAM, network, cloud, IR, certifications, and career progression. This resource is educational and defense-oriented — every practice below focuses on protecting people, systems, and data.</p>
