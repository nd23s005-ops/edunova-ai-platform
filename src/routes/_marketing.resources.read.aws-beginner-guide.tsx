...
const RESOURCE: ReaderResource = {
  id: "aws-beginner-guide",
  title: "AWS — Beginner Guide",
  ...
  heroSubtitle: "A beginner-friendly tour of AWS — global infrastructure, core services, and cloud fundamentals.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/aws-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/aws-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Amazon Web Services (AWS) is the world's most broadly adopted cloud, offering 200+ services across compute, storage, databases, networking, analytics, AI/ML, DevOps, and security. This beginner guide focuses on the concepts and services you need to design, build, and operate production cloud workloads.</p>
