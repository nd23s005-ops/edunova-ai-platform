...
const RESOURCE: ReaderResource = {
  id: "power-bi-pdf-notes",
  title: "Power BI — PDF Notes",
  ...
  heroSubtitle: "Comprehensive PDF-style notes consolidating Power BI end-to-end — Power Query, data modeling, DAX, visualization, governance, and Microsoft Fabric integration.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive PDF-style notes consolidating Power BI end-to-end — Power Query, data modeling, DAX, visualization, governance, and Microsoft Fabric integration.</p>
