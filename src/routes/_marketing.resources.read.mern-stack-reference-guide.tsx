...
const RESOURCE: ReaderResource = {
  id: "mern-stack-reference-guide",
  title: "MERN Stack — Reference Guide",
  ...
  heroSubtitle: 'The exhaustive MERN reference — MongoDB, Mongoose, Express, React, and Node API surface with recipes.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Reference Guide</b> — practical, production-ready MERN full-stack development.</li>
