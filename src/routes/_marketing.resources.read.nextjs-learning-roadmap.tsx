...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A staged roadmap for learning Next.js — from App Router to enterprise-grade full-stack apps.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/nextjs-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/nextjs-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready Next.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Next.js is the full-stack React framework built on the App Router, React Server Components, and a first-class edge / serverless runtime. It gives you routing, rendering strategies, data fetching, caching, and mutations in one integrated stack. This resource — <b>Next.js — Learning Roadmap</b> — is self-contained: A staged roadmap for learning Next.js — from App Router to enterprise-grade full-stack apps.</p>
