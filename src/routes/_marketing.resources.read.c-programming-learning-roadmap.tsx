...
const RESOURCE: ReaderResource = {
  id: "c-programming-learning-roadmap",
  title: "C Programming — Learning Roadmap",
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-learning-roadmap" }],
  }),
  component: Page,
});
