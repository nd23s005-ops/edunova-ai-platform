...
const RESOURCE: ReaderResource = {
  id: "gcp-advanced-concepts",
  title: "Google Cloud Platform — Advanced Concepts",
  ...
  heroSubtitle: "Advanced Google Cloud topics — multi-region, VPC-SC, Anthos, service mesh, and SRE.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-advanced-concepts" }],
  }),
  component: Page,
});
