...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Practical TypeScript tips and tricks — narrowing, inference, and productivity boosters.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Tips & Tricks</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Tips & Tricks</b> — is self-contained: Practical TypeScript tips and tricks — narrowing, inference, and productivity boosters.</p>
