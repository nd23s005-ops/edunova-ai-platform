...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Practical MongoDB tips that speed up querying, aggregation, and schema evolution.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Tips & Tricks</b> — practical, production-ready MongoDB.</li>
