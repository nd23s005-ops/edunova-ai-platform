...
const RESOURCE: ReaderResource = {
  id: "javascript-pdf-notes",
  title: "JavaScript — PDF Notes",
  ...
  heroSubtitle: "Chapter-wise printable notes \u2014 variables, closures, prototypes, DOM, async, ES2020+, performance, and best practices.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Ch 1 — Language Basics" },
  { id: "s2", label: "2. Ch 2 — Functions" },
  { id: "s3", label: "3. Ch 3 — Objects & Prototypes" },
  { id: "s4", label: "4. Ch 4 — Hoisting & Scope" },
  { id: "s5", label: "5. Ch 5 — DOM & Events" },
  { id: "s6", label: "6. Ch 6 — Async JavaScript" },
  { id: "s7", label: "7. Ch 7 — Fetch API" },
  { id: "s8", label: "8. Ch 8 — Modules" },
  { id: "s9", label: "9. Ch 9 — ES2020+" },
  { id: "s10", label: "10. Ch 10 — Performance & Testing" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-pdf-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — PDF Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Structured, downloadable-quality notes optimized for offline study and revision.</p>
      ...
      <Section id="s1" title="1. Ch 1 — Language Basics">
        <p>Types, operators, control flow.</p>
        <Code lang="js">{`// Ch 1 — Language Basics — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 1 — language basics";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Ch 2 — Functions">
        <p>Declarations, closures, IIFE.</p>
        <Code lang="js">{`// Ch 2 — Functions — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 2 — functions";
};`}</Code>
      </Section>

      <Section id="s3" title="3. Ch 3 — Objects & Prototypes">
        <p>Chain, hasOwnProperty, ES6 classes.</p>
        <Code lang="js">{`// Ch 3 — Objects & Prototypes — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 3 — objects & prototypes";
};`}</Code>
      </Section>

      <Section id="s4" title="4. Ch 4 — Hoisting & Scope">
        <p>var vs let, TDZ.</p>
        <Code lang="js">{`// Ch 4 — Hoisting & Scope — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 4 — hoisting & scope";
};`}</Code>
      </Section>

      <Section id="s5" title="5. Ch 5 — DOM & Events">
        <p>Selection, mutation, delegation.</p>
        <Code lang="js">{`// Ch 5 — DOM & Events — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 5 — dom & events";
};`}</Code>
      </Section>

      <Section id="s6" title="6. Ch 6 — Async JavaScript">
        <p>Promises, async/await, error handling.</p>
        <Code lang="js">{`// Ch 6 — Async JavaScript — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 6 — async javascript";
};`}</Code>
      </Section>

      <Section id="s7" title="7. Ch 7 — Fetch API">
        <p>GET, POST, AbortController.</p>
        <Code lang="js">{`// Ch 7 — Fetch API — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 7 — fetch api";
};`}</Code>
      </Section>

      <Section id="s8" title="8. Ch 8 — Modules">
        <p>ESM, dynamic import.</p>
        <Code lang="js">{`// Ch 8 — Modules — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 8 — modules";
};`}</Code>
      </Section>

      <Section id="s9" title="9. Ch 9 — ES2020+">
        <p>Optional chaining, nullish, top-level await.</p>
        <Code lang="js">{`// Ch 9 — ES2020+ — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 9 — es2020+";
};`}</Code>
      </Section>

      <Section id="s10" title="10. Ch 10 — Performance & Testing">
        <p>Debounce, throttle, Vitest.</p>
        <Code lang="js">{`// Ch 10 — Performance & Testing — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from ch 10 — performance & testing";
};`}</Code>
      </Section>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — PDF Notes equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
