...
const RESOURCE: ReaderResource = {
  id: "postgresql-pdf-notes",
  title: "PostgreSQL — PDF Notes",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "70 min",
  pages: 85,
  ...
  heroSubtitle: "Deep, printable PostgreSQL notes covering querying, JSONB, MVCC, replication, and tuning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/postgresql-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/postgresql-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>PostgreSQL — PDF Notes</b> — is designed to be self-contained: Deep, printable PostgreSQL notes covering querying, JSONB, MVCC, replication, and tuning.</p>
