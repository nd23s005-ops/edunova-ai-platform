...
const RESOURCE: ReaderResource = {
  id: "data-analytics-glossary",
  title: "Data Analytics — Glossary",
  ...
  heroSubtitle: "Every Data Analytics term you'll meet — KPI, ETL, OLAP, dimension, measure, drift, and more.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Glossary</b> — practical, business-ready Data Analytics.</li>
