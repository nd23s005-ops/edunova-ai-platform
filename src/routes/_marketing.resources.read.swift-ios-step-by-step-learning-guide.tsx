...
const RESOURCE: ReaderResource = {
  id: "swift-ios-step-by-step-learning-guide",
  title: "Swift (iOS) — Step-by-Step Learning Guide",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "28 min",
  pages: 29,
  ...
  heroSubtitle: "A structured, incremental path from zero to confident iOS developer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Step-by-Step Learning Guide</b> — is designed to be self-contained: A structured, incremental path from zero to confident iOS developer.</p>
