...
const RESOURCE: ReaderResource = {
  id: "gcp-learning-roadmap",
  title: "Google Cloud Platform — Learning Roadmap",
  ...
  heroSubtitle: "A roadmap from zero to Professional Cloud Architect on Google Cloud.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-learning-roadmap" }],
  }),
  component: Page,
});
