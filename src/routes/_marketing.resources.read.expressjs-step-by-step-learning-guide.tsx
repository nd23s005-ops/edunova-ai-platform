...
const RESOURCE: ReaderResource = {
  id: "expressjs-step-by-step-learning-guide",
  title: "Express.js — Step-by-Step Learning Guide",
  ...
  heroSubtitle: 'A progressive path through Express.js — install, route, middleware, connect a database, and secure your API.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/expressjs-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/expressjs-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Step-by-Step Learning Guide</b> — practical, production-ready Express.js.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Express.js is the de-facto minimal, unopinionated web framework for Node.js — the backbone of countless production APIs and full-stack backends. It gives you routing, middleware, and a razor-thin abstraction over Node's HTTP module, letting you compose exactly the backend you need. This resource — <b>Express.js — Step-by-Step Learning Guide</b> — is self-contained: A progressive path through Express.js — install, route, middleware, connect a database, and secure your API.</p>
