...
const RESOURCE: ReaderResource = {
  id: "ux-design-common-mistakes",
  title: "UX Design — Common Mistakes",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "14 min",
  pages: 16,
  ...
  heroSubtitle: "Troubleshooting handbook covering common UX Design mistakes \u2014 poor research, weak personas, confusing navigation, inaccessible interfaces, poor usability testing, and ineffective user flows.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Common Mistakes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Troubleshooting handbook covering common UX Design mistakes — poor research, weak personas, confusing navigation, inaccessible interfaces, poor usability testing, and ineffective user flows.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Common Mistakes</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
