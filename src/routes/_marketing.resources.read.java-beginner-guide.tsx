...
const RESOURCE: ReaderResource = {
  id: "java-beginner-guide",
  title: "Java — Beginner Guide",
  ...
  heroSubtitle: "A friendly first tour of Java — syntax, OOP, and your first working programs on the JVM.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-beginner-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Beginner Guide</b> — is designed to be self-contained: A friendly first tour of Java — syntax, OOP, and your first working programs on the JVM.</p>
