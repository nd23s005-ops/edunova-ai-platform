...
const RESOURCE: ReaderResource = {
  id: "html5-learning-roadmap",
  title: "HTML5 — Learning Roadmap",
  ...
  heroSubtitle: "Structured HTML5 roadmap \u2014 beginner to advanced, semantic, a11y, SEO, projects, interviews, career.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Phase 1 — Basics" },
  { id: "s2", label: "2. Phase 2 — Semantic" },
  { id: "s3", label: "3. Phase 3 — Forms & Media" },
  { id: "s4", label: "4. Phase 4 — A11y & SEO" },
  { id: "s5", label: "5. Phase 5 — Projects" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Learning Roadmap.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>A visual, milestone-driven roadmap to HTML mastery.</p>
      ...
      <Section id="s1" title="1. Phase 1 — Basics">
        <p>Elements, attributes, structure.</p>
        <Code lang="html">{`<!-- Phase 1 — Basics — illustrative snippet -->
<section aria-label="phase 1 — basics">
  <h2>Phase 1 — Basics</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s2" title="2. Phase 2 — Semantic">
        <p>Landmarks & outline.</p>
        <Code lang="html">{`<!-- Phase 2 — Semantic — illustrative snippet -->
<section aria-label="phase 2 — semantic">
  <h2>Phase 2 — Semantic</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s3" title="3. Phase 3 — Forms & Media">
        <p>Inputs & multimedia.</p>
        <Code lang="html">{`<!-- Phase 3 — Forms & Media — illustrative snippet -->
<section aria-label="phase 3 — forms & media">
  <h2>Phase 3 — Forms & Media</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s4" title="4. Phase 4 — A11y & SEO">
        <p>WCAG, structured data.</p>
        <Code lang="html">{`<!-- Phase 4 — A11y & SEO — illustrative snippet -->
<section aria-label="phase 4 — a11y & seo">
  <h2>Phase 4 — A11y & SEO</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s5" title="5. Phase 5 — Projects">
        <p>Portfolio-ready builds.</p>
        <Code lang="html">{`<!-- Phase 5 — Projects — illustrative snippet -->
<section aria-label="phase 5 — projects">
  <h2>Phase 5 — Projects</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Learning Roadmap equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
