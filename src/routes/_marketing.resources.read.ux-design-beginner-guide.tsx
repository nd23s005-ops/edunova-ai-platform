...
const RESOURCE: ReaderResource = {
  id: "ux-design-beginner-guide",
  title: "UX Design — Beginner Guide",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "14 min",
  pages: 28,
  ...
  heroSubtitle: "Beginner-friendly UX Design guide covering user-centered design, design thinking, usability principles, UX research, personas, empathy maps, customer journey mapping, information architecture, wireframing, prototyping, and accessibility.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Beginner Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Beginner-friendly UX Design guide covering user-centered design, design thinking, usability principles, UX research, personas, empathy maps, customer journey mapping, information architecture, wireframing, prototyping, and accessibility.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Beginner Guide</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
