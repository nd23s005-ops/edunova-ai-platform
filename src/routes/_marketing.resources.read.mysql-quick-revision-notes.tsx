...
const RESOURCE: ReaderResource = {
  id: "mysql-quick-revision-notes",
  title: "MySQL — Quick Revision Notes",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "6 min",
  pages: 4,
  ...
  heroSubtitle: "Fast recap of MySQL syntax, joins, indexes, and tuning for interview day.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Quick Revision Notes</b> — is designed to be self-contained: Fast recap of MySQL syntax, joins, indexes, and tuning for interview day.</p>
