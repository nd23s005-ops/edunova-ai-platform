...
const RESOURCE: ReaderResource = {
  id: "data-analytics-cheat-sheet",
  title: "Data Analytics — Cheat Sheet",
  ...
  heroSubtitle: 'One-page Data Analytics reference — SQL, Pandas, Excel formulas, and KPI patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, business-ready Data Analytics.</li>
