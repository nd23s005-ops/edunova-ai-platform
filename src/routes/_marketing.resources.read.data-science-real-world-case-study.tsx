...
const RESOURCE: ReaderResource = {
  id: "data-science-real-world-case-study",
  title: "Data Science — Real-world Case Study",
  ...
  heroSubtitle: 'How teams run Data Science in production — MLOps, drift, monitoring, and postmortems.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-science-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-science-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Real-world Case Study</b> — practical, production-ready Data Science.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Data Science combines <b>statistics</b>, <b>programming</b>, and <b>domain knowledge</b> to turn raw data into decisions and products. From dashboards and forecasts to recommender systems and LLM agents, it's the discipline behind most modern data-driven features. This resource — <b>Data Science — Real-world Case Study</b> — is self-contained: How teams run Data Science in production — MLOps, drift, monitoring, and postmortems.</p>
