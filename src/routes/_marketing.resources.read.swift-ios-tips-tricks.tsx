...
const RESOURCE: ReaderResource = {
  id: "swift-ios-tips-tricks",
  title: "Swift (iOS) — Tips & Tricks",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "12 min",
  pages: 14,
  ...
  heroSubtitle: "Practical Swift and SwiftUI tips — modifiers, previews, and shortcuts that save time.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-tips-tricks" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Tips & Tricks</b> — is designed to be self-contained: Practical Swift and SwiftUI tips — modifiers, previews, and shortcuts that save time.</p>
