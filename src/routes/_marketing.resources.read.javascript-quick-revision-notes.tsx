...
const RESOURCE: ReaderResource = {
  id: "javascript-quick-revision-notes",
  title: "JavaScript — Quick Revision Notes",
  ...
  heroSubtitle: "Concise interview-ready revision notes \u2014 summaries, syntax refs, mnemonics, and quick lookup tables.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Types & Coercion" },
  { id: "s2", label: "2. Scope & Closures" },
  { id: "s3", label: "3. This binding" },
  { id: "s4", label: "4. Prototypes" },
  { id: "s5", label: "5. Promises" },
  { id: "s6", label: "6. Event Loop" },
...
export const Route = createFileRoute("/_marketing/resources/read/javascript-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/javascript-quick-revision-notes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in JavaScript — Quick Revision Notes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Cram-friendly, one-page-per-topic revision material for the day before an interview.</p>
      ...
      <Section id="s1" title="1. Types & Coercion">
        <p>== vs === rules.</p>
        <Code lang="js">{`// Types & Coercion — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from types & coercion";
};`}</Code>
      </Section>

      <Section id="s2" title="2. Scope & Closures">
        <p>Lexical scope, closure use cases.</p>
        <Code lang="js">{`// Scope & Closures — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from scope & closures";
};`}</Code>
      </Section>

      <Section id="s3" title="3. This binding">
        <p>4 rules: default, implicit, explicit, new.</p>
        <Code lang="js">{`// This binding — illustrative snippet
const example = () => {
  // apply concepts covered above
  return "hello from this binding";
};`}</Code>
      </Section>

      <Section id="s4" title="4. Prototypes">
        <p>__proto__ vs prototype.</p>
...
const example = () => {
  ...
  return "hello from promises";
      ...
      <Section id="s6" title="6. Event Loop">
        <p>Call stack, task queue, microtasks.</p>
...
Next Macrotask (setTimeout, I/O, UI events)`}</Code>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>JavaScript — Quick Revision Notes equips you with the practical knowledge to write, debug, and ship JavaScript with confidence.</p>
        <ul className="list-disc space-y-1 pl-5">
