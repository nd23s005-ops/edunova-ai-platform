...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Fully explained answers to the Java practice set with step-by-step reasoning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Answer Key</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Answer Key</b> — is designed to be self-contained: Fully explained answers to the Java practice set with step-by-step reasoning.</p>
