...
const RESOURCE: ReaderResource = {
  id: "tableau-pdf-notes",
  title: "Tableau — PDF Notes",
  ...
  heroSubtitle: "These comprehensive PDF-style notes consolidate the entire Tableau knowledge base — visualization principles, calculations, LOD, dashboarding, governance, and BI best practices.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/tableau-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/tableau-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>These comprehensive PDF-style notes consolidate the entire Tableau knowledge base — visualization principles, calculations, LOD, dashboarding, governance, and BI best practices.</p>
