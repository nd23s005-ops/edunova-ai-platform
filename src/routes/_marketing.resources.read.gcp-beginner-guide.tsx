...
const RESOURCE: ReaderResource = {
  id: "gcp-beginner-guide",
  title: "Google Cloud Platform — Beginner Guide",
  ...
  heroSubtitle: "Beginner-friendly introduction to Google Cloud — global infrastructure, core services, and cloud fundamentals.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-beginner-guide" }],
  }),
  component: Page,
});
