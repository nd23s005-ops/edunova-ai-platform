...
const RESOURCE: ReaderResource = {
  id: "flutter-practice-questions",
  title: "Flutter — Practice Questions",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "23 min",
  pages: 37,
  ...
  heroSubtitle: 'Hands-on Flutter practice — widget composition, Riverpod/Bloc, navigation, and Firebase.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — modern, production-ready Flutter development.</li>
