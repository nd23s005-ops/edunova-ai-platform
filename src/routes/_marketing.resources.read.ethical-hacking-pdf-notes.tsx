...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-pdf-notes",
  title: "Ethical Hacking — PDF Notes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "67 min",
  pages: 100,
  ...
  heroSubtitle: "Comprehensive chapter-wise educational notes on ethical hacking — PTES, OWASP, MITRE, cryptography, IAM, cloud, container, IR, and governance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-pdf-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-pdf-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive chapter-wise educational notes on ethical hacking — PTES, OWASP, MITRE, cryptography, IAM, cloud, container, IR, and governance. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
