...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Azure best practices — Well-Architected Framework, identity, cost, security, and reliability.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Azure best practices — Well-Architected Framework, identity, cost, security, and reliability. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
