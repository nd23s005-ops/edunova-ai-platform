...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'One-page CSS3 cheat sheet — selectors, Flexbox, Grid, and modern functions at a glance.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Cheat Sheet</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Cheat Sheet</b> — is self-contained: One-page CSS3 cheat sheet — selectors, Flexbox, Grid, and modern functions at a glance.</p>
