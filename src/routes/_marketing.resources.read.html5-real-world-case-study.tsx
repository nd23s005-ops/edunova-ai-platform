...
const RESOURCE: ReaderResource = {
  id: "html5-real-world-case-study",
  title: "HTML5 — Real-world Case Study",
  ...
  heroSubtitle: "Enterprise HTML5 case study \u2014 accessible, SEO-friendly, responsive app with measurable business outcomes.",
};
...
const TOC: TocItem[] = [
  ...
  { id: "s2", label: "2. Solution" },
  { id: "s3", label: "3. Accessibility Audit" },
  { id: "s4", label: "4. SEO" },
  { id: "s5", label: "5. Browser Compat" },
  { id: "s6", label: "6. Deployment" },
  { id: "s7", label: "7. Monitoring" },
  { id: "s8", label: "8. Business Outcomes" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Real-world Case Study.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>How a real company shipped an accessible, performant HTML5 experience at scale.</p>
      ...
      <Section id="s1" title="1. Problem">
        <p>Inaccessible legacy site.</p>
        <Code lang="html">{`<!-- Problem — illustrative snippet -->
<section aria-label="problem">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s2" title="2. Solution">
        <p>Semantic rewrite + ARIA.</p>
        <Code lang="html">{`<!-- Solution — illustrative snippet -->
<section aria-label="solution">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s3" title="3. Accessibility Audit">
        <p>axe + manual + user testing.</p>
        <Code lang="html">{`<!-- Accessibility Audit — illustrative snippet -->
<section aria-label="accessibility audit">
...
<section aria-label="seo">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s5" title="5. Browser Compat">
        <p>Progressive enhancement.</p>
        <Code lang="html">{`<!-- Browser Compat — illustrative snippet -->
<section aria-label="browser compat">
...
<section aria-label="deployment">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s7" title="7. Monitoring">
        <p>Lighthouse CI, RUM.</p>
        <Code lang="html">{`<!-- Monitoring — illustrative snippet -->
<section aria-label="monitoring">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s8" title="8. Business Outcomes">
        <p>+35% organic traffic.</p>
        <Code lang="html">{`<!-- Business Outcomes — illustrative snippet -->
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Real-world Case Study equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
