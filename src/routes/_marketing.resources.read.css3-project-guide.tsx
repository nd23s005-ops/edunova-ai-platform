...
const RESOURCE: ReaderResource = {
  id: "css3-project-guide",
  title: "CSS3 — Project Guide",
  ...
  heroSubtitle: 'Build a responsive, production-ready CSS3 project with modern layout and design tokens.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-project-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Guide</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Project Guide</b> — is self-contained: Build a responsive, production-ready CSS3 project with modern layout and design tokens.</p>
