...
const RESOURCE: ReaderResource = {
  id: "mysql-step-by-step-learning-guide",
  title: "MySQL — Step-by-Step Learning Guide",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "20 min",
  pages: 33,
  ...
  heroSubtitle: "A structured, incremental path from zero to confident MySQL developer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Step-by-Step Learning Guide</b> — is designed to be self-contained: A structured, incremental path from zero to confident MySQL developer.</p>
