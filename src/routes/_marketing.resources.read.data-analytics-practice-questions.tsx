...
const RESOURCE: ReaderResource = {
  id: "data-analytics-practice-questions",
  title: "Data Analytics — Practice Questions",
  ...
  heroSubtitle: 'Hands-on Data Analytics practice — SQL joins, Pandas cleaning, KPIs, and dashboards.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-practice-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Practice Questions</b> — practical, business-ready Data Analytics.</li>
