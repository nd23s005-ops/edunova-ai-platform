...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "This complete tutorial walks you end-to-end through Power BI — from Power Query and modeling to DAX, dashboards, and publishing to the Power BI Service.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/power-bi-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/power-bi-complete-tutorial" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>This complete tutorial walks you end-to-end through Power BI — from Power Query and modeling to DAX, dashboards, and publishing to the Power BI Service.</p>
