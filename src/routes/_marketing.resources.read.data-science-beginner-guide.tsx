...
const RESOURCE: ReaderResource = {
  id: "data-science-beginner-guide",
  title: "Data Science — Beginner Guide",
  ...
  heroSubtitle: 'A friendly first tour of Data Science — the lifecycle, Python tooling, and your first analysis.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-science-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-science-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready Data Science.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Data Science combines <b>statistics</b>, <b>programming</b>, and <b>domain knowledge</b> to turn raw data into decisions and products. From dashboards and forecasts to recommender systems and LLM agents, it's the discipline behind most modern data-driven features. This resource — <b>Data Science — Beginner Guide</b> — is self-contained: A friendly first tour of Data Science — the lifecycle, Python tooling, and your first analysis.</p>
