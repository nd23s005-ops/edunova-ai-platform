...
const RESOURCE: ReaderResource = {
  id: "gcp-project-guide",
  title: "Google Cloud Platform — Project Guide",
  ...
  heroSubtitle: "Blueprint for building a production-grade cloud-native project on Google Cloud.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-project-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-project-guide" }],
  }),
  component: Page,
});
