...
const RESOURCE: ReaderResource = {
  id: "pandas-answer-key",
  title: "Pandas — Answer Key",
  ...
  heroSubtitle: 'Complete worked solutions and explanations for the Pandas practice question set.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/pandas-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/pandas-answer-key" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Answer Key</b> — practical, production-ready Pandas.</li>
