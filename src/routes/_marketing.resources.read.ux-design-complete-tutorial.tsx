...
const RESOURCE: ReaderResource = {
  id: "ux-design-complete-tutorial",
  title: "UX Design — Complete Tutorial",
  category: "Design",
  difficulty: "Beginner",
  readingTime: "55 min",
  pages: 94,
  ...
  heroSubtitle: "Complete UX Design tutorial: principles, user research, interviews, surveys, personas, empathy maps, journey maps, information architecture, card sorting, user flows, wireframing, prototyping, usability testing, accessibility, UX writing, analytics, design systems, and collaboration.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ux-design-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ux-design-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in UX Design — Complete Tutorial.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete UX Design tutorial: principles, user research, interviews, surveys, personas, empathy maps, journey maps, information architecture, card sorting, user flows, wireframing, prototyping, usability testing, accessibility, UX writing, analytics, design systems, and collaboration.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>UX Design is the practice of making products useful, usable, and desirable by grounding decisions in real user needs. This <b>Complete Tutorial</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
