...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'Curated Data Science interview questions across statistics, Python, SQL, ML, and case studies.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-science-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-science-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Interview Questions</b> — practical, production-ready Data Science.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Data Science combines <b>statistics</b>, <b>programming</b>, and <b>domain knowledge</b> to turn raw data into decisions and products. From dashboards and forecasts to recommender systems and LLM agents, it's the discipline behind most modern data-driven features. This resource — <b>Data Science — Interview Questions</b> — is self-contained: Curated Data Science interview questions across statistics, Python, SQL, ML, and case studies.</p>
