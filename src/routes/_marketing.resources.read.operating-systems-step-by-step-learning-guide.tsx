...
const RESOURCE: ReaderResource = {
  id: "operating-systems-step-by-step-learning-guide",
  title: "Operating Systems — Step-by-Step Learning Guide",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "23 min",
  pages: 34,
  ...
  heroSubtitle: "Structured week-by-week Operating Systems learning roadmap covering theory, practical labs, Linux commands, scheduling algorithms, memory management, filesystems, synchronization exercises, mini projects, interview prep, and revision milestones.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-step-by-step-learning-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Step-by-Step Learning Guide.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Structured week-by-week Operating Systems learning roadmap covering theory, practical labs, Linux commands, scheduling algorithms, memory management, filesystems, synchronization exercises, mini projects, interview prep, and revision milestones.</p>
