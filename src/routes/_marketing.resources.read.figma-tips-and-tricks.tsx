...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Figma productivity tips: keyboard shortcuts, Auto Layout techniques, component workflows, Smart Animate, Dev Mode, plugin recommendations, responsive design, and collaboration best practices.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-tips-and-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-tips-and-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Tips & Tricks.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Figma productivity tips: keyboard shortcuts, Auto Layout techniques, component workflows, Smart Animate, Dev Mode, plugin recommendations, responsive design, and collaboration best practices.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Tips & Tricks</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
