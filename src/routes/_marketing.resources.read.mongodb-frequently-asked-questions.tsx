...
const RESOURCE: ReaderResource = {
  id: "mongodb-frequently-asked-questions",
  title: "MongoDB — Frequently Asked Questions",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "13 min",
  pages: 9,
  ...
  heroSubtitle: 'Answers to the most-asked MongoDB questions — versions, drivers, Atlas, and deployment.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mongodb-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mongodb-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready MongoDB.</li>
