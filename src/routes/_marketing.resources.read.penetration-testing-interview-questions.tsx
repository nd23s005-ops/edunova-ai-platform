...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-interview-questions",
  title: "Penetration Testing — Interview Questions",
  category: "Security",
  ...
  heroSubtitle: "A comprehensive Penetration Testing Interview Handbook — 350+ questions across ethical hacking concepts, PTES methodology, OWASP Top 10, vulnerability assessment, web/API/cloud security, risk assessment, reporting, compliance, HR, scenario-based questions, and mock interviews.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive Penetration Testing Interview Handbook — 350+ questions across ethical hacking concepts, PTES methodology, OWASP Top 10, vulnerability assessment, web/API/cloud security, risk assessment, reporting, compliance, HR, scenario-based questions, and mock interviews. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
