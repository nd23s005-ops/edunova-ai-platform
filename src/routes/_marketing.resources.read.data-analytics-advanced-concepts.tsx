...
const RESOURCE: ReaderResource = {
  id: "data-analytics-advanced-concepts",
  ...
  heroSubtitle: 'Advanced Data Analytics — predictive analytics, ML basics, cloud warehouses, and MLOps for BI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/data-analytics-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/data-analytics-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, business-ready Data Analytics.</li>
