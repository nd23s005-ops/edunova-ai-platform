...
const RESOURCE: ReaderResource = {
  id: "flutter-reference-guide",
  title: "Flutter — Reference Guide",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "60 min",
  pages: 77,
  ...
  heroSubtitle: 'The exhaustive Flutter reference — Dart, widgets, state, Firebase, testing, and multi-platform deploy.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Reference Guide</b> — modern, production-ready Flutter development.</li>
