...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: 'A friendly first tour of Vue.js — SFCs, the Composition API, and shipping your first reactive SPA.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Beginner Guide</b> — practical, production-ready Vue.js.</li>
