...
const RESOURCE: ReaderResource = {
  id: "swift-ios-advanced-concepts",
  title: "Swift (iOS) — Advanced Concepts",
  category: "Mobile",
  difficulty: "Advanced",
  readingTime: "35 min",
  pages: 56,
  ...
  heroSubtitle: "Deep Swift — actors, structured concurrency, generics, ARC internals, and SwiftUI performance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-advanced-concepts" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Advanced Concepts</b> — is designed to be self-contained: Deep Swift — actors, structured concurrency, generics, ARC internals, and SwiftUI performance.</p>
