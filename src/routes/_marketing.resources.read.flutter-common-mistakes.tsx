...
const RESOURCE: ReaderResource = {
  id: "flutter-common-mistakes",
  title: "Flutter — Common Mistakes",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "10 min",
  pages: 15,
  ...
  heroSubtitle: 'The Flutter pitfalls that ship bugs — rebuilds, poor state, memory leaks, and blocked UI.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — modern, production-ready Flutter development.</li>
