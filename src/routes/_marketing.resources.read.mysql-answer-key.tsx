...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Fully explained answers to the MySQL practice set with step-by-step reasoning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-answer-key" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Answer Key</b> — is designed to be self-contained: Fully explained answers to the MySQL practice set with step-by-step reasoning.</p>
