...
const RESOURCE: ReaderResource = {
  id: "css3-common-mistakes",
  title: "CSS3 — Common Mistakes",
  ...
  heroSubtitle: 'The most common CSS3 mistakes and how to fix them with confidence.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/css3-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/css3-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Common Mistakes</b> — practical, production-ready CSS3.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>CSS3 is the modern styling language of the web — a living standard that powers layout, typography, color, motion, and design systems across every browser. This resource — <b>CSS3 — Common Mistakes</b> — is self-contained: The most common CSS3 mistakes and how to fix them with confidence.</p>
