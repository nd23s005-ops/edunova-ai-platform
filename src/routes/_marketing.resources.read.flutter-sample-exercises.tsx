...
const RESOURCE: ReaderResource = {
  id: "flutter-sample-exercises",
  title: "Flutter — Sample Exercises",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "20 min",
  pages: 31,
  ...
  heroSubtitle: 'Small, focused Flutter exercises to build Dart, widget, and state-management muscle memory.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/flutter-sample-exercises")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/flutter-sample-exercises" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Sample Exercises</b> — modern, production-ready Flutter development.</li>
