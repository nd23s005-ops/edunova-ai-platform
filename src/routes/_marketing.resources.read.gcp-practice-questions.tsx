...
const RESOURCE: ReaderResource = {
  id: "gcp-practice-questions",
  title: "Google Cloud Platform — Practice Questions",
  ...
  heroSubtitle: "Hands-on practice questions across GCP compute, storage, networking, and IAM.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/gcp-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/gcp-practice-questions" }],
  }),
  component: Page,
});
