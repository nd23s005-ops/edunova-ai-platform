...
const RESOURCE: ReaderResource = {
  id: "penetration-testing-frequently-asked-questions",
  title: "Penetration Testing — Frequently Asked Questions",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "8 min",
  pages: 16,
  ...
  heroSubtitle: "A comprehensive FAQ covering beginner-to-advanced questions on penetration testing, ethical hacking, authorization, PTES, OWASP, reporting, compliance, certifications, careers, interview prep, responsible disclosure, and enterprise assessments.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/penetration-testing-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/penetration-testing-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive FAQ covering beginner-to-advanced questions on penetration testing, ethical hacking, authorization, PTES, OWASP, reporting, compliance, certifications, careers, interview prep, responsible disclosure, and enterprise assessments. Every activity described below is educational and assumes explicit written authorization; unauthorized testing is illegal in most jurisdictions.</p>
