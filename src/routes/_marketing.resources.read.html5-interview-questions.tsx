...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "350+ HTML5 interview questions \u2014 semantic HTML, ARIA, WCAG, forms, multimedia, SEO, compatibility, responsive, performance.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Semantic HTML" },
  { id: "s2", label: "2. Accessibility" },
  { id: "s3", label: "3. Forms" },
  { id: "s4", label: "4. Multimedia" },
  { id: "s5", label: "5. SEO" },
  { id: "s6", label: "6. Compatibility" },
  { id: "s7", label: "7. Responsive" },
  { id: "s8", label: "8. Performance" },
  { id: "s9", label: "9. Scenario" },
  { id: "s10", label: "10. HR" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-interview-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Interview Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>A layered handbook covering junior to senior frontend and accessibility interviews.</p>
      ...
      <Section id="s1" title="1. Semantic HTML">
        <p>30+ Qs — landmarks & outline.</p>
        <Code lang="html">{`<!-- Semantic HTML — illustrative snippet -->
<section aria-label="semantic html">
  <h2>Semantic HTML</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>

      <Section id="s2" title="2. Accessibility">
        <p>50+ Qs — ARIA, WCAG.</p>
        <Code lang="html">{`<!-- Accessibility — illustrative snippet -->
...
<section aria-label="multimedia">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s5" title="5. SEO">
        <p>30+ Qs — OG, JSON-LD, canonical.</p>
...
<section aria-label="seo">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s6" title="6. Compatibility">
        <p>20+ Qs — progressive enhancement.</p>
...
<section aria-label="compatibility">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s7" title="7. Responsive">
        <p>30+ Qs — srcset, picture.</p>
...
<section aria-label="responsive">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s8" title="8. Performance">
        <p>25+ Qs — preload, defer, lazy.</p>
...
<section aria-label="performance">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s9" title="9. Scenario">
        <p>40+ Qs — real-world tasks.</p>
        <Code lang="html">{`<!-- Scenario — illustrative snippet -->
<section aria-label="scenario">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s10" title="10. HR">
        <p>STAR framework & culture Qs.</p>
        <Code lang="html">{`<!-- HR — illustrative snippet -->
<section aria-label="hr">
  <h2>HR</h2>
  <p>Apply the concepts covered above.</p>
</section>`}</Code>
      </Section>
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Interview Questions equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
