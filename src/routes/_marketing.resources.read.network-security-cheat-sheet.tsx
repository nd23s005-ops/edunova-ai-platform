...
const RESOURCE: ReaderResource = {
  id: "network-security-cheat-sheet",
  ...
  heroSubtitle: "A printable Network Security cheat sheet summarizing networking models, security protocols, common ports, firewall concepts, VPN technologies, authentication methods, encryption standards, and the incident response lifecycle.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-cheat-sheet" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A printable Network Security cheat sheet summarizing networking models, security protocols, common ports, firewall concepts, VPN technologies, authentication methods, encryption standards, and the incident response lifecycle. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
