...
const RESOURCE: ReaderResource = {
  id: "dsa-complete-tutorial",
  title: "Data Structures & Algorithms — Complete Tutorial",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "42 min",
  pages: 119,
  ...
  heroSubtitle: "Complete DSA tutorial: arrays, linked lists, stacks, queues, hash tables, trees, BSTs, heaps, tries, graphs, recursion, divide and conquer, greedy, DP, backtracking, bit manipulation, sorting, searching, and interview techniques.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-complete-tutorial")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-complete-tutorial" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Complete Tutorial.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete DSA tutorial: arrays, linked lists, stacks, queues, hash tables, trees, BSTs, heaps, tries, graphs, recursion, divide and conquer, greedy, DP, backtracking, bit manipulation, sorting, searching, and interview techniques.</p>
