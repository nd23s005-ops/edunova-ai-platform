...
const RESOURCE: ReaderResource = {
  id: "mern-stack-advanced-concepts",
  title: "MERN Stack — Advanced Concepts",
  ...
  heroSubtitle: 'Advanced MERN — microservices, message queues, SSR, streaming, AI integrations, and clean architecture.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/mern-stack-advanced-concepts")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mern-stack-advanced-concepts" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Advanced Concepts</b> — practical, production-ready MERN full-stack development.</li>
