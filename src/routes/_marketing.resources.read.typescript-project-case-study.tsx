...
const RESOURCE: ReaderResource = {
  id: "typescript-project-case-study",
  title: "TypeScript — Project Case Study",
  ...
  heroSubtitle: 'Deep-dive case study of a production TypeScript project — architecture and trade-offs.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/typescript-project-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/typescript-project-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Project Case Study</b> — practical, production-ready TypeScript.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>TypeScript is a strongly-typed superset of JavaScript that compiles to plain JS and runs everywhere JavaScript runs — browsers, Node.js, Deno, Bun, and edge runtimes. This resource — <b>TypeScript — Project Case Study</b> — is self-contained: Deep-dive case study of a production TypeScript project — architecture and trade-offs.</p>
