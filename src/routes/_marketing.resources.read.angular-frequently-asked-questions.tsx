...
const RESOURCE: ReaderResource = {
  id: "angular-frequently-asked-questions",
  title: "Angular — Frequently Asked Questions",
  ...
  heroSubtitle: 'Answers to the most frequently asked Angular questions — from setup to advanced patterns.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/angular-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/angular-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Frequently Asked Questions</b> — practical, production-ready Angular.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Angular is Google's opinionated, full-featured framework for building large-scale single-page applications. It ships with a powerful CLI, dependency injection, RxJS, standalone components, and — since v16+ — a fine-grained reactivity system based on signals. This resource — <b>Angular — Frequently Asked Questions</b> — is self-contained: Answers to the most frequently asked Angular questions — from setup to advanced patterns.</p>
