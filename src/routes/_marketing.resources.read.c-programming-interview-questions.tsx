...
const RESOURCE: ReaderResource = {
  id: "c-programming-interview-questions",
  ...
  heroSubtitle: "Curated C interview questions — pointers, memory, data structures, and systems.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-interview-questions" }],
  }),
  component: Page,
});
