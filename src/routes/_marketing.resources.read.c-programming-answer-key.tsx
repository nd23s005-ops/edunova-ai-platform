...
const RESOURCE: ReaderResource = {
  id: "c-programming-answer-key",
  title: "C Programming — Answer Key",
  ...
  heroSubtitle: "Fully explained answers to the C practice set with step-by-step reasoning.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/c-programming-answer-key")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/c-programming-answer-key" }],
  }),
  component: Page,
});
