...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Comprehensive SQL reference — syntax, joins, functions, indexes, and tooling.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-reference-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-reference-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Reference Guide</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Reference Guide</b> — is designed to be self-contained: Comprehensive SQL reference — syntax, joins, functions, indexes, and tooling.</p>
