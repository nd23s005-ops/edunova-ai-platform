...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "A comprehensive handbook of Network Security best practices covering secure architecture, segmentation, firewall policy management, IDS/IPS deployment, Zero Trust, VPN security, wireless, monitoring, logging, compliance, and DR.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-best-practices" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A comprehensive handbook of Network Security best practices covering secure architecture, segmentation, firewall policy management, IDS/IPS deployment, Zero Trust, VPN security, wireless, monitoring, logging, compliance, and DR. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
