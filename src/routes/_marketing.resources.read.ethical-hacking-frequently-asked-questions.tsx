...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-frequently-asked-questions",
  title: "Ethical Hacking — Frequently Asked Questions",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "13 min",
  pages: 11,
  ...
  heroSubtitle: "FAQs on ethical hacking — legality, certifications, career paths, tools, frameworks, and how to start responsibly.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-frequently-asked-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>FAQs on ethical hacking — legality, certifications, career paths, tools, frameworks, and how to start responsibly. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
