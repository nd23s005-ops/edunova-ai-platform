...
const RESOURCE: ReaderResource = {
  id: "operating-systems-cheat-sheet",
  ...
  heroSubtitle: "Printable Operating Systems cheat sheet: process states, scheduling algorithms, synchronization primitives, memory management formulas, paging, segmentation, Linux commands, filesystem hierarchy, and system calls.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/operating-systems-cheat-sheet")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/operating-systems-cheat-sheet" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the concepts presented in Operating Systems — Cheat Sheet.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Printable Operating Systems cheat sheet: process states, scheduling algorithms, synchronization primitives, memory management formulas, paging, segmentation, Linux commands, filesystem hierarchy, and system calls.</p>
