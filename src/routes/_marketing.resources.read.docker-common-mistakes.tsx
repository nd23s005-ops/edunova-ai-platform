...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "The most common Docker mistakes and how to avoid them — bloated images, root containers, missing health checks, and unbounded resources.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/docker-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/docker-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>The most common Docker mistakes and how to avoid them — bloated images, root containers, missing health checks, and unbounded resources.</p>
