...
const RESOURCE: ReaderResource = {
  id: "azure-common-mistakes",
  title: "Microsoft Azure — Common Mistakes",
  ...
  heroSubtitle: "Common Azure mistakes — over-permissive RBAC, unmanaged costs, no monitoring, and manual deployments.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/azure-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/azure-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Common Azure mistakes — over-permissive RBAC, unmanaged costs, no monitoring, and manual deployments. Microsoft Azure is a global cloud platform with 60+ regions and hundreds of services spanning compute, storage, networking, identity, data, AI, and DevOps.</p>
