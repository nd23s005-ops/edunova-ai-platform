...
const RESOURCE: ReaderResource = {
  id: "swift-ios-common-mistakes",
  title: "Swift (iOS) — Common Mistakes",
  category: "Mobile",
  difficulty: "Beginner",
  readingTime: "12 min",
  pages: 16,
  ...
  heroSubtitle: "Force-unwraps, retain cycles, MainActor misuse, and other classic Swift/iOS pitfalls.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/swift-ios-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/swift-ios-common-mistakes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>Swift (iOS) — Common Mistakes</b> — is designed to be self-contained: Force-unwraps, retain cycles, MainActor misuse, and other classic Swift/iOS pitfalls.</p>
