...
const RESOURCE: ReaderResource = {
  id: "dsa-frequently-asked-questions",
  title: "Data Structures & Algorithms — Frequently Asked Questions",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "9 min",
  pages: 12,
  ...
  heroSubtitle: "Comprehensive DSA FAQ: complexity, recursion, DP, trees, graphs, heaps, tries, hash tables, interview prep, competitive programming, and career guidance.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-frequently-asked-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-frequently-asked-questions" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Frequently Asked Questions.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Comprehensive DSA FAQ: complexity, recursion, DP, trees, graphs, heaps, tries, hash tables, interview prep, competitive programming, and career guidance.</p>
