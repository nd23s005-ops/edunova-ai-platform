...
const RESOURCE: ReaderResource = {
  id: "java-real-world-case-study",
  title: "Java — Real-world Case Study",
  ...
  heroSubtitle: "Real production Java systems — architecture, trade-offs, and lessons learned.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-real-world-case-study")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-real-world-case-study" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Real-world Case Study</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Real-world Case Study</b> — is designed to be self-contained: Real production Java systems — architecture, trade-offs, and lessons learned.</p>
