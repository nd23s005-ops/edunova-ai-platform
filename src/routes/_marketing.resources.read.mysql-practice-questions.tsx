...
const RESOURCE: ReaderResource = {
  id: "mysql-practice-questions",
  title: "MySQL — Practice Questions",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "30 min",
  pages: 25,
  ...
  heroSubtitle: "Hands-on MySQL practice questions covering queries, joins, aggregation, and CTEs.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-practice-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-practice-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>MySQL — Practice Questions</b> — is designed to be self-contained: Hands-on MySQL practice questions covering queries, joins, aggregation, and CTEs.</p>
