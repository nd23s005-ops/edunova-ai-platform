...
const RESOURCE: ReaderResource = {
  id: "sql-beginner-guide",
  title: "SQL — Beginner Guide",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "11 min",
  pages: 15,
  ...
  heroSubtitle: "A friendly first tour of SQL — tables, queries, and your first real database work.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/sql-beginner-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/sql-beginner-guide" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Beginner Guide</b> — practical, production-ready SQL.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>SQL (Structured Query Language) is the standard language for talking to relational databases. It powers analytics dashboards, banking systems, e-commerce checkouts, and every serious backend. This resource — <b>SQL — Beginner Guide</b> — is designed to be self-contained: A friendly first tour of SQL — tables, queries, and your first real database work.</p>
