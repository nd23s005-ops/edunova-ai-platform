...
const RESOURCE: ReaderResource = {
  ...
  title: "Data Structures & Algorithms — Common Mistakes",
  category: "CS Core",
  difficulty: "Beginner",
  readingTime: "16 min",
  pages: 16,
  ...
  heroSubtitle: "DSA troubleshooting handbook: mistakes in recursion, complexity analysis, graph traversal, tree operations, hash tables, DP, greedy, edge cases, overflow, and optimization.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/dsa-common-mistakes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/dsa-common-mistakes" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the ideas covered in Data Structures & Algorithms — Common Mistakes.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>DSA troubleshooting handbook: mistakes in recursion, complexity analysis, graph traversal, tree operations, hash tables, DP, greedy, edge cases, overflow, and optimization.</p>
