...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "HTML5 handbook \u2014 semantic, accessibility, SEO, responsive, metadata, forms, multimedia, validation, compatibility.",
};

const TOC: TocItem[] = [
  { id: "objectives", label: "Learning Objectives" },
  { id: "intro", label: "Introduction" },
  { id: "s1", label: "1. Semantic First" },
  { id: "s2", label: "2. Accessibility" },
  { id: "s3", label: "3. SEO" },
  { id: "s4", label: "4. Responsive" },
  { id: "s5", label: "5. Forms" },
  { id: "s6", label: "6. Multimedia" },
  { id: "s7", label: "7. Validation" },
  { id: "s8", label: "8. Compatibility" },
...
export const Route = createFileRoute("/_marketing/resources/read/html5-best-practices")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/html5-best-practices" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the core concepts covered in HTML5 — Best Practices.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>The habits that separate production-grade HTML5 from throwaway markup.</p>
      ...
      <Section id="s1" title="1. Semantic First">
        <p>Prefer semantic tags over div/span.</p>
        <Code lang="html">{`<!-- Semantic First — illustrative snippet -->
<section aria-label="semantic first">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s2" title="2. Accessibility">
        <p>Labels, ARIA only when needed.</p>
...
<section aria-label="accessibility">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s3" title="3. SEO">
        <p>Descriptive metadata & structured data.</p>
...
<section aria-label="seo">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s4" title="4. Responsive">
        <p>Mobile-first with srcset.</p>
...
<section aria-label="responsive">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s5" title="5. Forms">
        <p>Labels, autocomplete, inputmode.</p>
...
<section aria-label="forms">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s6" title="6. Multimedia">
        <p>Captions, transcripts.</p>
...
<section aria-label="multimedia">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s7" title="7. Validation">
        <p>W3C validator in CI.</p>
...
<section aria-label="validation">
  ...
  <p>Apply the concepts covered above.</p>
      ...
      <Section id="s8" title="8. Compatibility">
  ...
  <body>
    ...
    <footer>...</footer>
      ...
      <Section id="summary" title="Summary & Key Takeaways">
        <p>HTML5 — Best Practices equips you with the practical knowledge to write semantic, accessible, and SEO-friendly HTML5.</p>
        <ul className="list-disc space-y-1 pl-5">
