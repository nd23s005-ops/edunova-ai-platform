...
const RESOURCE: ReaderResource = {
  id: "vue-learning-roadmap",
  title: "Vue.js — Learning Roadmap",
  ...
  heroSubtitle: 'A staged roadmap for learning Vue.js — from Vite basics to enterprise-scale SPAs with Nuxt.',
};
...
export const Route = createFileRoute("/_marketing/resources/read/vue-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/vue-learning-roadmap" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the scope of the <b>Learning Roadmap</b> — practical, production-ready Vue.js.</li>
