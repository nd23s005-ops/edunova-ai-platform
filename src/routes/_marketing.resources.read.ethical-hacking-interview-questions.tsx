...
const RESOURCE: ReaderResource = {
  id: "ethical-hacking-interview-questions",
  title: "Ethical Hacking — Interview Questions",
  category: "Security",
  ...
  heroSubtitle: "350+ ethical hacking interview questions across PTES, OWASP, MITRE, cloud, IAM, IR, and governance for pentest, AppSec, and security engineering roles.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/ethical-hacking-interview-questions")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/ethical-hacking-interview-questions" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>350+ ethical hacking interview questions across PTES, OWASP, MITRE, cloud, IAM, IR, and governance for pentest, AppSec, and security engineering roles. All content is educational and defense-oriented; every activity assumes explicit written authorization within an agreed scope.</p>
