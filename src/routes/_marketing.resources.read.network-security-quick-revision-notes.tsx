...
const RESOURCE: ReaderResource = {
  id: "network-security-quick-revision-notes",
  title: "Network Security — Quick Revision Notes",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "12 min",
  pages: 10,
  ...
  heroSubtitle: "Concise revision notes summarizing Network Security concepts including OSI layers, TCP/IP, firewalls, IDS/IPS, VPNs, authentication, encryption, Zero Trust, security policies, incident response, and compliance frameworks.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Concise revision notes summarizing Network Security concepts including OSI layers, TCP/IP, firewalls, IDS/IPS, VPNs, authentication, encryption, Zero Trust, security policies, incident response, and compliance frameworks. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
