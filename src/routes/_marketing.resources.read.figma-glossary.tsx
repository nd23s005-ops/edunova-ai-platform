...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Complete alphabetical Figma glossary \u2014 terminology, Auto Layout concepts, components, variants, variables, design systems, prototyping, accessibility, Dev Mode, and UI/UX terms with examples.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/figma-glossary")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/figma-glossary" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Understand the concepts covered in Figma — Glossary.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Complete alphabetical Figma glossary — terminology, Auto Layout concepts, components, variants, variables, design systems, prototyping, accessibility, Dev Mode, and UI/UX terms with examples.</p>
      ...
      <Section id="content" title="Detailed Educational Content">
        <p>Figma is a collaborative interface design tool used by product teams to design, prototype, and hand off UIs. This <b>Glossary</b> walks through the concepts you need most.</p>
        <ul className="list-disc space-y-1 pl-5">
