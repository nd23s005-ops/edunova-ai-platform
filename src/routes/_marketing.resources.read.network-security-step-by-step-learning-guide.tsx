...
const RESOURCE: ReaderResource = {
  id: "network-security-step-by-step-learning-guide",
  title: "Network Security — Step-by-Step Learning Guide",
  category: "Security",
  difficulty: "Beginner",
  readingTime: "20 min",
  pages: 28,
  ...
  heroSubtitle: "A structured week-by-week Network Security roadmap covering networking fundamentals, TCP/IP, Linux, firewalls, VPNs, wireless security, cloud security, monitoring, incident response, certifications, and career development.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/network-security-step-by-step-learning-guide")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/network-security-step-by-step-learning-guide" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>A structured week-by-week Network Security roadmap covering networking fundamentals, TCP/IP, Linux, firewalls, VPNs, wireless security, cloud security, monitoring, incident response, certifications, and career development. This resource is educational and defense-oriented — it focuses on how to protect networks, users, and data using layered, standards-aligned controls.</p>
