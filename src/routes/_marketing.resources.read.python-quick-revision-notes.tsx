...
const RESOURCE: ReaderResource = {
  id: "python-quick-revision-notes",
  title: "Python — Quick Revision Notes",
  ...
  heroSubtitle: "Fast recap of Python core syntax, data structures, and idioms for exam or interview day.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/python-quick-revision-notes")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/python-quick-revision-notes" }],
  }),
  component: Page,
});
  ...
  return (
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      ...
      <Section id="intro" title="Introduction">
        <p>Python is a general-purpose, high-level programming language known for its readable syntax, batteries-included standard library, and huge ecosystem. This resource — <b>Python — Quick Revision Notes</b> — is designed to be self-contained: Fast recap of Python core syntax, data structures, and idioms for exam or interview day.</p>
