...
const RESOURCE: ReaderResource = {
  ...
  heroSubtitle: "Practical Java tips — streams, Optional, records, and shortcuts that save time.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/java-tips-tricks")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/java-tips-tricks" }],
  }),
  component: Page,
});
    ...
    <ReaderShell resource={RESOURCE} toc={TOC} related={RELATED}>
      <Section id="objectives" title="Learning Objectives">
        <ul className="list-disc space-y-1 pl-5">
          <li>Master the topic scope of the <b>Tips & Tricks</b> — practical, exam-ready coverage.</li>
      ...
      <Section id="intro" title="Introduction">
        <p>Java is a statically typed, object-oriented language that runs on the Java Virtual Machine — a mature, high-performance runtime used across banking, telecoms, e-commerce, and cloud platforms. This resource — <b>Java — Tips & Tricks</b> — is designed to be self-contained: Practical Java tips — streams, Optional, records, and shortcuts that save time.</p>
