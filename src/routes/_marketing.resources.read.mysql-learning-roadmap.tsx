...
const RESOURCE: ReaderResource = {
  id: "mysql-learning-roadmap",
  title: "MySQL — Learning Roadmap",
  category: "Databases",
  difficulty: "Beginner",
  readingTime: "7 min",
  pages: 9,
  ...
  heroSubtitle: "A month-by-month MySQL roadmap from beginner to production-ready database engineer.",
};
...
export const Route = createFileRoute("/_marketing/resources/read/mysql-learning-roadmap")({
  head: () => ({
    meta: [
    ...
    links: [{ rel: "canonical", href: "/resources/read/mysql-learning-roadmap" }],
  }),
  component: Page,
});
